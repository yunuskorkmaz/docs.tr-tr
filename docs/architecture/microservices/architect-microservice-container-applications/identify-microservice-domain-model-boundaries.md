...
[Sam Newman](https://samnewman.io/), mikro hizmet [derleme ve mikro hizmet oluşturma](https://samnewman.io/books/building_microservices/)bölümünün bilinen bir Promoter, daha önce açıklandığı gibi, mikro HIZMETLERINIZI sınırlanmış bağlam (BC) düzenine (etki alanı odaklı tasarımın bir parçası) göre tasarlamanız gerektiğini vurgular. Bazı durumlarda, bir BC birkaç fiziksel hizmetten oluşabilir, ancak tersi de değildir.
