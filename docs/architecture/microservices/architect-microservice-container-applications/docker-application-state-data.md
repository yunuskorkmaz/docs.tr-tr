...
- [Azure SQL veritabanı](https://azure.microsoft.com/services/sql-database/) gibi uzak ilişkisel veritabanları veya [Azure Cosmos DB](/azure/cosmos-db/introduction)gibi NoSQL veritabanları ya da [redin](https://redis.io/)gibi önbellek hizmetleri.
