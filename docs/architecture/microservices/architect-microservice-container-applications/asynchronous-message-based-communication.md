...
İzlemeniz gereken diğer bir kural, iç hizmetler arasında yalnızca zaman uyumsuz mesajlaşma kullanmak ve yalnızca istemci uygulamalarından ön uç hizmetlerine (API ağ geçitleri ve ilk mikro hizmet düzeyi) zaman uyumlu iletişim (HTTP gibi) kullanmak içindir.
