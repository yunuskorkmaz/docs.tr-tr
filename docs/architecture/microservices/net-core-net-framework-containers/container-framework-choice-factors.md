...
| ASP.NET Çekirdeği | .NET Core | .NET Core (önerilir) <br/> .NET Framework |
...
| Azure hizmetleri kullanımı | .NET Core <br/> (en sonunda Azure Hizmetleri, .NET Core için istemci SDK 'larını sağlar) | .NET Framework <br/> .NET Core <br/> (en sonunda Azure Hizmetleri, .NET Core için istemci SDK 'larını sağlar) |
