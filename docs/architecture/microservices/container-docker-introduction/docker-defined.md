...
Bu kapsayıcıların görüntüleri aynı şekilde oluşturulur ve aynı işlevi görür. Fark, bir Hyper-V kapsayıcısını çalıştıran görüntüden kapsayıcının oluşturulma biçiminde ek bir parametre olması gerekir. Ayrıntılar için bkz. [Hyper-V kapsayıcıları](/virtualization/windowscontainers/manage-containers/hyperv-container).
...
| Virtual Machines | Docker Kapsayıcıları |
| -----------------| ------------------|
