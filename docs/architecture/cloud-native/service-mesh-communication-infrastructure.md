...
Bir hizmet ağı 'nın anahtar bileşeni bir ara sunucu. Bulutta yerel bir uygulamada, bir ara sunucu örneği genellikle her bir mikro hizmetle birlikte bulunur. Ayrı işlemlerde yürütme yaparken, ikisi de yakından bağlantılıdır ve aynı yaşam döngüsünü paylaşır. Bu model, [sepet](/azure/architecture/patterns/sidecar)olarak bilinen ve Şekil 4-24 ' de gösterilmiştir.
...
- [Azure Depolama Kuyrukları](/azure/storage/queues/storage-queues-introduction)
...
- [Mikro hizmetler için Interservice Iletişimi tasarlama](/azure/architecture/microservices/design/interservice-communication)
...
- [WCF Geliştiricileri için gRPC](../grpc-for-wcf-developers/index.md)

- [GRPC hizmetlerini HTTP API 'Leri ile karşılaştırma](/aspnet/core/grpc/comparison?view=aspnetcore-3.0)
