...
**Çoklu mimari görüntü**: Çoklu mimari için, Docker 'ın çalıştırıldığı platforma göre uygun görüntünün seçimini kolaylaştıran bir özelliktir; Örneğin, bir dockerfile, gerçekten aldığı **`FROM mcr.microsoft.com/dotnet/core/sdk:2.2`** **`2.2-nanoserver-1709`** kayıt defterinden bir temel görüntü istediğinde, **`2.2-nanoserver-1803`** **yadaDocker'ınçalıştırıldığıişletimsistemine`2.2-stretch`** ve sürümüne bağlı olarak. **`2.2-nanoserver-1809`**
...
>[Önceki](what-is-docker.md)İleri
