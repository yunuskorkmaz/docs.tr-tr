...
Daha fazla bilgi için bkz. [sanal makine N katmanlı başvuru mimarisi](/azure/architecture/reference-architectures/virtual-machines-windows/n-tier).
...
Daha fazla bilgi için bkz. [sanal makineler](/azure/virtual-machines/).
...
[Örnek bir uygulama](/azure/sql-database/saas-tenancy-welcome-wingtip-tickets-app)aracılığıyla SaaS hakkında daha fazla bilgi edinin.
...
Düzenleme hakkında daha fazla bilgi için bkz. [Azure 'Da Kubernetes](/azure/aks/intro-kubernetes).
...
- **Mikro faturalama.** Çoğu sunucusuz sağlayıcı, belirli senaryolarda büyük maliyet tasarrufu sağlayan sunucusuz yürütmeler temelinde faturalandırılır.
...
Sunucusuz genellikle işlem bağlamında tartışılır, ancak veriler için de uygulanabilir. Örneğin, [Azure SQL](/azure/sql-database) ve [Cosmos DB](/azure/cosmos-db) her ikisi de konak makinelerini veya kümelerini yapılandırmanızı gerektirmeyen bulut veritabanları sağlar. Bu kitap sunucusuz işlem üzerine odaklanır.
...
- [Azure Uygulama Mimarisi Kılavuzu](/azure/architecture/guide/)
- [Azure Cosmos DB](/azure/cosmos-db)
- [Azure SQL](/azure/sql-database)
- [N katmanlı mimari model](/azure/architecture/guide/architecture-styles/n-tier)
- [Azure’da Kubernetes](/azure/aks/intro-kubernetes)
- [Mikro hizmetler](/azure/architecture/guide/architecture-styles/microservices)
- [Sanal makine N katmanlı başvuru mimarisi](/azure/architecture/reference-architectures/virtual-machines-windows/n-tier)
- [Sanal makineler](/azure/virtual-machines/)
- [Docker nedir?](../microservices/container-docker-introduction/docker-defined.md)
- [Wingtip bilet SaaS uygulaması](/azure/sql-database/saas-tenancy-welcome-wingtip-tickets-app)
