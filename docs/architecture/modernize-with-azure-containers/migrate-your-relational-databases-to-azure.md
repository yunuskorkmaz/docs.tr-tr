...
Azure 'da, veritabanı sunucularınızı doğrudan IaaS VM 'lerine (saf kaldırma ve kaydırma) geçirebilir veya ek avantajlar için Azure SQL veritabanı 'na geçiş yapabilirsiniz. Azure SQL veritabanı yönetilen örneği ve tam hizmet olarak veritabanı (DBaaS) seçeneklerini sunar. Şekil 3-1, Azure 'da kullanılabilen birden çok ilişkisel veritabanı geçiş yolunu gösterir.
...
Özgün bir RDBMS 'yi her değiştirdiğinizde yeniden test etmeniz gerekebilir. Ayrıca, test sonuçlarına bağlı olarak uygulamanızdaki SQL cümleleri veya Object-Relational eşleme (ORM) kodunu değiştirmeniz gerekebilir.
