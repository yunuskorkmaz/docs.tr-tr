...
- **Uygulama geliştirme**: kapsayıcılar içinde çalışan uygulamalar oluştururken birçok dil arasından seçim yapabilirsiniz. Bu kılavuz [.net](https://www.microsoft.com/net)'e odaklanır, ancak Node. js, Python, yay/Java veya Go gibi diğer dilleri kullanarak kapsayıcı tabanlı uygulamalar geliştirebilirsiniz.
