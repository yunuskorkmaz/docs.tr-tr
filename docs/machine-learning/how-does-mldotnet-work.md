...
Kod parçacığında `Concatenate` ve `Sdca` katalogdaki her iki yöntemlerdir. Oluşturdukları her bir [IEstimator](xref:Microsoft.ML.IEstimator`1) ardışık düzenine eklenen nesne.
