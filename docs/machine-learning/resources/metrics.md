...
| **AUCPR** | *Precision-Recall eğrisinin eğrisi altındaki* aucpr veya alan: sınıflar imletilmiş (yüksek oranda eğilmiş veri kümeleri) olduğunda, tahmin başarısı için yararlı ölçüm. |  **1,00 ' ye yaklaşarak daha iyidir**. 1,00 ' e yakın yüksek puanlar, sınıflandırıcının doğru sonuçları (yüksek duyarlık) döndürdüğünü ve tüm pozitif sonuçların (yüksek geri çağırma) büyük bir kısmını döndürdüğünü gösterir. |
...
- [Precision-Recall ve ROC eğrileri arasındaki Ilişki](http://pages.cs.wisc.edu/~jdavis/davisgoadrichcamera2.pdf)
