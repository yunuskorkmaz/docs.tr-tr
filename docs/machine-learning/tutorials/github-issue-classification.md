...
Sorun kategorisi tahmininizde birden çok kategoriden (veya çoklu sınıflar) olamayacağından bu sorun türünün veya çoklu sınıflar sınıflandırma görevi yerine iki kullanın (ikili).
