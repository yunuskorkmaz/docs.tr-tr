...
1. Tuşuna **F5** oluşturun ve uygulamayı çalıştırın. Bir konsol penceresi ve şu metnin erişemediklerinde sunulması gereken: **Hizmet, uygulamadan çıkmak içinse diğer herhangi bir tuşa çağırmak için Enter tuşuna basın:**  
