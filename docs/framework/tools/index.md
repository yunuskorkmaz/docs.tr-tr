...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Makine ilke düzeyi, kullanıcı ilke düzeyi ve kurumsal ilke düzeyi için güvenlik ilkesi görüntülemenize ve yapılandırmanıza olanak tanır. .NET Framework 4 ve sonrasında, bu araç, [ \<legacycaspolicy > öğesi](../configure-apps/file-schema/runtime/netfx40-legacysecuritypolicy-element.md) olarak `true`ayarlanmadığı takdirde kod erişim güvenliği (CAS) ilkesini etkilemez. Daha fazla bilgi için bkz. [güvenlik değişiklikleri](../security/security-changes.md).  
