...
|**-remgroup** {*label &#124;name*}<br /><br /> veya<br /><br /> **-rg** {l*abel &#124; adı*}|Etiketinin veya adının belirttiği kod grubunu kaldırır. Belirtilen kod grubunda alt kod grupları varsa, Caspol.exe tüm alt kod gruplarını da kaldırır.|  
