...
> [!IMPORTANT]
> .NET Framework 4 ' te başlayarak, [ \<legacycaspolicy > öğesi](../configure-apps/file-schema/runtime/netfx40-legacysecuritypolicy-element.md) olarak `true`ayarlanmadıkça Caspol. exe CAS ilkesini etkilemez. CasPol.exe tarafından gösterilen veya değiştirilen ayarlar yalnızca CAS ilkesini kullanmayı seçen uygulamaları etkiler. Daha fazla bilgi için bkz. [güvenlik değişiklikleri](../security/security-changes.md).  
...
|**-e** [**xecution**] {**on** &#124; **off**}|Kod yürütülmeye başlamadan önce çalıştırmak için izni denetleyen mekanizmayı etkinleştirir veya devre dışı bırakır. **Not:**  Bu anahtar .NET Framework 4 ve sonraki sürümlerinde kaldırılır. Daha fazla bilgi için bkz. [güvenlik değişiklikleri](../security/security-changes.md).|  
