...
## <a name="gamepiece-class"></a>GamePiece sınıfı  
 Aşağıdaki kod tüm gösterir **GamePiece** sınıfı.  
...
## <a name="gamepiececollection-class"></a>GamePieceCollection sınıfı  
 Aşağıdaki kod tüm gösterir **GamePieceCollection** sınıfı.  
...
## <a name="game1-class"></a>Game1 sınıfı  
 Aşağıdaki kod tüm gösterir **Game1** sınıfı.  
