...
[.NET Framework 4.0.3](https://www.microsoft.com/download/details.aspx?id=29053) , Windows XP ve windows Server 2003 ' de desteklenen en son .NET Framework sürümdür. .NET Framework 4.0.3, önce [.NET Framework 4 ' ün](https://dotnet.microsoft.com/download/dotnet-framework/net40) yüklenmesini gerektirir. Bu .NET Framework sürümlerinin her ikisi de artık Microsoft tarafından desteklenmemektedir.

## <a name="net-framework-4"></a>.NET Framework 4

Windows XP 'de [.NET Framework 4](https://dotnet.microsoft.com/download/dotnet-framework/net40) ' ü yükleyebilirsiniz. Artık Microsoft tarafından desteklenmemektedir.

## <a name="net-framework-35"></a>.NET Framework 3.5

Windows XP 'de [3,5 .NET Framework](https://dotnet.microsoft.com/download/dotnet-framework/net35-sp1) yükleyebilirsiniz.
