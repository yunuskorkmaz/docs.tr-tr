...
|.NET framework 4.5 *.x*/4.6 *.x*/4.7 *.x*  /bileşen deposu bozuk olduğundan 4.8 yüklenmedi.|Bkz: [DISM ya da sistem güncelleştirme hazırlığı aracını kullanarak Windows güncelleştirme düzeltme hataları](https://support.microsoft.com/kb/947821) daha fazla bilgi için.|  
