...
|.NET Framework 4.5. x zaten bu işletim sisteminin bir parçası, ancak şu anda kapalı (yalnızca[!INCLUDE[winserver8](../../../includes/winserver8-md.md)]).| .NET Framework 4.5. x ' i açmak için **Denetim Masası** 'ndaki **Windows özelliklerini aç veya kapat** seçeneğini kullanın. |  
