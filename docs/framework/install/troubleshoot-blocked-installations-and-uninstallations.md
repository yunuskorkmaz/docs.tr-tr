...
|.NET Framework 4.5. x zaten bu işletim sisteminin bir parçası, ancak şu anda kapalı (yalnızca[!INCLUDE[winserver8](../../../includes/winserver8-md.md)]).|Bkz. Windows Web sitesindeki [Windows özelliklerini açma veya kapatma](https://go.microsoft.com/fwlink/p/?LinkId=248438) .|  
