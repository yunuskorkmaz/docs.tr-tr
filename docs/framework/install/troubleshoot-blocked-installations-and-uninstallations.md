...
Bu tabloda, 4.5. x .NET Framework 4,5 ve Point yayımları, 4.5.1 ve 4.5.2, 4.6. x, .NET Framework 4,6 ve Point yayımları, 4.6.1 ve 4.6.2, 4.7. x .NET Framework 4,7 ve onun nokta sürümleri, 4.7.1 ve 4.7.2 anlamına gelir ve 4,8 .NET Framework 4,8 anlamına gelir.
