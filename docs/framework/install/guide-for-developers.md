...
- [4.5.2](https://dotnet.microsoft.com/download/dotnet-framework/net452) veya daha önceki sürümleri, Visual Studio 2013, Visual Studio 2012 veya diğer Ides Windows 8.1 'te sürüm 4.5.2 yüklemek için .NET Framework.
- Visual Studio 2012 veya diğer Ides 'te sürüm 4.5.1 yüklemek için [4.5.1 .NET Framework](https://dotnet.microsoft.com/download/dotnet-framework/net451) .
...
- Uygulamanızı .NET Framework 4 ' ten .NET Framework 4,5 veya sonraki sürümlere geçirme hakkında daha fazla bilgi için, [geçiş kılavuzuna](../migration-guide/index.md)bakın.
