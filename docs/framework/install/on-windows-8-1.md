...
ms.locfileid: "33391670"
---
# <a name="install-the-net-framework-on-windows-81-and-windows-server-2012-r2"></a>Windows 8.1 ve Windows Server 2012 R2'de .NET Framework'ü yüklemek
...
Bu yönergeleri, ihtiyacınız olan .NET Framework sürümlerini yüklemenize yardımcı olur. [.NET Framework 4.7.2](http://go.microsoft.com/fwlink/?LinkID=863255) en son sürümüdür. Windows 8.1 ve Windows Server 2012 R2'de desteklenir ve içerdiği [10 Nisan 2018 Windows Update](https://www.microsoft.com/software-download/windows10).
...
Yüklemek için yönergeleri izleyin [.NET Framework 3.5 Windows 8.1 ve 10](dotnet-35-windows-10.md).
