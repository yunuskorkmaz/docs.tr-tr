...
|[\<Prefercomınsteadofmanagedremoting >](../../../../../docs/framework/configure-apps/file-schema/runtime/prefercominsteadofmanagedremoting-element.md)|Çalışma zamanı uygulama etki alanı sınırlarında yerine remoting COM birlikte çalışma kullanacağını belirtir.|  
