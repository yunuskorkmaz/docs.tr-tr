 ...
 *configurationName*  
 ...
 Bitiş noktası yapılandırma adını belirtir. Bu parametrenin değeri **null** ya da boş olmamalıdır. Bu koşullar karşılanmıyorsa, oluşturucuyu ve bu sınıfın diğer yöntemlerini kullanmanın çalışma zamanı sonucu tanımsızdır.  
  
 *proxyNamespace*  
  
 İşlem için hizmet ad alanını belirtir. Bu parametrenin değeri **null** ya da boş olmamalıdır. Bu koşullar karşılanmıyorsa, oluşturucuyu ve bu sınıfın diğer yöntemlerini kullanmanın çalışma zamanı sonucu tanımsızdır.  
