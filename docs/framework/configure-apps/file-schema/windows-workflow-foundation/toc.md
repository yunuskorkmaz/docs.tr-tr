# [Windows Workflow Foundation Yapılandırma Şeması](index.md)
## [<system.serviceModel>](system-servicemodel-of-workflow.md)
### [<behaviors>](behaviors-of-workflow.md)
#### [<serviceBehaviors>](servicebehaviors-of-workflow.md)
##### [<behavior> / <serviceBehaviors>](behavior-of-servicebehaviors-of-workflow.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [Sorgularda Ek Açıklama Kullanma](using-annotation-in-queries.md)
## [Ek Yönetilen Başvuru](additional-managed-reference.md)
