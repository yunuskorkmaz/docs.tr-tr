...
|Öznitelik|Açıklama|  
|---------------|-----------------|  
|action|İşlenmeyen bir özel durum oluştuğunda gerçekleştirilecek eylemi belirten bir dize. Bu öznitelik türü<xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction>|  
