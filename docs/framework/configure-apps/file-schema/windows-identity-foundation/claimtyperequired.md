...
|Öğe|Açıklama|  
|-------------|-----------------|  
|[\<claimType >](../../../../../docs/framework/configure-apps/file-schema/windows-identity-foundation/claimtype.md)|Gelen güvenlik belirteçleri için tek bir isteğe bağlı veya gerekli talep belirtir.|  
