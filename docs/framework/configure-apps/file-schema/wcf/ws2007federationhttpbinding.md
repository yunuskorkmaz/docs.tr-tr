...
|`privactyNoticeAt`|Gizlilik bildirimini bulunduğu bir URI.|  
|`privactyNoticeVersion`|Geçerli gizlilik bildirimini sürümü.|  
...
|`textEncoding`|İletileri bağlamadaki yayma için kullanılacak kodlama karakter kümesini ayarlar. Geçerli değerler şunlardır:<br /><br /> -BigEndianUnicode: Unicode büyük Endian'ya kodlaması.<br />-Unicode: 16-bit kodlaması.<br />-UTF8: 8-bit kodlaması.<br /><br /> UTF8 varsayılandır. Bu öznitelik türünde <xref:System.Text.Encoding>.|  
