...
|Öğe|Açıklama|  
|-------------|-----------------|  
|[\<Güvenlik >](security-of-peertransport.md)|Bu taşımanın güvenlik ayarlarını tanımlar. Bu öğe <xref:System.ServiceModel.Configuration.PeerSecurityElement>türündedir.|  
