...
Taşıma kanalı oluşturulmalıdır URI belirtir. Daha fazla bilgi için bkz. <xref:System.ServiceModel.Description.ClientViaBehavior>.  
...
|Öznitelik|Açıklama|  
|---------------|-----------------|  
|`viaUri`|Rotayı gösteren bir URI belirten bir dize bir ileti almanız gerekir.|  
