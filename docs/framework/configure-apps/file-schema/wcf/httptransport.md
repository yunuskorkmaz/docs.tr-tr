...
## <a name="remarks"></a>Açıklamalar  
 `httpTransport` Öğesidir başlangıç noktası HTTP aktarım protokolünü uygulayan bağlaması özel oluşturma için. Birlikte çalışabilirlik amaçlar için kullanılan birincil aktarım HTTP'dir. Bu aktarım olmayan birlikte çalışabilirliği sağlamak için Windows Communication Foundation (WCF) tarafından desteklenen[!INCLUDE[indigo2](../../../../../includes/indigo2-md.md)] Web Hizmetleri yığınları.  
