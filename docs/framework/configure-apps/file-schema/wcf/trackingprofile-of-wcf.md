...
---
# <a name="trackingprofile-of-wcf"></a>\<WCF > trackingProfile
...
|Öğe|Açıklama|  
|-------------|-----------------|  
|[\<Katılımcılar >](../windows-workflow-foundation/participants.md)|Belirli bir iş akışı tarafından tanımlanan tüm sorgularında içeren bir yapılandırma öğesi <xref:System.ServiceModel.Activities.Tracking.Configuration.ProfileWorkflowElement.ActivityDefinitionId?displayProperty=nameWithType> özelliği.|  
