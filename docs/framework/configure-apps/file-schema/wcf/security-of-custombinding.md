...
|securityHeaderLayout|İsteğe bağlı. Güvenlik üst bilgisindeki öğelerin sıralamasını belirtir. Geçerli değerler:<br /><br /> -   `Strict`: Öğeler "kullanılmadan önce bildirme" Genel İlkesi göre güvenlik üstbilgisi eklenir.<br />-   `Lax`: WSS için onaylar herhangi bir sırada güvenlik başlığına öğeleri eklendi: SOAP ileti güvenliği.<br />-   `LaxWithTimestampFirst`: WSS için onaylar herhangi bir sırada güvenlik başlığına öğeleri eklendi: SOAP ileti güvenliği dışında güvenlik üst bilgisi içindeki ilk öğeyi wsse:Timestamp öğesi olmalıdır.<br />-   `LaxWithTimestampLast`: WSS için onaylar herhangi bir sırada güvenlik başlığına öğeleri eklendi: SOAP ileti güvenliği dışında güvenlik üst bilgisi içindeki son öğeden bir wsse:Timestamp öğesi olmalıdır.<br /><br /> Varsayılan, `Strict` değeridir.<br /><br /> Bu öğe türünde <xref:System.ServiceModel.Channels.SecurityHeaderLayout>.|  
