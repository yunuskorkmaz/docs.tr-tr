...
Gerekli talep türlerinin koleksiyonunu belirtir.  
 ...
 Talep türü gereksinimi, verilen belirteçte istenen belirteç için talep türünün URI 'sinden ve bu talep türünün verilen belirteçte gerekli olup olmadığını belirten bir Boolean parametresiyle oluşur.  
...
- [Federasyon ve Verilen Belirteçler](../../../wcf/feature-details/federation-and-issued-tokens.md)
- [\<> Ekle](add-of-claimtyperequirements.md)
