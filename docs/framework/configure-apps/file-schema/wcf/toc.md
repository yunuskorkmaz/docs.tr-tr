# [WCF Yapılandırma Şeması](index.md)
...
######## [<add> / <defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings> / <namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add> / <namespaceTable>](add-of-namespacetable.md)
