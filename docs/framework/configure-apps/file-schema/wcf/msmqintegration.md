...
|deadLetterQueue|Kullanılacak geçerliliğini yitirmiş kuyruk türünü belirtir.<br /><br /> Geçerli değerler<br /><br /> -Özel: Özel teslim edilemeyen iletiler sırası.<br />-: Hiçbir teslim edilemeyen iletiler sırası kullanılacak Yok'tur.<br />-Sistem: Sistem teslim edilemeyen iletiler sırası kullanın.<br /><br /> Bu öznitelik DeadLetterQueue türüdür.|  
