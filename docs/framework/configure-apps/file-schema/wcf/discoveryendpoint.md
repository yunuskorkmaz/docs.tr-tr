...
Aşağıdaki örnek, bir eş ağ çok noktaya yayın aktarımı üzerinden keşif iletilerini dinleyen bir hizmeti gösterir. Örnek açıkça WS-Discovery Nisan 2005 sürümünü belirtir.  
