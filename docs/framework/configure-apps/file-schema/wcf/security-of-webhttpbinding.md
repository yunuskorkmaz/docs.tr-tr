...
Yapılandırılmış uç noktaya ilişkin güvenlik gereksinimlerini belirleyen bir [ \<webHttpBinding >](../../../../../docs/framework/configure-apps/file-schema/wcf/webhttpbinding.md).  
