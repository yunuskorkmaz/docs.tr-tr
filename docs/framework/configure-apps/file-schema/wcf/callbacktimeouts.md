...
|Öznitelik|Açıklama|  
|---------------|-----------------|  
|`transactionTimeout`|<xref:System.TimeSpan>İşlemlerin tamamlaması gereken veya otomatik olarak sonlandırılacağı zaman aralığını belirten bir değer. Varsayılan değer "00:00:00" dır.|  
