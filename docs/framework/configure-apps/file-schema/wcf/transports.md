...
Aktarım katmanı, kanal yığınının en düşük düzeyindedir. Windows Communication Foundation (WCF) ' de kullanılan ana aktarımlar HTTP, HTTPS, TCP ve adlandırılmış kanallardır. Bu bölüm, farklı türde aktarımlar yapılandırmanıza izin veren tüm yapılandırma öğelerini listeler.  
