...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 Tarafından sağlanan şifreleme hizmetlerine genel bakış sağlayan [!INCLUDE[winsdkshort](../../../includes/winsdkshort-md.md)].  
  
 [Şifreleme Ayarları Şeması](../../../docs/framework/configure-apps/file-schema/cryptography/index.md)  
 Şifreleme algoritmalarını uygulayan sınıflar için kolay algoritma adlarını eşleme öğelerini açıklar.
