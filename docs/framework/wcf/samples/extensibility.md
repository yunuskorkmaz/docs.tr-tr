...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Keşif genişletilebilirliği](../../../../docs/framework/wcf/samples/discovery-extensibility.md)  
 Özel bulma gösterir.  
 ...
 [İşlem biçimlendirici ve işlem Seçici](../../../../docs/framework/wcf/samples/operation-formatter-and-operation-selector.md)  
 ...
 [Üzerinden hata işleme ve bildirme denetimini genişletme](../../../../docs/framework/wcf/samples/extending-control-over-error-handling-and-reporting.md)  
