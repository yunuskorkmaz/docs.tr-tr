...
2. Çözümün oluşturulması üç dosya üretir: CustomChannelsTester.exe, TestSpec.xml ve SampleRun. cmd. SampleRun. cmd dosyası, taşımayı test etmek için bu aracın nasıl kullanılacağını gösteren örnek bir komut satırına sahiptir [: UDP](transport-udp.md) örneği.  
