...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Dayanıklı örnek bağlamı etkinleştirmek için WCF çalışma zamanı özelleştirmek gösterilmiştir.  
  
 [Özel Yaşam Süresi](../../../../docs/framework/wcf/samples/custom-lifetime.md)  
 Paylaşılan WCF hizmet örneği için özel yaşam süresi hizmetleri sağlamak için WCF uzantısı yazılacağını gösterir.  
 ...
 Nesne havuzu desteklemek için Windows Communication Foundation (WCF) genişletmek gösterilmiştir.
