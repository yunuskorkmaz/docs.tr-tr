...
1. Hizmet IIS 'de barındırılıyorsa:  
    ...
    1. Hizmet makinesinde, ServiceModelSamples adlı bir sanal dizin oluşturun. [Windows Communication Foundation Örnekleri Için bir kerelik kurulum yordamında](one-time-setup-procedure-for-the-wcf-samples.md) bulunan Setupvroot. bat toplu iş dosyası, disk dizini ve sanal dizin oluşturmak için kullanılabilir.  
