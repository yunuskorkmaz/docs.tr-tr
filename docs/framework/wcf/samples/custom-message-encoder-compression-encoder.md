...
-   <span data-ttu-id="3de0d-124">Bir bağlama öğesi için özel bir kodlayıcı geliştirme.</span><span class="sxs-lookup"><span data-stu-id="3de0d-124">Developing a binding element for a custom encoder.</span></span>  
