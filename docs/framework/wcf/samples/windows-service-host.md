...
3. Çözüm derlendikten sonra, Installutil.exe aracını kullanarak Windows hizmetini yüklemek için yükseltilmiş bir Visual Studio 2012 komut isteminden Setup.bat çalıştırın. Hizmet, hizmetler 'de görünmelidir.  
