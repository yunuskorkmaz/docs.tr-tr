...
Bu bölümde Windows hizmet bağlamayı gösteren örnekleri içeren [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
  
## <a name="in-this-section"></a>Bu Bölümde  
 [WS işlem akışı](../../../../docs/framework/wcf/samples/ws-transaction-flow.md)  
 ...
 [WS ikili Http](../../../../docs/framework/wcf/samples/ws-dual-http.md)  
