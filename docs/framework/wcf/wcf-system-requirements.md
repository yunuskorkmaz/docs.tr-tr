...
Windows Communication Foundation (WCF) dağıtılmış uygulamaları oluşturmak için kullanılan bir iletişim altyapısıdır. Çalıştırmak WCF etkinleştirme gereksinimleri aşağıda listelenmektedir.  
  
## <a name="system-requirements"></a>Sistem Gereksinimleri  
 WCF üzerinde varsayılan olarak yüklenir [!INCLUDE[wv](../../../includes/wv-md.md)].  
  
 WCF da yüklenebilir üzerinde [!INCLUDE[wxpsp2](../../../includes/wxpsp2-md.md)], [!INCLUDE[ws2003r2](../../../includes/ws2003r2-md.md)], veya [!INCLUDE[ws2003sp1](../../../includes/ws2003sp1-md.md)].  
