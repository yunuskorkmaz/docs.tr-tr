...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl yapılır: meta verilerini almak için MetadataExchangeClient kullanma](../../../../docs/framework/wcf/feature-details/how-to-use-metadataexchangeclient-to-retrieve-metadata.md)  
