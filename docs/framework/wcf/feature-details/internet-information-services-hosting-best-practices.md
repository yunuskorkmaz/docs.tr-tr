---
description: 'Hakkında daha fazla bilgi edinin: Internet Information Services barındırma En Iyi uygulamaları'
...
## <a name="service-hosts-in-iis-hosted-applications"></a>IIS-Hosted uygulamalarında hizmet ana bilgisayarları  
...
## <a name="uris-and-iis-hosted-endpoints"></a>URI 'Ler ve IIS-Hosted uç noktaları  
...
## <a name="optimizing-performance-in-middle-tier-scenarios"></a>Middle-Tier senaryolarda performansı iyileştirme  
