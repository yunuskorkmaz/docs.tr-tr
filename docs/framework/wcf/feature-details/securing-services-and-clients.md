...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Aktarım katmanı üzerinden ileti güvenliğini sağlama genel bakış.  
  
 [İleti Güvenliği](../../../../docs/framework/wcf/feature-details/message-security-in-wcf.md)  
 İleti düzeyi güvenlik kullanma nedenleri özetler [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
  
 [Güvenli Oturumlar](../../../../docs/framework/wcf/feature-details/secure-sessions.md)  
 Güvenli hale getirirken gerekli konuları tartışması bir [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] oturumu.  
  
 [Sertifikalarla Çalışma](../../../../docs/framework/wcf/feature-details/working-with-certificates.md)  
 Bir açıklama bazı ortak görevler X.509 sertifikalarını kullanılırken gereklidir.  
