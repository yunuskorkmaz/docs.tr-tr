...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Windows Communication Foundation (WCF) ileti düzeyi güvenlik kullanma nedenleri özetler.  
  
 [Güvenli Oturumlar](../../../../docs/framework/wcf/feature-details/secure-sessions.md)  
 Bir WCF oturumu güvenli hale getirirken gerekli konuları tartışma.  
