...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Bazı yeni bulma özellikler prototip uyarlamasını kısa bir genel bakış sağlar. Ayrıca bulma sürümün kullanılacağını seçme hakkında genel bir bakış sağlar.  
  
 [Yapılandırma dosyasındaki yapılandırma bulma](../../../../docs/framework/wcf/feature-details/configuring-discovery-in-a-configuration-file.md)  
