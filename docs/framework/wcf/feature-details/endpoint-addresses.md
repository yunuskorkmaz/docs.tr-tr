...
### <a name="endpoints-in-wsdl"></a>WSDL 'deki uç noktalar  
 ...
 Bir uç nokta adresi, WSDL 'de karşılık gelen bitiş noktası öğesinin içinde bir WS-Addressing EPR öğesi olarak da gösterilebilir `wsdl:port` . EPR, uç noktanın adresini ve tüm adres özelliklerini içerir. Ayrıntılar ve bir örnek için bkz. [bir uç nokta adresi belirtme](../specifying-an-endpoint-address.md).  
