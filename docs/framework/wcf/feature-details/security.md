...
Bu bölümdeki konularda açıklanmaktadır [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] güvenlik özellikleri ve bunları güvenli iletiler yardımcı olmak için kullanma.  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Bkz: Windows Server AppFabric ve güvenlik, [Windows Server AppFabric güvenlik modeli](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
  
## <a name="in-this-section"></a>Bu Bölümde  
 [Güvenliğe Genel Bakış](../../../../docs/framework/wcf/feature-details/security-overview.md)  
 Güvenlik özellikleri açıklar [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
  
 [Güvenlik Kavramları](../../../../docs/framework/wcf/feature-details/security-concepts.md)  
 Temel terimler ve kullanılan kavramlar açıklanmaktadır [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] güvenlik.  
  
 [Ortak Güvenlik Senaryoları](../../../../docs/framework/wcf/feature-details/common-security-scenarios.md)  
 Senaryolar ve Topolojileri ile yapılandırabileceğiniz açıklanmıştır [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
 ...
 Kullanarak iletileri güvenli hale getirmek açıklar [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] güvenlik özellikleri.  
 ...
 Kısmen güvenilen senaryoları çalıştırılacağını açıklar ve [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] kısmen güvenilen çalıştırırken sınırlamaları.  
 ...
 Güvenli oluşturma yönergeleri [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] uygulamalar.  
