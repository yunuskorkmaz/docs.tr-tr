...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl yapılır: bir sözleşmeyi SOAP ve Web istemcileri kullanıma sunma](../../../../docs/framework/wcf/feature-details/how-to-expose-a-contract-to-soap-and-web-clients.md)  
 ...
 [WCF Web HTTP hata işleme](../../../../docs/framework/wcf/feature-details/wcf-web-http-error-handling.md)  
 ...
 [Bir WCF hizmetinden REST tarzı bir hizmete çağırma](../../../../docs/framework/wcf/feature-details/calling-a-rest-style-service-from-a-wcf-service.md)  
