...
### <a name="when-to-use-http-transport"></a>HTTP taşıma kullanma zamanı  
 ...
 İçinde [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], HTTP aktarım bağlama eski olmayan ile birlikte çalışabilirlik getirilmiştir[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] sistemler. Tüm iletişim kuran tarafların kullanıyorsanız [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], TCP tabanlı veya adlandırılmış kanallar tabanlı bağlamalar daha hızlıdır. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)]<xref:System.ServiceModel.NetTcpBinding> ve <xref:System.ServiceModel.NetNamedPipeBinding>.  
...
|Ulaşma|Bir taşıma ulaşabileceği nasıl özellikli taşıma olan diğer sistemleri ile bağlama sırasında yansıtır. Adlandırılmış kanal taşıma çok az ulaştığından; yalnızca aynı makinede çalışan hizmetlere bağlanabilir. TCP ve HTTP taşımaları mükemmel reach sahip hem bazı NAT ve güvenlik duvarı yapılandırmaları sızmasını. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][NAT ve güvenlik duvarlarıyla çalışma](../../../../docs/framework/wcf/feature-details/working-with-nats-and-firewalls.md).|HTTP, TCP|  
