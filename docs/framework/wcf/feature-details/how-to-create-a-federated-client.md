...
ms.locfileid: "33496977"
---
# <a name="how-to-create-a-federated-client"></a>Nasıl yapılır: Federe İstemci Oluşturma
Windows Communication Foundation (WCF) için bir istemci oluşturma bir *Federasyon Hizmeti* üç ana adımdan oluşur:  
