...
## <a name="iis-70-installation-with-iis-60-compatibility-components"></a>IIS 7,0: IIS 6,0 uyumluluk bileşenleriyle yükleme
 ...
 IIS 7,0 metatabanı API 'SI kullanan sanal 6,0 uygulamaları yapılandıran Visual Studio 2005 veya diğer otomasyon betikleri ya da araçları (örneğin Adsutil.vbs) olan bir sisteme IIS ' i yüklerken IIS 6,0 **Scripting araçları**' nı denetletdiğinizden emin olun. Bu, IIS 6,0 **Yönetim uyumluluğun** diğer alt düğümlerini otomatik olarak denetler. Aşağıdaki çizimde, Bu yapıldıktan sonra ekran gösterilmektedir:
