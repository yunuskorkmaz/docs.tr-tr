...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Açıklayan nasıl <xref:System.ServiceModel.WorkflowServiceHost> gelen iletileri işler.  
  
 [İş Akışı Hizmeti Konak Genişletilebilirliği](../../../../docs/framework/wcf/feature-details/workflow-service-host-extensibility.md)  
 İş akışı hizmeti konağı genişletmek açıklar.  
 ...
 Kalıcılık, izleme, boş ve işlenmeyen özel durum davranışını denetlemek nasıl açıklar.  
