...
Windows Communication Foundation (WCF) işlemleri özelliği eşzamanlı olarak veri işleminde yer çeşitli bileşenleri sağlar. Bu bölümdeki konularda ayrıntılı özelliğini inceleyin.  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 WCF tarafından sağlanan işlemleri özelliğine genel bakış.  
 ...
 WS-AtomicTransaction (WS-AT) içinde WCF uygulanan bir birlikte çalışabilen işlem yayma protokolü açıklar.  
  
 [System.ServiceModel İşlemsel Desteği](../../../../docs/framework/wcf/feature-details/transactional-support-in-system-servicemodel.md)  
 WCF tarafından sağlanan işlem işlevler açıklanmaktadır.  
