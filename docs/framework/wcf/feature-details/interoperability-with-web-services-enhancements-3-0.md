...
## <a name="in-this-section"></a>Bu Bölümde  
 [Nasıl yapılır: WCF hizmetlerini WSE 3.0 istemcileriyle birlikte çalışmak için yapılandırma](../../../../docs/framework/wcf/feature-details/how-to-configure-wcf-services-to-interoperate-with-wse-3-0-clients.md)  
 Microsoft .NET (WSE) istemci için bir Web Hizmetleri iyileştirmeleri 3.0 ile iletişim kurabilmesi için bir WCF hizmetini yapılandırma işlemini açıklamaktadır.  
  
 [Nasıl yapılır: Bir WCF istemcisini WSE3.0 hizmetleriyle yapılandırma](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-client-to-interoperate-with-wse3-0-services.md)  
 Böylece Web Hizmetleri iyileştirmeleri 3.0 için Microsoft .NET (WSE) hizmet ile iletişim kuran bir WCF istemcisini yapılandırma işlemi açıklanmaktadır.  
