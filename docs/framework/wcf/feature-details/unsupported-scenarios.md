...
- Sertifikaları sorgulamak için komut satırından `certutil` komutunu kullanın. Daha fazla bilgi için bkz. [sertifika sorunlarını giderme Için Certutil görevleri](https://go.microsoft.com/fwlink/?LinkId=120056).  
