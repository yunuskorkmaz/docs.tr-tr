---
title: Mesajlaşma etkinlikleri - WCF
ms.date: 03/30/2017
...
Bir istek/yanıt MEP hizmet ve istemci ayarlama kolaylaştırmak için Visual Studio 2012 iki Mesajlaşma etkinlik şablonları sağlar. `System.ServiceModel.Activities.Design.ReceiveAndSendReply` hizmette kullanılır ve `System.ServiceModel.Activities.Design.SendAndReceiveReply` istemci üzerinde kullanılır. Her iki durumda da, akışınıza uygun Mesajlaşma etkinlikleri şablonlara ekleyin. Hizmetinde `System.ServiceModel.Activities.Design.ReceiveAndSendReply` ekler bir <xref:System.ServiceModel.Activities.Receive> etkinliği tarafından izlenen bir <xref:System.ServiceModel.Activities.SendReply> etkinlik. <xref:System.ServiceModel.Activities.SendReply.Request> Otomatik olarak ayarlanırsa <xref:System.ServiceModel.Activities.Receive> etkinlik. İstemci üzerindeki `System.ServiceModel.Activities.Design.SendAndReceiveReply` ekler bir <xref:System.ServiceModel.Activities.Send> etkinliği tarafından izlenen bir <xref:System.ServiceModel.Activities.ReceiveReply>. <xref:System.ServiceModel.Activities.ReceiveReply.Request%2A> Otomatik olarak ayarlanırsa <xref:System.ServiceModel.Activities.Send> etkinlik. Bu şablonları kullanmak için sürükleyin ve uygun şablonu akışınızı üzerine bırakın.
