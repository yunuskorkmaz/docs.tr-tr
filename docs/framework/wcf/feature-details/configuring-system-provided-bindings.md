...
|<xref:System.ServiceModel.WSFederationHttpBinding>|WS-Federasyon|Hiçbiri (mesaj), karma|(Hiçbiri) güvenilir oturum|Evet (hiçbiri)|Hayır|  
|<xref:System.ServiceModel.WS2007FederationHttpBinding>|WS-Federasyon|Hiçbiri (mesaj), karma|(Hiçbiri) güvenilir oturum|Evet (hiçbiri)|Hayır|  
