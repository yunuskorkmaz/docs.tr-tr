...
|Ayar|Açıklama|  
|-------------|-----------------|  
|Hiçbiri|İstemcinin herhangi bir kimlik bilgisi sunması gerekmediğini belirtir. Bu, anonim bir istemciyi dönüştürür.|  
...
|Ayar|Açıklama|  
|-------------|-----------------|  
|Hiçbiri|İstemcinin bir kimlik bilgisi sunması gerekmediğini belirtir. Bu, anonim bir istemciyi dönüştürür.|  
