...
Bu belge Windows Communication Foundation (WCF) mimarisinin üst düzey bir görünümünü sağlar. Temel kavramları ve bunların birbirine nasıl uyduğunu açıklamak için tasarlanmıştır. WCF hizmeti ve istemcisinin en basit sürümünü oluşturmaya yönelik bir öğretici için bkz. [Başlangıç Öğreticisi](../../../docs/framework/wcf/getting-started-tutorial.md). WCF programlamayı öğrenmek için bkz. [Temel WCF programlama](../../../docs/framework/wcf/basic-wcf-programming.md).
...
Bir WCF istemcisi, [ServiceModel meta veri yardımcı programı Aracı (Svcutil. exe)](../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) kullanılarak otomatik olarak oluşturulabilir ve meta verileri yayımlayan çalışan bir hizmete işaret edebilir.
