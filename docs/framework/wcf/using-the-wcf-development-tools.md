...
```  
 ...
 Netsh.exe hakkında daha fazla bilgi için bkz. [Netsh.exe aracını ve Command-Line anahtarlarını kullanma](/previous-versions/tn-archive/bb490939(v=technet.10)).  
