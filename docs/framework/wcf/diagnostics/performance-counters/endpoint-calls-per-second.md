...
ms.locfileid: "61797221"
---
# <a name="endpoint-calls-per-second"></a>Uç noktası: Çağrı/saniye
Sayaç adı: Saniyede çağrı sayısı.  
  
## <a name="description"></a>Açıklama  
 Bu uç noktaya bir saniye içinde çağrı sayısı.  
