# [Tanılama için Windows Yönetim Araçlarını Kullanma](index.md)
## [WMI Sınıfı Başvurusu](wmi-class-reference.md)
...
### [Davranış sınıfı](behavior-class.md)
...
### [İşlem sınıfı](operation-class.md)
