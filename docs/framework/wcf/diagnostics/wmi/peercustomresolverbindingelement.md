...
## <a name="methods"></a>Yöntemler  
 PeerCustomResolverBindingElement sınıfı herhangi bir yöntem tanımlamıyor.  
  
## <a name="properties"></a>Özellikler  
 PeerCustomResolverBindingElement sınıfı aşağıdaki özelliklere sahiptir:  
