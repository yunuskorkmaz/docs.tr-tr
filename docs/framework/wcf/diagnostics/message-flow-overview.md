...
-   WCF/WF Hizmetleri için uçtan uca etkinlik modeli: Bu özellik, izlemeleri tarafından oluşturulan bağıntısı destekler <xref:System.ServiceModel> ve <xref:System.Workflow.ComponentModel> ad alanları.

-   ETW İzleme için WF: Bu özellik, iş akışının geçerli durumunu ve ilerlemesini görünürlük sağlamak için WF Hizmetleri tarafından oluşturulan izleme kayıtları kullanır.
