...
## <a name="description"></a>Açıklama  
 Yönlendirme hizmeti bir çift yönlü geri çağırma özel karşılaştığında bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Yönlendirme hizmeti bileşeni %1 çift yönlü geri çağırma özel durumla karşılaştı.  
