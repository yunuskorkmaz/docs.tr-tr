...
## <a name="description"></a>Açıklama  
 Uç nokta bulunabilirliğini devre dışı bırakıldığında bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 EndpointAddress noktayla bulunabilirliğini = '%1' ve ListenUri = '%2' devre dışı bırakıldı.  
