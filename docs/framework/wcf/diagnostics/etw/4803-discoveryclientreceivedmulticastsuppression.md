...
## <a name="description"></a>Açıklama  
 DiscoveryClient DiscoveryProxy çok noktaya yayın gizleme iletisi alındığında bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 DiscoveryClient DiscoveryProxy çok noktaya yayın gizleme iletisi aldı.  
