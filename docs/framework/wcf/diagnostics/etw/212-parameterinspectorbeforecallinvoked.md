...
## <a name="description"></a>Açıklama  
 Bu olay, hizmet modeli çağırdığı sonra yayıldığını `BeforeCall` metodunda bir `ParameterInspector`.  
  
## <a name="message"></a>İleti  
 Dağıtıcı 'BeforeCall' üzerinde '%1' türünde bir ParameterInspector çağrılır.  
