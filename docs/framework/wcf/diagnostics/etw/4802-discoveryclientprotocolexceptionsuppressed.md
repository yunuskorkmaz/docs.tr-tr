...
## <a name="description"></a>Açıklama  
 Bu olay gösterilen zaman DiscoveryClient kapatılırken bir ProtocolException engellendi.  
  
## <a name="message"></a>İleti  
 Bir ProtocolException DiscoveryClient kapatılırken engellendi. Bir DiscoveryService hala yanıt DiscoveryClient olarak göndermeye çalışıyor olmasından kaynaklanabilir.  
