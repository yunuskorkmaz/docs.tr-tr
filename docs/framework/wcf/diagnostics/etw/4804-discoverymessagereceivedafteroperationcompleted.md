...
## <a name="description"></a>Açıklama  
 Bu olay, bulma iletisi işlemi tamamlandıktan sonra alındığında yayınlanır.  
  
## <a name="message"></a>İleti  
 MessageID ile bir %1 ileti = '%2' karşılık gelen %3 işlemi tamamlanmadığından DiscoveryClient tarafından bırakıldı.  
