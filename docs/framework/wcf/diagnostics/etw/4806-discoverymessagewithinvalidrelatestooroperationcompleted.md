...
## <a name="description"></a>Açıklama  
 Bulma ileti DiscoveryClient tarafından karşılık gelen işlem tamamlandı ya da relatesTo değeri geçersiz olmadığından bırakıldı olduğunda bu olay yayınlanır.  
