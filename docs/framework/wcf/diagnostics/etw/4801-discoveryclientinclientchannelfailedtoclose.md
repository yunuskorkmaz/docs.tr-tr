...
## <a name="description"></a>Açıklama  
 Bu olay, DiscoveryClientChannel içinde oluşturulan DiscoveryClient kapatmak başarısız oldu ve bu nedenle durduruldu yayınlanır.  
  
## <a name="message"></a>İleti  
 DiscoveryClientChannel içinde oluşturulan DiscoveryClient kapatın ve bu nedenle durduruldu başarısız oldu.  
