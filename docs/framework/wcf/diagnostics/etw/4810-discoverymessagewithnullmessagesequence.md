...
## <a name="description"></a>Açıklama  
 DiscoveryMessageSequence özelliğine sahip olmadığından bulma ileti DiscoveryClient tarafından bırakıldı olduğunda bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 MessageID ile bir %1 ileti = DiscoveryMessageSequence özelliğine sahip olmadığından, '%2' DiscoveryClient tarafından bırakıldı.  
