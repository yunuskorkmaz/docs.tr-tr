...
## <a name="description"></a>Açıklama  
 Bu olay, yönlendirme hizmeti bir ileti işlenirken yayınlanır.  
  
## <a name="message"></a>İleti  
 Yönlendirme hizmeti Kimliğine sahip bir iletisi işliyor: '%1', eylem: '%2', gelen URL: '%3' işlemde alınan: %4.  
