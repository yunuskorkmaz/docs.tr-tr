...
## <a name="description"></a>Açıklama  
 Bu olay, hizmet modeli çağrılmış sonra yayınlanır `AfterCall` istemci parametre denetçisi yöntemi.  
  
## <a name="message"></a>İleti  
 Dağıtıcı '%1' türünde bir ClientParameterInspector ' AfterCall' çağrılır.  
