...
## <a name="description"></a>Açıklama  
 Bu olay, kanal fabrikası önbellekten kullanmadığınızda yayınlanır.  
  
## <a name="message"></a>İleti  
 Kanal fabrikası önbellekten kullanmayan, yani önbelleğe alma örneği için devre dışı.  
