...
## <a name="description"></a>Açıklama  
 ServiceType '%2' ve '%3' serviceHostFactoryType ile yeni bir Asp.Net yol '%1' eklendiğinde bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 ServiceType '%2' ve '%3' serviceHostFactoryType ile yeni bir Asp.Net yolu '%1' eklenir.  
