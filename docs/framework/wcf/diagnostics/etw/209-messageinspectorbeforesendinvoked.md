...
## <a name="description"></a>Açıklama  
 Bu olay, hizmet modeli çağırdığı sonra yayıldığını `BeforeSend` ileti denetçisi yöntemi.  
  
## <a name="message"></a>İleti  
 Dağıtıcı 'BeforeSendRequest' üzerinde '%1' türünde bir MessageInspector çağrılır.  
