...
## <a name="description"></a>Açıklama  
 Yönlendirme hizmeti mevcut işleminizi kullanarak iletileri gönderir, bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Yönlendirme hizmeti, '%1' varolan hareket kullanarak iletileri gönderir.  
