...
## <a name="description"></a>Açıklama  
 Yönlendirme hizmeti ile RouteOnHeadersOnly yapılandırıldığında bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Yönlendirme hizmeti ile RouteOnHeadersOnly yapılandırılır: %1, SoapProcessingEnabled: %2, EnsureOrderedDispatch: %3.  
