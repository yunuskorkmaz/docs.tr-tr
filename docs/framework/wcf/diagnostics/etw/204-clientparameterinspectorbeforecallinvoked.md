...
## <a name="description"></a>Açıklama  
 Bu olay, hizmet modeli çağırdığı sonra yayıldığını `BeforeCall` istemci parametresi denetçisi yöntemi.  
  
## <a name="message"></a>İleti  
 Dağıtıcı 'BeforeCall' üzerinde '%1' türünde bir ClientParameterInspector çağrılır.  
