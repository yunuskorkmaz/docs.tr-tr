...
## <a name="description"></a>Açıklama  
 Önbellek sınırına ulaştığı için bir kanal fabrikası önbellek dışına eski olduğunda bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Önbelleği '% 1', sınırına ulaştığı için bir kanal fabrikası önbellek dışına eski.  
