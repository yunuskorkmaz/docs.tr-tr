...
## <a name="description"></a>Açıklama  
 Bu olay, negotiate belirteç kimlik doğrulayıcı durumu önbellek oranı bilgi sağlamak için yayınlanır.  
  
## <a name="message"></a>İleti  
 Belirteç kimlik doğrulayıcı durumu önbelleği oranı anlaşma: %1 / %2  
