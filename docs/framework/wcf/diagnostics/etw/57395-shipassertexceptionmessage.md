...
## <a name="description"></a>Açıklama  
 Beklenmeyen bir hata oluştuğunda, bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Beklenmeyen bir hata oluştu. Uygulamalar, bu hatayı işlemeye çalışmamalısınız. Tanılama amacıyla İngilizce bu ileti hata ile ilişkilidir: %1.  
