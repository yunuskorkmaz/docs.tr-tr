...
## <a name="description"></a>Açıklama  
 Gelen istek Asp.Net rota adresi %1 ile tanımlanan bir WCF Hizmeti eşleştiğinde bu olay yayınlanır.  
  
## <a name="message"></a>İleti  
 Gelen istek Asp.Net rota adresi %1 ile tanımlanan bir WCF Hizmeti eşleşir.  
