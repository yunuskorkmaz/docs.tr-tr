...
## <a name="description"></a>Açıklama  
 Bu olay, yönlendirme hizmeti yedekleme Uç noktalara taşındıklarında yayınlanır.  
  
## <a name="message"></a>İleti  
 Yönlendirme hizmeti iletinin kimliği: '%1' [işlemi %2] '%3' yedekleme uç noktasına taşınır.  
