...
## <a name="description"></a>Açıklama  
 Bu olay, yinelenen bir yuva gönderilirken bir hata oluştu gösterir. Bu işleyici şimdi işlemde sızmış. Olay kaynağı, özel durum, işlem adı ve işlem kimliği listeler  
