...
## <a name="description"></a>Açıklama  
 Bu olay, yinelenen bir yuva gönderilirken bir hata oluştuğunu gösterir. Bu işleyici, işlemde artık sızmış. Olay kaynağı, özel durum, işlem adı ve işlem kimliği listeler  
