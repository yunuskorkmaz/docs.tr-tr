...
## <a name="description"></a>Açıklama  
 Düzenleyici listelemesi için bir kurtarma günlük girişi oluşturulamadı. İşlem iptal edilecek. Olay listeleri işlem kimliği, nedeni, özel durum, işlem adı ve işlem kimliği  
