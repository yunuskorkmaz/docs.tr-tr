...
## <a name="description"></a>Açıklama  
 Bu olay MSDTC WS-Atomic işlem protokolü kurtarma başında başarısız olduğunu gösterir. Sonuç olarak, WS-Atomic işlem işlevselliği devre dışı bırakıldı. Olay protokol kimliği, protokol adı, özel durum, işlem adı ve işlem kimliği listeler  
