...
## <a name="description"></a>Açıklama  
 Bu olay, bir kimlik sertifikası belirli konu adı ve parmak izi ile erişilebilir bir özel anahtara sahip olmadığını gösterir. İşlem kimliği ve işlem adı olay listeler  
