...
## <a name="description"></a>Açıklama  
 Bu olay, bir tür uyuşmazlığı oluştuğunu gösterir. Belirtilen bir CIM sınıfı özelliği, belirli türde değer kabul edemez. İşlem kimliği ve işlem adı olay listeler  
