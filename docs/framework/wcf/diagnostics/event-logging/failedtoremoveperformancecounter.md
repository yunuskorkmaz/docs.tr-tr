...
## <a name="description"></a>Açıklama  
 Bu olay, bir performans sayacı kaldırılmadı gösterir. Olay kategorisi adı, sayaç adı, örnek adı, özel durum, işlem adı ve işlem kimliği listeler  
