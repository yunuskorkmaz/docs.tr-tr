...
ms.author: erikre
manager: erikre
ms.openlocfilehash: 55da713706305eeb8fb4a5897c2bdbae949b705a
...
## <a name="description"></a>Açıklama  
 Bu olay, WMI Sağlayıcısı kaydı olmadığını gösterir. WMI nesnesi, hata, işlem adı ve işlem kimliği olay listeler  
