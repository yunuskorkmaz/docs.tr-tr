...
## <a name="description"></a>Açıklama  
 Bu olay, WS-Atomic işlem Protokolü hizmetini durdurmak başarısız olduğunu gösterir. Olay protokol kimliği, protokol adı, özel durum, işlem adı ve işlem kimliği listeler  
