...
## <a name="description"></a>Açıklama  
 Bu olay, bir Durum makinesi bir olay işleme sırasında işlenmeyen özel durum oluştu gösterir. Olay listeleri işlem kimliği, durum makine adı, geçerli durumu, geçmiş, kaydı kimliği, özel durum, işlem adı ve işlem kimliği  
