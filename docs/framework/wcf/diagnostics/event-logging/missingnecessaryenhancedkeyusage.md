...
## <a name="description"></a>Açıklama  
 Bu olay, bir kimlik sertifikası belirli konu adı ve parmak izi ile kendi EnhancedKeyUsages arasında belirli veri sağlamaz gösterir. İşlem kimliği ve işlem adı olay listeler  
