...
manager: mbaldwin
ms.workload: dotnet
ms.openlocfilehash: 44e8d4f144db36528d944b1a2335a41bead36c04
...
## <a name="description"></a>Açıklama  
 Bu olay, güvenlik anlaşması eylemini, istemci kimliği, ActivityID ve anlaşma hizmetin adını listeleyen başarılı olduğunu gösterir.  
