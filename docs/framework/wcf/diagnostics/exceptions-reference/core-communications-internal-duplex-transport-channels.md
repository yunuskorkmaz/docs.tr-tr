...
|-------------------|---------------------|  
|MessageMustHaveViaOrToSetForSendingOnServerSideCompositeDuplexChannels|Sunucu bileşik çift yönlü kanalları bir ileti göndermek için ileti 'Üzerinden' özelliği veya 'To' üstbilginin olması gerekir.|
