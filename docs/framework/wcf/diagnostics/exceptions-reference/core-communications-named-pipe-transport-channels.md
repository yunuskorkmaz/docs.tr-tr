...
|-------------------|---------------------|  
|PipeCantCloseWithPendingWrite|Bir yazma işlemi kanala beklemedeyken kanal kapatılamaz.|  
|PipeReadPending|Kanal için bir okuma işlemi sürüyor.|  
|PipeShutdownReadError|Kanal 'Kapatma' göstergesi okuma işlemi başarısız oldu.|  
|PipeShutdownWriteError|Kanal 'Kapatma' göstergesinin yazma işlemi başarısız oldu.|  
