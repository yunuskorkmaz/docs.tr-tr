...
ms.locfileid: "33478985"
---
# <a name="systemservicemodelchannelspnrpresolveexception"></a>System.ServiceModel.Channels.PnrpResolveException
Bir çözümleme gerçekleştirmek PnrpResolverService çalışır bir özel durumla karşılaşıldı.  
  
## <a name="description"></a>Açıklama  
 Bu izleme, PNRP çözümleyici tarafından çözmek işlemi sırasında oluşur.  
