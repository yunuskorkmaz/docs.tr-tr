...
ms.locfileid: "61937000"
---
# <a name="systemservicemodelchannelspnrpresolveexception"></a>System.ServiceModel.Channels.PnrpResolveException
PnrpResolverService bir Çözümle gerçekleştirmeye çalışır ancak bir özel durumla karşılaşıldı.  
  
## <a name="description"></a>Açıklama  
 Bu izleme, PNRP çözümleyici tarafından çözme işlemi sırasında oluşur.  
