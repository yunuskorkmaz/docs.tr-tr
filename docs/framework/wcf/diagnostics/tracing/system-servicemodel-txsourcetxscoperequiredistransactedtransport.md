...
Belirtilen MSMQ gibi işlem temelli bir taşıma işlemi için belirtilen işlem alındı.  
  
## <a name="description"></a>Açıklama  
 Kullanıcı kodu için kullanılabilir hale işlem aktarım tarafından oluşturulmuşsa, izlenen.  
