...
## <a name="description"></a>Açıklama  
 Bu izleme, bilgi düzeyinde bir kanal fabrikası oluştururken yayınlanır. Bu istemci Bahsediyor (örneğin, uzak adres, bağlama, anlaşma adı) uç noktasının bir açıklama sağlar.  
