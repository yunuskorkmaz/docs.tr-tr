...
manager: wpickett
ms.openlocfilehash: 02cd16ef72f3e5ee7560e28a89d5de2078e83ecb
...
## <a name="description"></a>Açıklama  
 Bu izleme bilgileri düzeyinde bir kanal fabrikası oluşturma sırasında yayınlanır. İstemci Konuşmayı (örneğin, uzak adresi, bağlama, sözleşme adı) uç noktası açıklamasını sağlar.  
