...
Bu bölüm, farklı senaryolar için izlemeyi kullanma açıklayan konulara içerir.  
  
 Etkinlik izleme/yanıt için aşağıdakileri kullanarak, tek yönlü ve çift yönlü senaryoları uygulanır.  
  
-   Zaman uyumlu veya zaman uyumsuz  
  
-   BasicHttpBinding netNamedPipeBinding, netTcpBinding, wsHttpBinding veya netMsmqBinding  
  
-   COM hizmet  
  
-   Kullanıcı Etkinlik Kimliği yayma  
