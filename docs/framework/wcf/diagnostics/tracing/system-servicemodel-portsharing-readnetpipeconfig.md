...
## <a name="description"></a>Açıklama  
 Yapılandırma verilerini NetPipeSection için belirtilen verilerle okuyun: belirtilen verilerle: maxConnectionsPendingDispatch, maxPendingAccepts ve receiveTimeout.  
