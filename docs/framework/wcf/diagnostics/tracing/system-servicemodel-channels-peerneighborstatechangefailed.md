...
Komşu'nin durumu bozulmuş.  
  
## <a name="description"></a>Açıklama  
 Bu izleme komşu'nin durumunu değiştirmek için başarısız bir denendiğinde oluşur. Bu, bir beklenmeyen bir iç hata veya bozuk bellek belirtir.  
