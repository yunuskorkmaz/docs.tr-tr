...
ms.locfileid: "33485101"
---
# <a name="systemservicemodeltxcompletionstatuscompletedfortacosc"></a>System.ServiceModel.TxCompletionStatusCompletedForTACOSC
Oturum kapatıldığında belirli işlem tamamlandı.  
  
## <a name="description"></a>Açıklama  
 Geçerli etkin oturum kapatıldığında izlenmesini ve `TransactionAutoCompleteOnSessionClose` ayarlanır `true`.  
