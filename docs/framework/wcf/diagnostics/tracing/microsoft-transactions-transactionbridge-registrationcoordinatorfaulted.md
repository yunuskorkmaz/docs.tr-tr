...
WS-AT protokolü hizmeti Koordinatörü kayıt iletisine yanıt olarak bir hata aldı.  
  
## <a name="description"></a>Açıklama  
 Yerel TransactionManager kendi üst TransactionManager döndürülen bir hata nedeniyle kaydı mümkün değilse, izlenen.  
