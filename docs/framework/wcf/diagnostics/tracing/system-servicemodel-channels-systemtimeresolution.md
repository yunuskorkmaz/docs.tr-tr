...
## <a name="description"></a>Açıklama  
 İşletim sistemi zamanlayıcı çözünürlüğü olarak algılandı *n* yaklaşık saat tıklaması, *m* milisaniye. Burada *n* ve *m* sayısal değerlerdir.  
