...
## <a name="description"></a>Açıklama  
 Bir Internet Information Service (IIS) veya Windows İşlem Etkinleştirme Hizmeti (WAS) barındırılan hizmet .svc dosyada yoksa bir satır içi koddan derlenmiş oluşur.  
