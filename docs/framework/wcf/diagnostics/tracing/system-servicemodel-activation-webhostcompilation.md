...
## <a name="description"></a>Açıklama  
 Bir Internet Information Service (IIS) veya Windows İşlem Etkinleştirme Hizmeti (WAS) barındırılan hizmet .svc dosyasında satır içi kod derlenir gerçekleşir.  
