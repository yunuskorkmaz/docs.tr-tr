...
Bir ileti PeerNode tarafından alınan ancak Komşuları için yayılan değil.  
  
## <a name="description"></a>Açıklama  
 Bu izleme, bir gelen sel ileti işleme sırasında oluşur.  
  
## <a name="troubleshooting"></a>Sorun giderme  
 İleti yayma filtresi olup olmadığını kontrol edin.  
