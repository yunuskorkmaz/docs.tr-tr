...
Katılımcı listesi işlem yöneticisi günlüğünden kurtarıldı.  
  
## <a name="description"></a>Açıklama  
 Yerel işlem yöneticisi başarıyla kurtarma için belirli alt Katılımcı listesi gerçekleştirdiğinde izlenen.  
