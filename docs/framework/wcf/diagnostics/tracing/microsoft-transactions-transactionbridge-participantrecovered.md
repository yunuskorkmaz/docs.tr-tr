...
Katılımcı bir liste işlem yöneticisi günlüğünden kurtarıldı.  
  
## <a name="description"></a>Açıklama  
 Yerel hareket yöneticisi belirli bir alt Katılımcı listesi için kurtarma başarıyla gerçekleştirdi, izlenen.  
