...
## <a name="description"></a>Açıklama  
 Bir ileti bir kanal üzerinden gönderilir.  
  
 Bu izleme, bir WCF ileti gönderildiğinde yayılan `System.ServiceModel` izleme kaynağını bilgi veya ayrıntılı düzeyinde etkinleştirilir. Bu izleme iletisi bağıntı oku etkinliği Grafik görünümünde görmek gereklidir.  
