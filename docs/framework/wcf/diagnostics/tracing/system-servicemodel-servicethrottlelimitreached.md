...
## <a name="description"></a>Açıklama  
 Örnekleri/MaxConcurrentCalls/oturumları kısıtlama birini ulaşıldı ve ileti kuyruğa alındı.  
  
 Bu izleme, beklenen ve gerçek üretim yüküne göre kısıtlama değerlerini ayarlamak için kullanabilirsiniz.  
