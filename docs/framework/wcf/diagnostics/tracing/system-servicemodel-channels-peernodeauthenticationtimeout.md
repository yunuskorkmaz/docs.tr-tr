...
Güvenlik el sıkışması belirtilen süre sınırı içinde başarılı olmadı.  
  
## <a name="description"></a>Açıklama  
 Bu izleme, bir güvenli komşu bağlantısı kurmaya çalışırken oluşur.  
  
## <a name="troubleshooting"></a>Sorun giderme  
 Tüm Komşuları uygun güvenlik kimlik bilgilerine sahip olması ve 1 dakikadan az tüm iletileri yanıtlayın emin olun.  
