...
## <a name="description"></a>Açıklama  
 Yapılandırma verilerini NetTcpSection için belirtilen verilerle okuyun: listenBacklog, maxConnectionsPendingDispatch, maxPendingAccepts, receiveTimeout ve teredoEnabled.  
