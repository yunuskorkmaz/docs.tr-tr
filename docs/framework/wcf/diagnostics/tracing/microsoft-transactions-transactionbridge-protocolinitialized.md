...
WS Atomik Işlem protokolü hizmeti başlatıldı.  
  
## <a name="description"></a>Açıklama  
 Hangi protokolün başarıyla başlatıldığını göstermek için Işlem yöneticisi başlatması sırasında izleniyor.  
