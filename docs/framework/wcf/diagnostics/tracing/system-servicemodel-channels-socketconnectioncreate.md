...
## <a name="description"></a>Açıklama  
 Bu izleme, istemci tarafından gerçekleştirilen ilk işlem eylem etkinliğindeki ve hizmette bayt alma etkinliğinde yayınlanır. Bu, yerel ve uzak IP adreslerini sağlar. Bilgi düzeyinde yayılır.  
