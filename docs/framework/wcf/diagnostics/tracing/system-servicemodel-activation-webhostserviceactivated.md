...
## <a name="description"></a>Açıklama  
 Internet Information Services (IIS) veya Windows İşlem Etkinleştirme Hizmeti (WAS) barındırılan bir hizmet tam olarak etkinleştirilir ve iletiler için dinleme başlar gerçekleşir.  
