...
## <a name="description"></a>Açıklama  
 Internet Information Services (IIS) veya Windows İşlem Etkinleştirme Hizmeti (WAS) üzerinde barındırılan bir hizmet tam olarak etkinleştirilir ve iletiler için dinleme başlar oluşur.  
