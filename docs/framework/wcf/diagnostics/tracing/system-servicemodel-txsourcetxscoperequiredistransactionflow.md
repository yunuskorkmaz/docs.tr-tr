...
Belirtilen işlem için belirtilen işlem eylemine aktarıldı.  
  
## <a name="description"></a>Açıklama  
 Kullanıcı kodu tarafından sunulan işlem olarak bir dış kaynaktan akışı yapılan işlemler, izlenen.  
