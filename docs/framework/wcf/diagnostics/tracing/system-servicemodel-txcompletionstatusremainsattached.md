...
Belirtilen işlem için belirtilen işlem için InstanceContext eklenen kalır.  
  
## <a name="description"></a>Açıklama  
 İzlenen bir ServiceOperation tamamlanır ancak işlemi tamamlamak için ayarlı değil.  
