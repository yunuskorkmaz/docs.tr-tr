...
ms.locfileid: "33481662"
---
# <a name="systemservicemodeldroppedamessage"></a>System.ServiceModel.DroppedAMessage
System.ServiceModel.DroppedAMessage  
  
## <a name="description"></a>Açıklama  
 Bir yanıt iletisi alındı, ancak bu ileti için bekleyen bekleyen istek yok. Windows Communication Foundation (WCF) çalışma zamanı tarafından ileti bırakılıyor.  
  
 Bu izleme, kayıp iletilerle hata ayıklama için kullanılabilir.  
