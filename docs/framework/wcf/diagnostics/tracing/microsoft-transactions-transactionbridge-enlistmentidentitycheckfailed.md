...
Gelen iletiyi gönderenin kimliğini liste 's uç nokta başvurudan türetilmiş kimlik eşleşmedi.  
  
## <a name="description"></a>Açıklama  
 İleti güvenlik doğrulaması başarısız olursa izlenen.  
  
## <a name="troubleshooting"></a>Sorun giderme  
 İşlem güvenliği işlem sırasında katılan tüm makineler için doğru şekilde yapılandırıldığından emin olun.  
