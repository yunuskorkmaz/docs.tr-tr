...
Gelen iletiyi gönderenin kimliğini kaydı 's bitiş noktası başvurusundan elde kimlik eşleşmedi.  
  
## <a name="description"></a>Açıklama  
 İleti güvenlik doğrulama başarısız olursa izlenen.  
  
## <a name="troubleshooting"></a>Sorun giderme  
 İşlem güvenliği işlemde katılan tüm makineler için doğru şekilde yapılandırıldığından emin olun.  
