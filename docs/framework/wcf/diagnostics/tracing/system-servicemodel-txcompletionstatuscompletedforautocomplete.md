...
Belirtilen işlem için belirtilen işlem şu nedenle tamamlandı `OperationBehaviorAttribute.TransactionAutoComplete` ayarlamak üye `true`.  
  
## <a name="description"></a>Açıklama  
 Altyapı otomatik olarak kullanıcı adına işlem tamamlandığında izlenen.  
