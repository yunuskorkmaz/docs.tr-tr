...
## <a name="description"></a>Açıklama  
 Null bir ileti (kanal sinyal sonu) datagram kanalından alındı, ancak kanal hala açık durumda. Bu veri birimi kanal bir hata olduğunu gösterir ve devre dışı bırakma multiplexer alma döngü beklenenden önce sonlandırıldı.  
