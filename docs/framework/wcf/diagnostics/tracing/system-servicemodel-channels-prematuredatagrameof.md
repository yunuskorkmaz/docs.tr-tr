...
## <a name="description"></a>Açıklama  
 Bir veri birimi kanaldan (kanal sinyal sonu) null bir ileti alındı, ancak yine de Opened durumunda kanalıdır. Bu veri birimi kanal bir hata olduğunu gösterir ve devre dışı bırakma multiplexer alma döngü beklenenden önce sonlandırıldı.  
