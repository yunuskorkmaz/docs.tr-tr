...
Belirtilen işlem için belirtilen işlem bir InstanceContext işleminden alındı.  
  
## <a name="description"></a>Açıklama  
 Kullanıcı kodu için kullanılabilir hale işlem tarafından bir otomatik tamamlama geride, izlenen = false yöntemi bu çağrıyı önce çağrılır.  
