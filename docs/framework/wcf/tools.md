...
|Aracı|Açıklama|  
|----------|-----------------|  
|[ServiceModel Meta Veri Yardımcı Programı Aracı (Svcutil.exe)](../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md)|Meta veri belgelerini ve meta veri belgelerini hizmet modeli kodundan hizmet modeli kod oluşturur.|  
|[Find Private Key Aracı (FindPrivateKey.exe)](../../../docs/framework/wcf/find-private-key-tool-findprivatekey-exe.md)|Özel anahtarı belirtilen deposundan alır.|  
...
|[Hizmet İzleme Görüntüleyicisi Aracı (SvcTraceViewer.exe)](../../../docs/framework/wcf/service-trace-viewer-tool-svctraceviewer-exe.md)|Görünüm, Grup ve iletileri tanılamak böylece onarın ve WCF hizmetleri ile ilgili sorunları doğrulayın filtre izleme yardımcı olur.|  
