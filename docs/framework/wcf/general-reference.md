...
Bölümü, [\<system.serviceModel>](../configure-apps/file-schema/wcf/system-servicemodel.md) Windows Communication Foundation (WCF) istemcileri ve hizmetlerini yapılandırmak için kullanılan öğeleri açıklar.
