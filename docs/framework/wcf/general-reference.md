...
Bölüm [ \<system.serviceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) Windows Communication Foundation (WCF) istemcileri ve hizmetleri yapılandırmak için kullanılan öğeleri açıklar.
