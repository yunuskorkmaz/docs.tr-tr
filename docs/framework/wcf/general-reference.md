...
Bölüm [ \<system.serviceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) yapılandırmak için kullanılan öğeleri açıklar [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] istemciler ve hizmetler.
