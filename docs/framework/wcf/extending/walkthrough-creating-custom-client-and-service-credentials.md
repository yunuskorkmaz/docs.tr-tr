...
-   İçin bir üreteci olarak gerçekleştirmek <xref:System.IdentityModel.Selectors.SecurityTokenManager> uygulamaları.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]kimlik bilgileri sınıfları ve nasıl bunların içine sığması [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] güvenlik mimarisi bkz [güvenlik mimarisi](http://msdn.microsoft.com/en-us/16593476-d36a-408d-808c-ae6fd483e28f).  
