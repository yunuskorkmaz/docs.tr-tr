...
Bu bölüm, Windows Workflow Foundation (WF) özel etkinlikler oluşturmak nasıl gösteren örnekleri içerir.  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Tasarım zamanı etkinlik doğrulamayı gösterme örnekleri içerir.
