...
## <a name="in-this-section"></a>Bu Bölümde  
 [Yer işaretleri](../../../../docs/framework/windows-workflow-foundation/samples/bookmarks.md)  
 Bu örnek, bir dış giriş almak için bir yer işareti oluşturur özel bir etkinlik yazma gösterilmiştir.  
  
 [Özel bileşik yerel etkinliğini kullanma](../../../../docs/framework/windows-workflow-foundation/samples/custom-composite-using-native-activity.md)  
 ...
 [Hello World özel etkinlik](../../../../docs/framework/windows-workflow-foundation/samples/hello-world-custom-activity.md)  
 ...
 [Dinamik değişkenleri](../../../../docs/framework/windows-workflow-foundation/samples/dynamic-arguments.md)  
