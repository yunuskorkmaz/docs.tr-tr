...
## <a name="ruleset-tool"></a>Kural kümesi araç  
 ...
 ![Dış kural kümesi Toolket örnek çıktı](../../../../docs/framework/windows-workflow-foundation/samples/media/rulesetbrowser.gif "RuleSetBrowser")  
