...
## <a name="in-this-section"></a>Bu bölümde  
 ...
 Basic gösteren örnekler sağlar [!INCLUDE[wf](../../../../includes/wf-md.md)] işlevselliği.  
  
 [Senaryo](../../../../docs/framework/windows-workflow-foundation/samples/scenario.md)  
 Örnekler sağlar [!INCLUDE[wf](../../../../includes/wf-md.md)] senaryoları.  
