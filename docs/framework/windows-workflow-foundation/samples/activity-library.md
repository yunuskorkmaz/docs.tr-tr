...
## <a name="in-this-section"></a>Bu Bölümde
 ...
 Bir iş akışı uygulamasında kullanmak üzere SMTP kullanarak e-posta göndermek için <xref:System.Activities.AsyncCodeActivity> türetilen özel bir etkinliğin nasıl oluşturulacağını gösterir.  
 ...
 <xref:System.Activities.Statements.ForEach%601> etkinliğinin genel olmayan bir sürümünün nasıl oluşturulacağını gösterir.  
  
 [Genel Olmayan ParallelForEach](non-generic-parallelforeach.md)  
 <xref:System.Activities.Statements.ParallelForEach%601> etkinliğinin genel olmayan bir sürümünün nasıl oluşturulacağını gösterir.  
  
 [WorkflowInstanceId Alma](get-workflowinstanceid.md)  
 `GetWorkflowInstanceId`, özel etkinliğin, iş akışı örneği KIMLIĞINI döndürmek için nasıl kullanılacağını gösterir.
