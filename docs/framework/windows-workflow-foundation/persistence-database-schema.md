...
|ServiceNamespace|Nvarchar (max)|İş akışı hizmetinin ad alanını temsil eder. (ör. **şirketim**).|  
 ...
 Servicedağıtımlar görünümü bir silme tetikleyicisi de içerir. Uygun izinlere sahip kullanıcılar, Service Deployment girişlerini veritabanından kaldırmak için bu görünüme karşı delete deyimlerini yürütebilir. Şunlara dikkat edin:  
...
> [!NOTE]
> Dizinli bir görünüm daha fazla depolama alanı gerektirir ve ek işleme yükü ekler. Daha fazla bilgi için lütfen [SQL Server 2008 dizinli görünümlerle performansı artırma](/previous-versions/sql/sql-server-2008/dd171921(v=sql.100)) bölümüne bakın.
