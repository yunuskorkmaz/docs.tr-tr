...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Kümesi önerilen konuları okumak için benzerlik (iyi erkenden tanışmanız için yeni başlayan) ve gereksinimlerine bağlı olarak.  
  
 [Windows Workflow Foundation’daki Yenilikler](../../../docs/framework/windows-workflow-foundation/whats-new.md)  
 Önceki sürümlerden birkaç geliştirme örneklerinde değişiklikleri açıklar.  
  
 [.NET 4.5 içinde Windows Workflow Foundation’daki Yenilikler](../../../docs/framework/windows-workflow-foundation/whats-new-in-wf-in-dotnet.md)  
 ...
 [Windows Workflow Örnekleri](../../../docs/framework/windows-workflow-foundation/samples/index.md)  
 WF özelliklerini ve senaryolarını gösteren örnek uygulamaları içerir.
