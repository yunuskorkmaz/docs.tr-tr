...
---
# <a name="what39s-new-in-windows-workflow-foundation-in-net-45"></a>Hangi&#39;s .NET 4.5 içinde Windows Workflow Foundation'daki yenilikler
...
-   Dinamik güncelleştirme bir kalıcı iş akışı örneğinin tanımını güncelleştirmeye yönelik bir mekanizma sağlayan kullanıma sunulmuştur. Daha fazla bilgi için [dinamik güncelleştirme](../../../docs/framework/windows-workflow-foundation/dynamic-update.md) ve [nasıl yapılır: çalışan iş akışı örneğinin tanımını güncelleştirme](../../../docs/framework/windows-workflow-foundation/how-to-update-the-definition-of-a-running-workflow-instance.md).  
