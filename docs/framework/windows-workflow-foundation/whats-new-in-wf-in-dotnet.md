...
###  <a name="BKMK_DesignerSearch"></a>Tasarımcı arama  
 Daha büyük iş akışları daha kolay yönetilebilir hale getirmek için iş akışları şimdi anahtar sözcüğüyle aranabilir. Bu özellik yalnızca kullanılabilir [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)]; bu özellik rehosted Tasarımcısı'nda kullanılamıyor. Aramaları iki tür vardır:  
