...
###  <a name="WFDesigner"></a><span data-ttu-id="569de-115">İş Akışı Tasarımcısı'nda C# ifadeler kullanma</span><span class="sxs-lookup"><span data-stu-id="569de-115">Using C# expressions in the Workflow Designer</span></span>  
...
####  <a name="BackwardCompat"></a><span data-ttu-id="569de-124">Geriye dönük uyumluluk</span><span class="sxs-lookup"><span data-stu-id="569de-124">Backwards compatibility</span></span>  
...
###  <a name="CodeWorkflows"></a><span data-ttu-id="569de-130">Kod iş akışlarında C# ifadeler kullanma</span><span class="sxs-lookup"><span data-stu-id="569de-130">Using C# expressions in code workflows</span></span>  
...
###  <a name="XamlWorkflows"></a><span data-ttu-id="569de-147">XAML iş akışlarında C# ifadeler kullanma</span><span class="sxs-lookup"><span data-stu-id="569de-147">Using C# expressions in XAML workflows</span></span>  
...
####  <a name="CompiledXaml"></a><span data-ttu-id="569de-152">Derlenmiş Xaml</span><span class="sxs-lookup"><span data-stu-id="569de-152">Compiled Xaml</span></span>  
...
####  <a name="LooseXaml"></a><span data-ttu-id="569de-155">Gevşek Xaml</span><span class="sxs-lookup"><span data-stu-id="569de-155">Loose Xaml</span></span>  
...
###  <a name="WFServices"></a><span data-ttu-id="569de-162">C# ifadeler XAMLX iş akışı hizmetleri kullanma</span><span class="sxs-lookup"><span data-stu-id="569de-162">Using C# expressions in XAMLX workflow services</span></span>  
