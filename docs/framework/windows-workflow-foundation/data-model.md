...
## <a name="in-this-section"></a>Bu Bölümde  
 [Değişkenleri ve bağımsız değişkenler](../../../docs/framework/windows-workflow-foundation/variables-and-arguments.md).  
 Değişkenleri ve bağımsız değişkenleri ve bunların nasıl kullanıldığı kavramlarını açıklar.  
