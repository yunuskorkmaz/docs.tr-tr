...
-   Türetilen özel bir aktivite <xref:System.Activities.CodeActivity> soyut sınıf. <xref:System.Activities.CodeActivity> (Örneğin, izleme ve özellikleri) çalışma zamanı özelliklere erişebilir kullanarak <xref:System.Activities.CodeActivityContext> bir parametresi olarak kullanılabilir <xref:System.Activities.CodeActivity.Execute%2A> yöntemi. [!INCLUDE[crabout](../../../includes/crabout-md.md)]Bu çalışma zamanı özellikleri bkz [izleme ve izleme iş akışı](../../../docs/framework/windows-workflow-foundation/workflow-tracking-and-tracing.md) ve [iş akışı yürütme özellikleri](../../../docs/framework/windows-workflow-foundation/workflow-execution-properties.md).  
