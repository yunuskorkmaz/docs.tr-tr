...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Bağlam düzenleme ModelItem kullanma](../../../docs/framework/windows-workflow-foundation/using-the-modelitem-editing-context.md)  
 Konak ile etkileşim kurmak Tasarımcı izin vermek için ModelItem düzenleme bağlam özelliklerini kullanmayı açıklar.  
  
 [Özel Etkinlik özelliğinin bir tasarımcı denetimine bağlama](../../../docs/framework/windows-workflow-foundation/binding-a-custom-activity-property-to-a-designer-control.md)  
