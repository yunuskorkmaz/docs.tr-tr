...
## <a name="net-framework-security"></a>.NET Framework Güvenliği  
 Bilgisayardaki hizmetlerin denetimi, içindeki izinleri ayarlamak <xref:System.ServiceProcess.ServiceControllerPermissionAccess> için kullanılarak kısıtlanabilir. <xref:System.ServiceProcess.ServiceControllerPermission>  
  
 Hizmet bilgilerine erişim, içindeki izinleri ayarlamak <xref:System.Security.Permissions.PermissionState> için kullanılarak kısıtlanabilir. <xref:System.Security.Permissions.SecurityPermission>  
