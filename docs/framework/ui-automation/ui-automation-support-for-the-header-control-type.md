...
|Üstbilgi<br /><br /> -Headerıtem (1 veya daha fazla)|Yok.|  
 ...
 Üstbilgi denetimleri her zaman 1 veya daha fazla alt denetim görünümünde sahip [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] ağacı.  
  
 Üstbilgi denetimleri sahip sıfır alt içerik görünümünde [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] ağacı.  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.NameProperty>|Notlarına bakın.|Üstbilgi denetimi birden fazla satır başlığını veya birden fazla sütun başlığı ise bir adı olmalıdır. Bu bilgilerin üstbilgisi içinde tanımlar.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LabeledByProperty>|`Null`.|Üstbilgi denetimleri statik etiketi yok.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Üstbilgi|Bu değer tüm aynıdır [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] çerçeveleri.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LocalizedControlTypeProperty>|"üstbilgisi"|Bu değer tüm aynıdır [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] çerçeveleri.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.OrientationProperty>|Yatay|Bu özelliğin değeri bir satır veya sütun başlığındaki olup - üstbilgi denetimi konumunu gösterir.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|False|Üstbilgi denetimi içerik görünümünde dahil edilmeyen [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] ağacı.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|Doğru|Üstbilgi denetimi her zaman denetim görünümünde dahil [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] ağacı.|  
...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.ITransformProvider>|Bağlıdır|Üstbilgi denetimi yeniden boyutlandırılabilir varsa bu denetim deseni uygular.|  
