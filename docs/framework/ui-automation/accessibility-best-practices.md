...
### <a name="respect-all-system-wide-settings-and-do-not-interfere-with-accessibility-functions"></a>Tüm System-Wide ayarlarına saygı ve erişilebilirlik Işlevlerini engellemez  
...
### <a name="provide-user-selectable-equivalents-for-non-text-elements"></a>Metin olmayan öğeler için User-Selectable eşdeğerleri sağlayın  
...
### <a name="use-standard-input-apis-with-device-independent-calls"></a>Device-Independent çağrılarıyla standart giriş API 'Lerini kullanma  
