...
## <a name="distributing-client-side-providers"></a>Client-Side sağlayıcılarını dağıtma  
...
## <a name="registering-and-configuring-client-side-providers"></a>Client-Side sağlayıcılarını kaydetme ve yapılandırma  
