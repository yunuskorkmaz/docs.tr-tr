...
## <a name="example"></a>Örnek  
 ...
 İlk teknik için daha hızlı olma eğilimindedir [!INCLUDE[TLA2#tla_win32](../../../includes/tla2sharptla-win32-md.md)] denetimleri, ancak ikinci Windows Presentation Foundation (WPF) denetimleri için daha hızlı.  
