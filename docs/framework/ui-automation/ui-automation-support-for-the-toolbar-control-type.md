...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.NameProperty>|-sına bağ -lıdır|Bir uygulama içinde birden fazla kullanılmadığı sürece araç çubuğu denetiminin bir ad gerektirmemesi gerekir. Birden fazla kişi varsa, her birinin ayırt edici bir adı olmalıdır (örneğin, Biçimlendirme veya Anahat Oluşturma).|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LabeledByProperty>|`Null`|Araç çubuğu denetimleri hiçbir zaman bir etikete sahip olmaz.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|ToolBar|Bu değer tüm Ara bilgi arabirimi çerçeveleri için aynıdır.|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|True|Araç çubuğu denetimi her zaman içeriktir.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|True|Araç çubuğu denetimi her zaman bir kontrol olmalıdır.|  
...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.ExpandCollapsePattern>|-sına bağ -lıdır|Araç çubuğu daha fazla öğe göstermek için genişletilebilir ve daraltılabilirse, bu deseni desteklemesi gerekir.|  
|<xref:System.Windows.Automation.DockPattern>|-sına bağ -lıdır|Araç çubuğu ekranın farklı bölümlerine sabitlenebilirse, bu deseni desteklemesi gerekir.|  
|<xref:System.Windows.Automation.TransformPattern>|-sına bağ -lıdır|Araç çubuğu yeniden boyutlandırılabilir, döndürülebilir veya taşınabiliyorsa, bu deseni desteklemesi gerekir.|  
  
<a name="Required_UI_Automation_Events"></a>
## <a name="required-ui-automation-events"></a>Gerekli UI Otomasyon Etkinlikleri  
 Aşağıdaki tabloda, [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] tüm araç çubuğu denetimleri tarafından desteklenmesi gereken olaylar listelenmektedir. Etkinlikler hakkında daha fazla bilgi için [UI Otomasyon Etkinliklerine Genel Bakış'a](ui-automation-events-overview.md)bakın.  
