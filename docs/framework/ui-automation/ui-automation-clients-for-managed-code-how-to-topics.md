...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Bir liste öğesi için UI Otomasyon öğesi bulma](../../../docs/framework/ui-automation/find-a-ui-automation-element-for-a-list-item.md)  
 [UI Otomasyon öğesi özelliklerini alma](../../../docs/framework/ui-automation/get-ui-automation-element-properties.md)  
