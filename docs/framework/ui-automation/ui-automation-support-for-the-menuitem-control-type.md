...
|MenuItem "Help"<br /><br /> <ul><li>Menü (Yardım menü öğesinin alt menüsü)<br /><br /> <ul><li>MenuItem "Yardım konuları"</li><li>MenuItem "Not hakkında"</li></ul></li></ul>|MenuItem "Help"<br /><br /> -MenuItem "Yardım konuları"<br />-MenuItem "Not hakkında"|  
 ...
 Menü öğesi denetimi denetiminin görünümünü sahip [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] ağaç yapısı yukarıda gösterilen. Unutmayın **yardımcı** menü öğesi, yapı tipik bir menüye alt hiyerarşi içinde daha iyi anlamak için inlcluded olduğu.  
...
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementAddedToSelectionEvent>|Bağlıdır|Hiçbiri|  
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementRemovedFromSelectionEvent>|Bağlıdır|Hiçbiri|  
|<xref:System.Windows.Automation.SelectionItemPatternIdentifiers.ElementSelectedEvent>|Bağlıdır|Hiçbiri|  
