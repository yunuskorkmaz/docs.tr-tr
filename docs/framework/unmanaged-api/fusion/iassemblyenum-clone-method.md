...
ms.locfileid: "59144473"
---
# <a name="iassemblyenumclone-method"></a>IAssemblyEnum::Clone Yöntemi
Bu basit bir kopyasını oluşturur [Iassemblyenum](../../../../docs/framework/unmanaged-api/fusion/iassemblyenum-interface.md) nesne.  
