...
#### <a name="parameters"></a>Parametreler  
 `bstrSimpleName`  
 [in] A [BSTR](http://msdn.microsoft.com/en-us/1b2d7d2c-47af-4389-a6b6-b01b7e915228) basit tür kitaplığı adını içerir.  
 ...
 `syskind`  
 [in] A [SYSKIND](http://msdn.microsoft.com/en-us/662048b2-59a8-48ca-9e4f-2f9a5306faa1) işletim sistemi ortamında belirleyen bayrak. SYS_WIN32 ve SYS_WIN64 bunun ortak değerlerdir.  
  
 `pbstrResolvedTlbName`  
 [out] Bir işaretçi bir [BSTR](http://msdn.microsoft.com/en-us/1b2d7d2c-47af-4389-a6b6-b01b7e915228) adlı tür kitaplığı tam yolunu içeren `bstrSimpleName` parametresi.  
...
## <a name="remarks"></a>Açıklamalar  
 ...
 Bu arabirim özel uygulamaları döndürmelidir bir [BSTR](http://msdn.microsoft.com/en-us/1b2d7d2c-47af-4389-a6b6-b01b7e915228) adlı tür kitaplığı tam yolunu içeren `bstrSimpleName` parametresi.  
