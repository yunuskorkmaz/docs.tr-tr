...
## <a name="remarks"></a>Açıklamalar  
 [ICorProfilerInfo:: BeginInprocDebugging](icorprofilerinfo-begininprocdebugging-method.md) ve `EndInprocDebugging` aynı geri çağırma yöntemi içinde çağırmanız gerekir.  
