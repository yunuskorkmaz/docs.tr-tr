...
## <a name="net-framework-version-4-profiling-functions"></a>.NET Framework sürüm 4 profil oluşturma Işlevleri  
 ...
 `FunctionIDMapper2`[FunctionIDMapper](functionidmapper-function.md) işlevini, çalışma `clientData` zamanları arasında belirsizliği ortadan kaldırmak için profil oluşturucular kullanılabilecek bir parametresiyle genişletir.  
