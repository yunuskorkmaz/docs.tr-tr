...
`COR_PRF_HIGH_MONITOR` bayrakları, [ICorProfilerInfo5:: GetEventMask2](icorprofilerinfo5-geteventmask2-method.md) ve [ICorProfilerInfo5:: SetEventMask2](icorprofilerinfo5-seteventmask2-method.md) yöntemlerinin `pdwEventsHigh` parametresiyle kullanılır.  
