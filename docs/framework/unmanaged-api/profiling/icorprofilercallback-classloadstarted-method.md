...
## <a name="parameters"></a>Parametreler  
 `classId`  
 'ndaki Yüklenmekte olan sınıfı tanımlar.  
  
## <a name="remarks"></a>Açıklamalar  
 `classId` değeri, [ICorProfilerCallback:: ClassLoadFinished](../../../../docs/framework/unmanaged-api/profiling/icorprofilercallback-classloadfinished-method.md) yöntemi çağrılana kadar bir bilgi isteği için geçerli değildir.  
