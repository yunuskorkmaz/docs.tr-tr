...
## <a name="parameters"></a>Parametreler  
 `pbAttached`  
 [out] `true` bir hata ayıklayıcısı işleme eklenmişse; Aksi takdirde, `false` .  
...
## <a name="remarks"></a>Açıklamalar  
 `IsDebuggerAttached`bir hata ayıklayıcının işleme eklenip eklenmeyeceğini anlamak için konağın CLR 'yi sorgulamasını sağlar.  
