...
## <a name="parameters"></a>Parametreler  
 `pbAttached`  
 [out] işleme bir hata ayıklayıcı ekli ise `true`; Aksi takdirde, `false`.  
...
## <a name="remarks"></a>Açıklamalar  
 `IsDebuggerAttached`, ana bilgisayarın bir hata ayıklayıcının işleme eklenip eklenmeyeceğini belirlemede CLR 'yi sorgulamasını sağlar.  
