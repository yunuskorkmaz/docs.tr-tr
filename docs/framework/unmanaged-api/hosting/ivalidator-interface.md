...
|Yöntem|Açıklama|  
|------------|-----------------|  
|Doğrula|Belirtilen PE veya Microsoft Ara dili (MSIL) dosya doğrular.|  
|Formateventınfo|Belirtilen doğrulama hatası karşılık gelen hata iletisi alır.|  
