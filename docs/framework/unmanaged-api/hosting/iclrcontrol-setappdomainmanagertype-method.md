...
Uygulama etki alanı yöneticileri için tür olarak <xref:System.AppDomainManager> türetilmiş bir tür belirler.  
...
## <a name="parameters"></a>Parametreler  
 ...
 'ndaki <xref:System.AppDomainManager> türetilen istenen türün uygulandığı derlemenin adı.  
  
 `pwzAppDomainManagerType`  
 'ndaki <xref:System.AppDomainManager>yeteneklerini uygulayan `pwzAppDomainManagerAssembly` parametresinde uygulanan türün adı.  
