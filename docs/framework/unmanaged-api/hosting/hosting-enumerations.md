...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [CLSID_RESOLUTION_FLAGS Numaralandırması](clsid-resolution-flags-enumeration.md)  
 ...
 [COR_GC_THREAD_STATS_TYPES Numaralandırması](cor-gc-thread-stats-types-enumeration.md)  
 ...
 [ECLRAssemblyIdentityFlags Numaralandırması](eclrassemblyidentityflags-enumeration.md)  
 ...
 [EHostApplicationPolicy Numaralandırması](ehostapplicationpolicy-enumeration.md)  
 ...
 [EHostBindingPolicyModifyFlags Numaralandırması](ehostbindingpolicymodifyflags-enumeration.md)  
 ...
 [EMemoryAvailable Numaralandırması](ememoryavailable-enumeration.md)  
 Bilgisayardaki boş fiziksel bellek miktarını belirten değerleri içerir.  
  
 [EMemoryCriticalLevel Numaralandırması](ememorycriticallevel-enumeration.md)  
 ...
 [MALLOC_TYPE Numaralandırması](malloc-type-enumeration.md)  
 ...
 [METAHOST_POLICY_FLAGS Numaralandırması](metahost-policy-flags-enumeration.md)  
 Çoğu çalışma zamanı ana bilgisayarı için ortak olan bağlama ilkeleri sağlar.  
  
 [RUNTIME_INFO_FLAGS Numaralandırması](runtime-info-flags-enumeration.md)  
 CLR ile ilgili hangi bilgilerin döndürüleceğini belirten değerleri içerir.  
  
 [StackOverflowType Numaralandırması](stackoverflowtype-enumeration.md)  
 Yığın taşması olayının temel nedenini gösteren değerleri içerir.  
  
 [STARTUP_FLAGS Numaralandırması](startup-flags-enumeration.md)  
