...
---
# <a name="iclrhostprotectionmanagerseteagerserializegrantsets-method"></a>ICLRHostProtectionManager::SetEagerSerializeGrantSets Yöntemi
...
|HRESULT|Açıklama|  
|-------------|-----------------|  
|S_OK|`SetEagerSerializeGrantSets` başarıyla döndürüldü.|  
