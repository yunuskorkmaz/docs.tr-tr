...
---
# <a name="iceefilegen-class"></a><span data-ttu-id="b7833-102">ICeeFileGen Sınıfı</span><span class="sxs-lookup"><span data-stu-id="b7833-102">ICeeFileGen Class</span></span>
<span data-ttu-id="b7833-103">Bir yerel taşınabilir yürütülebilir (PE) dosyasını oluşturmak için işlevsellik sağlar.</span><span class="sxs-lookup"><span data-stu-id="b7833-103">Provides functionality for creating a native portable executable (PE) file.</span></span> <span data-ttu-id="b7833-104">Arabirim genellikle derleyicileri tarafından yürütülebilir derlenmiş çıktılarını oluşturmak için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="b7833-104">The interface will typically be used by compilers to generate their compiled output executable.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="b7833-105">`ICeeFileGen`.NET Framework altyapısını destekler ve doğrudan kodunuzdan kullanılmaya yönelik değildir.</span><span class="sxs-lookup"><span data-stu-id="b7833-105">`ICeeFileGen` supports the .NET Framework infrastructure and is not intended to be used directly from your code.</span></span>  
  
 <span data-ttu-id="b7833-106">Bu arabirim kullanım dışı bırakıldı ve bir sonraki sürümde kaldırılacak.</span><span class="sxs-lookup"><span data-stu-id="b7833-106">This interface has been deprecated and will be removed in a future release.</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="b7833-107">Sözdizimi</span><span class="sxs-lookup"><span data-stu-id="b7833-107">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="b7833-108">Gereksinimler</span><span class="sxs-lookup"><span data-stu-id="b7833-108">Requirements</span></span>  
 <span data-ttu-id="b7833-109">**Platformlar:** bkz [sistem gereksinimleri](../../../../docs/framework/get-started/system-requirements.md).</span><span class="sxs-lookup"><span data-stu-id="b7833-109">**Platforms:** See [System Requirements](../../../../docs/framework/get-started/system-requirements.md).</span></span>  
  
 <span data-ttu-id="b7833-110">**Başlık:** ICeeFileGen.h</span><span class="sxs-lookup"><span data-stu-id="b7833-110">**Header:** ICeeFileGen.h</span></span>  
  
 <span data-ttu-id="b7833-111">**.NET framework sürümü:** 1.0</span><span class="sxs-lookup"><span data-stu-id="b7833-111">**.NET Framework Version:** 1.0</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="b7833-112">Ayrıca Bkz.</span><span class="sxs-lookup"><span data-stu-id="b7833-112">See Also</span></span>  
 [<span data-ttu-id="b7833-113">Barındırma arabirimleri</span><span class="sxs-lookup"><span data-stu-id="b7833-113">Hosting Interfaces</span></span>](../../../../docs/framework/unmanaged-api/hosting/hosting-interfaces.md)
