...
## <a name="remarks"></a>Açıklamalar  
 Konak, istenen veya gerekli olarak başka bir görev içinde geçiş yapabilirsiniz.  
  
> [!NOTE]
>  `SwitchToTask` ana bilgisayar geçiş yapmamalıdır hangi görev belirtmez; Bu, yalnızca, geçiş görev belirtir.  
