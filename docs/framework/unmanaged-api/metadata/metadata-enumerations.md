...
## <a name="in-this-section"></a>Bu Bölümde  
 [AssemblyFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/assemblyflags-enumeration.md)  
 Bir derlemeyi çalışma zamanı özelliklerini açıklayan değerlerini içerir.  
  
 [AssemblyRefFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/assemblyrefflags-enumeration.md)  
 Bir derleme başvurusu özelliklerini açıklayan değerlerini içerir.  
  
 [CeeSectionAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/ceesectionattr-enumeration.md)  
 ...
 [CeeSectionRelocType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/ceesectionreloctype-enumeration.md)  
 ...
 [COINITICOR numaralandırması](../../../../docs/framework/unmanaged-api/metadata/coiniticor-enumeration.md)  
 ...
 [COINITIEE numaralandırması](../../../../docs/framework/unmanaged-api/metadata/coinitiee-enumeration.md)  
 ...
 [CorArgType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corargtype-enumeration.md)  
 Bir çalışma zamanı tanıtıcı yerel türünü tanımlayan değerler içeriyor.  
  
 [CorAssemblyFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corassemblyflags-enumeration.md)  
 Bir bütünleştirilmiş kod derlemesi uygulanan meta verileri tanımlayan değerler içeriyor.  
  
 [CorAttributeTargets numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corattributetargets-enumeration.md)  
 Üzerinde bir öznitelik uygulamak için geçerli olan uygulama öğeleri belirtir.  
  
 [CorCallingConvention numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corcallingconvention-enumeration.md)  
 Yönetilen kodda yapılan çağırma kurallarını türlerini açıklayan değerlerini içerir.  
  
 [CorCheckDuplicatesFor numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corcheckduplicatesfor-enumeration.md)  
 Denetimler sırasında kullanılan için yinelenen değerler içeriyor.  
  
 [CorDeclSecurity numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cordeclsecurity-enumeration.md)  
 ...
 [Corerrorıfemitoutoforder numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corerrorifemitoutoforder-enumeration.md)  
 Meta verileri bozuk yayılan zaman altında bir hata iletisi oluşturulan koşulları belirtmek bayrak değerleri içerir.  
  
 [CorEventAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/coreventattr-enumeration.md)  
 Bir olay meta verilerini açıklayan değerlerini içerir.  
  
 [CorFieldAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corfieldattr-enumeration.md)  
 Meta veriler hakkında bir alan açıklamak değerlerini içerir.  
  
 [CorFileFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corfileflags-enumeration.md)  
 ...
 [CorGenericParamAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corgenericparamattr-enumeration.md)  
 ...
 [Corımportoptions numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corimportoptions-enumeration.md)  
 Geçerli kapsam dışında bir derlemeyi içe aktarılmasını sırasında davranışını denetleyen bayrak değerleri içerir.  
  
 [CorLinkerOptions numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corlinkeroptions-enumeration.md)  
 ...
 [CorManifestResourceFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cormanifestresourceflags-enumeration.md)  
 Bir derleme bildirimi kodlanmış kaynakları görünürlüğünü açıklamak değerlerini içerir.  
  
 [CorMethodAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cormethodattr-enumeration.md)  
 Bir yöntem hakkında meta verileri tanımlayan değerler içeriyor.  
  
 [Cormethodımpl numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cormethodimpl-enumeration.md)  
 Yöntem uygulaması özellikleri açıklanmaktadır değerlerini içerir.  
  
 [CorMethodSemanticsAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cormethodsemanticsattr-enumeration.md)  
 Bir yöntem ve bir ilişkili özelliğin veya olay arasındaki ilişkiyi tanımlayan değerler içeriyor.  
  
 [CorNativeLinkFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cornativelinkflags-enumeration.md)  
 Yerel kod bağlarken bağlayıcı tarafından kullanılan bayrak değerleri sağlar.  
  
 [CorNativeLinkType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cornativelinktype-enumeration.md)  
 Yerel kodda bağlı türünü gösteren değerleri sağlar.  
  
 [CorNativeType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cornativetype-enumeration.md)  
 Yerel yönetilmeyen türlerini tanımlamak değerlerini içerir.  
  
 [CorNotificationForTokenMovement numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cornotificationfortokenmovement-enumeration.md)  
 Belirteç taşıma sırasında bildirimleri etkilemek bayrak değerleri içerir.  
  
 [CorOpenFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/coropenflags-enumeration.md)  
 Bildirim dosyaları açma bağlı meta veri davranışını denetleyen bayrak değerleri içerir.  
  
 [CorParamAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corparamattr-enumeration.md)  
 ...
 [CorPinvokeMap numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corpinvokemap-enumeration.md)  
 PInvoke çağrısı özelliklerini açıklayan değerlerini içerir.  
  
 [CorPropertyAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corpropertyattr-enumeration.md)  
 Bir özelliğin meta verilerini açıklayan değerlerini içerir.  
  
 [CorRefToDefCheck numaralandırması](../../../../docs/framework/unmanaged-api/metadata/correftodefcheck-enumeration.md)  
 Hangi başvurulan öğelerin tanımlarını için kod iyileştirmek üzere dönüştürülür denetim bayrakları belirtir.  
  
 [CorRegFlags numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corregflags-enumeration.md)  
 Kayıt için bir modül veya bileşik yüklenirken kullanılan bayrak değerleri sağlar.  
  
 [CorSaveSize numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corsavesize-enumeration.md)  
 Kaydetme boyutu için sorgulanırken gerekli duyarlık düzeyini gösteren değerleri içeren işlemi.  
  
 [CorSerializationType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corserializationtype-enumeration.md)  
 ...
 [CorSetENC numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corsetenc-enumeration.md)  
 Meta veri oluşturma sırasında davranışını etkilemek için kullanılan değerler içeriyor.  
  
 [CorThreadSafetyOptions numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corthreadsafetyoptions-enumeration.md)  
 İş parçacığı güvenliği seçeneklerini seçmek için bayrakları belirtir.  
  
 [CorTokenType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cortokentype-enumeration.md)  
 Meta veri simgesi başvuran nesne türünü gösteren değerler içeriyor.  
  
 [CorTypeAttr numaralandırması](../../../../docs/framework/unmanaged-api/metadata/cortypeattr-enumeration.md)  
 Tür meta veri gösteren değerler içeriyor.  
  
 [CorUnmanagedCallingConvention numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corunmanagedcallingconvention-enumeration.md)  
 Yönetilmeyen çağırma kuralları açıklanır değerlerini içerir.  
  
 [CorValidatorModuleType numaralandırması](../../../../docs/framework/unmanaged-api/metadata/corvalidatormoduletype-enumeration.md)  
 ...
 [COUNINITIEE numaralandırması](../../../../docs/framework/unmanaged-api/metadata/couninitiee-enumeration.md)  
