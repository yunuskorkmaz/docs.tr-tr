...
---
# <a name="iceegengetstring-method"></a>ICeeGen::GetString Metodu
Belirtilen göreli sanal adresinde depolanan dizesini alır.  
...
#### <a name="parameters"></a>Parametreler  
 `RVA`  
 [in] Döndürülecek dizesinin göreli sanal adres.  
