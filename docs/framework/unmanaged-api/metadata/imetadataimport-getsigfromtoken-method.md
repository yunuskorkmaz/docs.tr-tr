...
Belirtilen belirteçle ilişkili ikili meta verileri imza alır.  
...
#### <a name="parameters"></a>Parametreler  
 `mdSig`  
 [in] İkili meta veri imzası döndürülecek belirteci.  
  
 `ppvSig`  
 [out] Döndürülen meta veri imza için bir işaretçi.  
