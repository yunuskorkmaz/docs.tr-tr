...
|CorSym_LanguageType_CPlusPlus|C++ dilini gösterir.|  
|CorSym_LanguageType_CSharp|C# dilini gösterir.|  
...
|CorSym_LanguageType_MCPlusPlus|.NET Framework için etkinleştirilmiş C++ dilini gösterir.|  
