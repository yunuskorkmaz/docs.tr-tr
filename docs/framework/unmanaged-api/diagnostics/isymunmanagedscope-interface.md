...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[GetChildren Yöntemi](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedscope-getchildren-method.md)|Bu kapsamın alt öğeleri alır.|  
|[GetEndOffset Yöntemi](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedscope-getendoffset-method.md)|Bu kapsam için bitiş uzaklığı alır.|  
...
|[GetLocals Yöntemi](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedscope-getlocals-method.md)|Bu kapsam içinde tanımlanan yerel değişkenler alır.|  
...
|[GetStartOffset Yöntemi](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedscope-getstartoffset-method.md)|Bu kapsam için başlangıç uzaklığını alır.|  
