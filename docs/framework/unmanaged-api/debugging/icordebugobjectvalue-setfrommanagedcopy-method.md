...
ms.locfileid: "59203775"
---
# <a name="icordebugobjectvaluesetfrommanagedcopy-method"></a>ICorDebugObjectValue::SetFromManagedCopy Yöntemi
`SetFromManagedCopy` artık kullanılmıyor. Bu yöntemi çağırmanız gerekmez.  
