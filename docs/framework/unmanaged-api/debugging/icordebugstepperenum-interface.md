...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[Next Yöntemi](../../../../docs/framework/unmanaged-api/debugging/icordebugstepperenum-next-method.md)|Belirtilen sayıda alır `ICorDebugStepper` örneklerden geçerli konumunda başlayan bir numaralandırma.|  
