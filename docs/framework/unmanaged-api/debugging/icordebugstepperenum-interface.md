...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[Next Yöntemi](icordebugstepperenum-next-method.md)|`ICorDebugStepper`Geçerli konumdan başlayarak Numaralandırmadaki belirtilen örnek sayısını alır.|  
