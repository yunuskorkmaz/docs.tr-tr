...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[Next Yöntemi](icordebugstepperenum-next-method.md)|Geçerli konumdan başlayarak Numaralandırmadaki belirtilen `ICorDebugStepper` örneği sayısını alır.|  
