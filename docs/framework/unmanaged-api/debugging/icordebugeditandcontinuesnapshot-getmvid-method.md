...
---
# <a name="icordebugeditandcontinuesnapshotgetmvid-method"></a>ICorDebugEditAndContinueSnapshot::GetMvid Metodu
`GetMvid` artık kullanılmıyor. Bu yöntemi çağırmanız gerekmez.  
