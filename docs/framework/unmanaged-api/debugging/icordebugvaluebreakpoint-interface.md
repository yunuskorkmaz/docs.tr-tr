...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[GetValue Metodu](icordebugvaluebreakpoint-getvalue-method.md)|Kesme noktasının ayarlandığı nesnenin değerini temsil eden ICorDebugValue nesnesine yönelik bir arabirim işaretçisi alır.|  
