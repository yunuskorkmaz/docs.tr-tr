...
---
# <a name="icordebugeditandcontinueerrorinfogetstring-method"></a>ICorDebugEditAndContinueErrorInfo::GetString Metodu
`GetString` artık kullanılmıyor. Bu yöntemi çağırmanız gerekmez.  
