...
#### <a name="parameters"></a>Parametreler  
 `ppFrame`  
 [out] Adresine bir işaretçi bir `ICorDebugFrame` çağrılan çerçeveyi temsil eden nesne. Bu değer arama çerçeve geçerli zincirindeki en içteki çerçeve ise null şeklindedir.  
