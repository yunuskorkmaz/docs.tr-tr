...
---
# <a name="icordebugeditandcontinuesnapshotsetpebytes-method"></a>ICorDebugEditAndContinueSnapshot::SetPEBytes Yöntemi
`SetPEBytes` Kullanımdan kalktı. Bu yöntemi çağırmanız gerekmez.  
