...
Bellek içi arabelleği temsil eder.  
  
## <a name="methods"></a>Yöntemler  
  
|Yöntem|Açıklama|  
|------------|-----------------|  
|[GetSize Yöntemi](icordebugmemorybuffer-getsize-method.md)|Bellek arabelleğinin boyutunu bayt cinsinden alır.|  
|[GetStartAddress Yöntemi](icordebugmemorybuffer-getstartaddress-method.md)|Bellek arabelleğinin başlangıç adresini alır.|  
