...
## <a name="terminology"></a>Terminoloji  
 ...
 Hem kapsayıcı modülleri hem de alt modüller ICorDebugModule arabirim nesneleriyle temsil edilir. Ancak, bölümünde açıklandığı gibi, arabirimin davranışı her durumda biraz farklıdır \<x-ref to section> .  
