...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[GetObject Yöntemi](../../../../docs/framework/unmanaged-api/debugging/icordebugboxvalue-getobject-method.md)|Arabirim işaretçisi Kutulu "ICorDebugObjectValue" örneğinde alır.|  
