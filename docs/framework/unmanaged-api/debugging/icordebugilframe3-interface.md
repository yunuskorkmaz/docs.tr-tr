...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[GetReturnValueForILOffset Yöntemi](icordebugilframe3-getreturnvalueforiloffset-method.md)|Bir işlevin dönüş değerini kapsülleyen bir ICorDebugValue nesnesi alır.|  
