...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[Next Yöntemi](icordebugprocessenum-next-method.md)|Geçerli konumdan başlayarak Numaralandırmadaki belirtilen `ICorDebugProcess` örneği sayısını alır.|  
