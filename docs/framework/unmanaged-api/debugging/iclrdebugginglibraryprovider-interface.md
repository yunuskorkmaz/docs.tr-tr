...
|Yöntem|Açıklama|  
|------------|-----------------|  
|[ProvideLibrary Yöntemi](../../../../docs/framework/unmanaged-api/debugging/iclrdebugginglibraryprovider-providelibrary-method.md)|Hata ayıklama kitaplığı yüklemek için kullanılan bir modül için bir tanıtıcı sağlamak hata ayıklayıcı sağlar.|  
