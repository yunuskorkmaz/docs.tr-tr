---
description: ': ICorDebugController:: CanCommitChanges yöntemi hakkında daha fazla bilgi edinin'
...
ms.locfileid: "99710770"
---
# <a name="icordebugcontrollercancommitchanges-method"></a>ICorDebugController::CanCommitChanges Yöntemi

`CanCommitChanges` artık kullanılmıyor. Bu yöntemi çağırmayın.
