...
---
# <a name="icordebugeditandcontinueerrorinfogetmodule-method"></a>ICorDebugEditAndContinueErrorInfo::GetModule Metodu
`GetModule` artık kullanılmıyor. Bu yöntemi çağırmanız gerekmez.  
