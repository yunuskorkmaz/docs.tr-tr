...
---
# <a name="icordebugeditandcontinuesnapshotsetpesymbolbytes-method"></a>ICorDebugEditAndContinueSnapshot::SetPESymbolBytes Yöntemi
`SetPESymbolBytes` artık kullanılmıyor. Bu yöntemi çağırmanız gerekmez.  
