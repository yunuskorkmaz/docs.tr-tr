...
|Başlık|Personel Veritabanı|
 ...
 Aşağıdaki kod, `UILibrary` sınıfının ve kaynaklarının bir Windows 8. x mağaza uygulamasından nasıl erişilebilir olduğunu gösterir. Windows Mağazası uygulama projesine eklenmek üzere UILibrary.dll için bir başvuru gerektirir.
