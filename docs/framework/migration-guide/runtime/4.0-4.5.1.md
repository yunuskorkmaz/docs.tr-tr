---
title: .NET Framework 4,0 ' den 4.5.1 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4,0 ' den 4.5.1 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86443708"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="ad465-103">.NET Framework 4,0 ' den 4.5.1 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="ad465-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ad465-104">4,0 .NET Framework 'den 4.5.1 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="ad465-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="ad465-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="ad465-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="ad465-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ad465-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ad465-107">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="ad465-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ad465-108">Veri</span><span class="sxs-lookup"><span data-stu-id="ad465-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ad465-109">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="ad465-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ad465-110">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="ad465-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="ad465-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="ad465-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="ad465-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="ad465-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="ad465-113">Ağ</span><span class="sxs-lookup"><span data-stu-id="ad465-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="ad465-114">Yazdırma</span><span class="sxs-lookup"><span data-stu-id="ad465-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ad465-115">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="ad465-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="ad465-116">Web Uygulamaları</span><span class="sxs-lookup"><span data-stu-id="ad465-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ad465-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ad465-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="ad465-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="ad465-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ad465-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ad465-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ad465-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ad465-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="ad465-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="ad465-121">XML, XSLT</span></span>
