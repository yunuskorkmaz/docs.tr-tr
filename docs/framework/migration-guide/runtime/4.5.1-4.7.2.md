...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-472"></a>.NET Framework 4.5.1'den 4.7.2'ye Geçiş Için Çalışma Zamanı Değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.5.1 ile 4.7.2 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
