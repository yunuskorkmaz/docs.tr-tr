---
title: .NET Framework 4.5.1 için 4.8 geçiş için çalışma zamanı değişiklikleri
ms.date: 04/18/2019
ms.assetid: a2c49220-76db-47b4-9b0d-7f9681096d7a
author: chlowell
ms.author: ronpet
ms.openlocfilehash: a2be340ee70676c712dd31902bdff8134251bbb0
ms.sourcegitcommit: 9b552addadfb57fab0b9e7852ed4f1f1b8a42f8e
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 04/23/2019
ms.locfileid: "62032909"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-48"></a><span data-ttu-id="cb72a-102">.NET Framework 4.5.1 için 4.8 geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="cb72a-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cb72a-103">.NET Framework 4.5.1 için 4.8 geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="cb72a-103">If you are migrating from the .NET Framework 4.5.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="cb72a-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cb72a-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cb72a-105">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="cb72a-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cb72a-106">Veri</span><span class="sxs-lookup"><span data-stu-id="cb72a-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="cb72a-107">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="cb72a-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cb72a-108">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="cb72a-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="cb72a-109">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="cb72a-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="cb72a-110">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="cb72a-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="cb72a-111">Çalışma zamanı</span><span class="sxs-lookup"><span data-stu-id="cb72a-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="cb72a-112">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="cb72a-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cb72a-113">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="cb72a-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="cb72a-114">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="cb72a-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="cb72a-115">Araçlar</span><span class="sxs-lookup"><span data-stu-id="cb72a-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="cb72a-116">Web Uygulamaları</span><span class="sxs-lookup"><span data-stu-id="cb72a-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cb72a-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cb72a-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cb72a-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cb72a-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="cb72a-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="cb72a-119">Windows Workflow Foundation (WF)</span></span>
