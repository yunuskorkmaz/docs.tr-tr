...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-462"></a>.NET Framework 4,0 ' den 4.6.2 'e geçiş için çalışma zamanı değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

4,0 .NET Framework 'den 4.6.2 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
