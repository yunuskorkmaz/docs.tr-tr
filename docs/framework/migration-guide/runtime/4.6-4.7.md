...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a>.NET Framework 4,6 ' den 4,7 ' e geçiş için çalışma zamanı değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

4,6 .NET Framework ' den 4,7 ' e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
