---
title: .NET Framework 4,6 ' den 4,7 ' e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4,6 ' den 4,7 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86444033"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="2c668-103">.NET Framework 4,6 ' den 4,7 ' e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="2c668-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="2c668-104">4,6 .NET Framework ' den 4,7 ' e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="2c668-104">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="2c668-105">Veri</span><span class="sxs-lookup"><span data-stu-id="2c668-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="2c668-106">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="2c668-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="2c668-107">JIT</span><span class="sxs-lookup"><span data-stu-id="2c668-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="2c668-108">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="2c668-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="2c668-109">Araçlar</span><span class="sxs-lookup"><span data-stu-id="2c668-109">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2c668-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2c668-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2c668-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2c668-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2c668-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2c668-112">Windows Workflow Foundation (WF)</span></span>
