---
title: .NET Framework 4.5.1 'den 4.5.2 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4.5.1 ' den 4.5.2 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "97009078"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="85751-103">.NET Framework 4.5.1 'den 4.5.2 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="85751-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="85751-104">.NET Framework 4.5.1 ' den 4.5.2 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="85751-104">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="85751-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="85751-105">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="85751-106">Veriler</span><span class="sxs-lookup"><span data-stu-id="85751-106">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="85751-107">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="85751-107">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="85751-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="85751-108">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="85751-109">XML</span><span class="sxs-lookup"><span data-stu-id="85751-109">XML</span></span>
