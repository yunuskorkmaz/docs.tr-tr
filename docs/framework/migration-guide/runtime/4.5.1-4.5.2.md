...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="c00d9-102">.NET Framework 4.5.1'den 4.5.2'ye Geçiş Için Çalışma Zamanı Değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="c00d9-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c00d9-103">.NET Framework 4.5.1 ile 4.5.2 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="c00d9-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c00d9-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c00d9-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="c00d9-105">Veriler</span><span class="sxs-lookup"><span data-stu-id="c00d9-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c00d9-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c00d9-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c00d9-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c00d9-107">Windows Presentation Foundation (WPF)</span></span>
