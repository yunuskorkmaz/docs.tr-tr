---
title: .NET Framework 4,5 ' den 4.6.1 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4,5 ' den 4.6.1 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "97009299"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="4d3cf-103">.NET Framework 4,5 ' den 4.6.1 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="4d3cf-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4d3cf-104">4,5 .NET Framework 'den 4.6.1 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="4d3cf-104">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4d3cf-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4d3cf-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4d3cf-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4d3cf-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4d3cf-107">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="4d3cf-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4d3cf-108">Veriler</span><span class="sxs-lookup"><span data-stu-id="4d3cf-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4d3cf-109">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="4d3cf-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4d3cf-110">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="4d3cf-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="4d3cf-111">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="4d3cf-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4d3cf-112">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="4d3cf-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4d3cf-113">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="4d3cf-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="4d3cf-114">Araçlar</span><span class="sxs-lookup"><span data-stu-id="4d3cf-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4d3cf-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4d3cf-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4d3cf-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4d3cf-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="4d3cf-117">XML</span><span class="sxs-lookup"><span data-stu-id="4d3cf-117">XML</span></span>
