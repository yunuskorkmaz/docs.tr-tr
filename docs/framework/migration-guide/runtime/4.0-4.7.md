...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a>.NET Framework 4.0 için 4.7 geçiş için çalışma zamanı değişiklikleri

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

4.7 için .NET Framework 4. 0 ' geçiriyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
