...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a>.NET Framework 4.5.2'den 4.6'ya Geçiş Için Çalışma Zamanı Değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.5.2 ile 4.6 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
