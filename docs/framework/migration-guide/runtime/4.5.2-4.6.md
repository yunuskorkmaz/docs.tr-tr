...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a>.NET Framework 4.5.2 'den 4,6 ' e geçiş için çalışma zamanı değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.5.2 ' den 4,6 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
