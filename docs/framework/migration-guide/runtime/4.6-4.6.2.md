---
title: .NET Framework 4,6 ' den 4.6.2 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4,6 ' den 4.6.2 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86444046"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="4f5c9-103">.NET Framework 4,6 ' den 4.6.2 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="4f5c9-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4f5c9-104">4,6 .NET Framework 'den 4.6.2 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="4f5c9-104">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="4f5c9-105">Veri</span><span class="sxs-lookup"><span data-stu-id="4f5c9-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4f5c9-106">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="4f5c9-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="4f5c9-107">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="4f5c9-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="4f5c9-108">Araçlar</span><span class="sxs-lookup"><span data-stu-id="4f5c9-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4f5c9-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4f5c9-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4f5c9-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4f5c9-110">Windows Presentation Foundation (WPF)</span></span>
