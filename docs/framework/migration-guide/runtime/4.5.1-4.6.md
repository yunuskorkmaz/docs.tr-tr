...
ms.locfileid: "59771985"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="eecdd-102">.NET Framework 4.5.1 için 4.6 geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="eecdd-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="eecdd-103">.NET Framework 4.5.1 için 4.6 geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="eecdd-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="eecdd-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="eecdd-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="eecdd-105">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="eecdd-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="eecdd-106">Veri</span><span class="sxs-lookup"><span data-stu-id="eecdd-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="eecdd-107">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="eecdd-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="eecdd-108">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="eecdd-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="eecdd-109">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="eecdd-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="eecdd-110">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="eecdd-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="eecdd-111">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="eecdd-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="eecdd-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="eecdd-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="eecdd-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="eecdd-113">Windows Presentation Foundation (WPF)</span></span>
