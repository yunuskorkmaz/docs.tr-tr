---
title: .NET Framework 4.6 için 4.8 geçiş için çalışma zamanı değişiklikleri
ms.date: 04/18/2019
ms.assetid: ad0ad2e5-bcc5-4fad-8449-fc1d7d5db0f8
author: chlowell
ms.author: ronpet
ms.openlocfilehash: 8b6adcd2980e22dbf9403b2d56b89bafdf73c07e
ms.sourcegitcommit: 9b552addadfb57fab0b9e7852ed4f1f1b8a42f8e
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 04/23/2019
ms.locfileid: "62033260"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-48"></a><span data-ttu-id="83d2d-102">.NET Framework 4.6 için 4.8 geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="83d2d-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="83d2d-103">4.8 için .NET Framework 4. 6 ' geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="83d2d-103">If you are migrating from the .NET Framework 4.6 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="83d2d-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="83d2d-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="83d2d-105">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="83d2d-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="83d2d-106">Veri</span><span class="sxs-lookup"><span data-stu-id="83d2d-106">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="83d2d-107">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="83d2d-107">Globalization</span></span>
...
## <a name="runtime"></a><span data-ttu-id="83d2d-108">Çalışma zamanı</span><span class="sxs-lookup"><span data-stu-id="83d2d-108">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="83d2d-109">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="83d2d-109">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="83d2d-110">Araçlar</span><span class="sxs-lookup"><span data-stu-id="83d2d-110">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="83d2d-111">Web Uygulamaları</span><span class="sxs-lookup"><span data-stu-id="83d2d-111">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="83d2d-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="83d2d-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="83d2d-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="83d2d-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="83d2d-114">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="83d2d-114">Windows Workflow Foundation (WF)</span></span>
