...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-48"></a>.NET Framework 4.6'dan 4.8'e Geçiş Için Çalışma Zamanı Değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.6 ile 4.8 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
