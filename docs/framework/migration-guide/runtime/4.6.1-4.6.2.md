---
title: .NET Framework 4.6.1'den 4.6.2'ye Geçiş Için Çalışma Zamanı Değişiklikleri
ms.date: 07/10/2019
...
ms.locfileid: "73196419"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="c30e9-102">.NET Framework 4.6.1'den 4.6.2'ye Geçiş Için Çalışma Zamanı Değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="c30e9-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c30e9-103">.NET Framework 4.6.1 ile 4.6.2 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="c30e9-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="c30e9-104">Veriler</span><span class="sxs-lookup"><span data-stu-id="c30e9-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c30e9-105">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="c30e9-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="c30e9-106">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="c30e9-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c30e9-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c30e9-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c30e9-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c30e9-108">Windows Presentation Foundation (WPF)</span></span>
