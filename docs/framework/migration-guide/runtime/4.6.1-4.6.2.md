...
ms.locfileid: "62032578"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="1c0c1-102">.NET Framework 4.6.1 için 4.6.2 geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="1c0c1-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1c0c1-103">.NET Framework 4.6.1 için 4.6.2 geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="1c0c1-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="1c0c1-104">Veri</span><span class="sxs-lookup"><span data-stu-id="1c0c1-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="1c0c1-105">Genelleştirme</span><span class="sxs-lookup"><span data-stu-id="1c0c1-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="1c0c1-106">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="1c0c1-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1c0c1-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1c0c1-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1c0c1-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1c0c1-108">Windows Presentation Foundation (WPF)</span></span>
