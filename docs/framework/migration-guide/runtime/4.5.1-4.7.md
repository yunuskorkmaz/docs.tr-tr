...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-47"></a>.NET Framework 4.5.1 'den 4,7 ' e geçiş için çalışma zamanı değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.5.1 ' den 4,7 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
