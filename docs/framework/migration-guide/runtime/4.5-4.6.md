...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="14c0b-102">.NET Framework 4.5 için 4.6 geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="14c0b-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="14c0b-103">4.6 için .NET Framework 4.5'ten geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="14c0b-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="14c0b-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="14c0b-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="14c0b-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="14c0b-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="14c0b-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="14c0b-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="14c0b-107">Veri</span><span class="sxs-lookup"><span data-stu-id="14c0b-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="14c0b-108">Hata ayıklayıcı</span><span class="sxs-lookup"><span data-stu-id="14c0b-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="14c0b-109">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="14c0b-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="14c0b-110">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="14c0b-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="14c0b-111">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="14c0b-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="14c0b-112">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="14c0b-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="14c0b-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="14c0b-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="14c0b-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="14c0b-114">Windows Presentation Foundation (WPF)</span></span>
