---
title: .NET Framework 4,5 ' den 4.5.1 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4,5 ' den 4.5.1 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86443214"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="b0243-103">.NET Framework 4,5 ' den 4.5.1 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="b0243-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b0243-104">4,5 .NET Framework 'den 4.5.1 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="b0243-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b0243-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b0243-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b0243-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="b0243-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b0243-107">Veri</span><span class="sxs-lookup"><span data-stu-id="b0243-107">Data</span></span>

[!INCLUDE[ADO.NET now attempts to automatically reconnect broken SQL connections](~/includes/migration-guide/runtime/adonet/adonet-now-attempts-automatically-reconnect-broken-sql-connections.md)]

## <a name="serialization"></a><span data-ttu-id="b0243-108">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="b0243-108">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b0243-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b0243-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b0243-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b0243-110">Windows Presentation Foundation (WPF)</span></span>
