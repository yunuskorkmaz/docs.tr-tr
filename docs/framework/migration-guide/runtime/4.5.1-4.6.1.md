...
ms.locfileid: "91607844"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="a21b0-103">.NET Framework 4.5.1 'den 4.6.1 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="a21b0-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a21b0-104">.NET Framework 4.5.1 ' den 4.6.1 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="a21b0-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a21b0-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a21b0-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a21b0-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="a21b0-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a21b0-107">Veriler</span><span class="sxs-lookup"><span data-stu-id="a21b0-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a21b0-108">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="a21b0-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a21b0-109">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="a21b0-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="a21b0-110">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="a21b0-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a21b0-111">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="a21b0-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a21b0-112">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="a21b0-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a21b0-113">Araçlar</span><span class="sxs-lookup"><span data-stu-id="a21b0-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a21b0-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a21b0-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a21b0-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a21b0-115">Windows Presentation Foundation (WPF)</span></span>
