---
title: .NET Framework 4.5.1 'den 4.6.1 'e geçiş için çalışma zamanı değişiklikleri
description: .NET Framework 4.5.1 ' den 4.6.1 ' den geçiş yaparken uygulamanızı etkileyebilecek çalışma zamanı değişikliklerinden uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "97009878"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="47f2c-103">.NET Framework 4.5.1 'den 4.6.1 'e geçiş için çalışma zamanı değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="47f2c-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="47f2c-104">.NET Framework 4.5.1 ' den 4.6.1 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="47f2c-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="47f2c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="47f2c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="47f2c-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="47f2c-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="47f2c-107">Veriler</span><span class="sxs-lookup"><span data-stu-id="47f2c-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="47f2c-108">Hata Ayıklayıcısı</span><span class="sxs-lookup"><span data-stu-id="47f2c-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="47f2c-109">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="47f2c-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="47f2c-110">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="47f2c-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="47f2c-111">Serileştirme</span><span class="sxs-lookup"><span data-stu-id="47f2c-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="47f2c-112">Kurulum ve dağıtım</span><span class="sxs-lookup"><span data-stu-id="47f2c-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="47f2c-113">Araçlar</span><span class="sxs-lookup"><span data-stu-id="47f2c-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="47f2c-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="47f2c-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="47f2c-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="47f2c-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="47f2c-116">XML</span><span class="sxs-lookup"><span data-stu-id="47f2c-116">XML</span></span>
