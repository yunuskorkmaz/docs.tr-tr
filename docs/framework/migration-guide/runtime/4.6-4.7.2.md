...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-472"></a>.NET Framework 4.6'dan 4.7.2'ye Geçiş Için Çalışma Zamanı Değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

.NET Framework 4.6 ile 4.7.2'den geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
