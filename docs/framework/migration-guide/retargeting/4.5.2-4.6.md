---
title: .NET Framework 4.5.2'den 4.6'ya Geçiş Değişikliklerini Yeniden Hedefleme
ms.date: 07/10/2019
...
ms.locfileid: "79399954"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="f327b-102">.NET Framework 4.5.2'den 4.6'ya Geçiş Değişikliklerini Yeniden Hedefleme</span><span class="sxs-lookup"><span data-stu-id="f327b-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="f327b-103">.NET Framework 4.5.2 ile 4.6 arasında geçiş yapıyorsunuz, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="f327b-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f327b-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f327b-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="f327b-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="f327b-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="f327b-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="f327b-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f327b-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f327b-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="f327b-108">JIT</span><span class="sxs-lookup"><span data-stu-id="f327b-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="f327b-109">Ağ</span><span class="sxs-lookup"><span data-stu-id="f327b-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f327b-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f327b-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="f327b-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="f327b-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f327b-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f327b-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="f327b-113">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="f327b-113">XML, XSLT</span></span>
