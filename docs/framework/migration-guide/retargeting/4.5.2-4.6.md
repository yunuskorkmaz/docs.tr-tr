---
title: .NET Framework 4.5.2 'den 4,6 ' e geçiş için yeniden hedefleme değişiklikleri
description: .NET Framework 4.5.2 'den 4,6 ' e geçiş yaparken uygulamanızı etkileyebilecek uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86443747"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="89b32-103">.NET Framework 4.5.2 'den 4,6 ' e geçiş için yeniden hedefleme değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="89b32-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="89b32-104">.NET Framework 4.5.2 ' den 4,6 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="89b32-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="89b32-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="89b32-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="89b32-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="89b32-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="89b32-107">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="89b32-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="89b32-108">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="89b32-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="89b32-109">JIT</span><span class="sxs-lookup"><span data-stu-id="89b32-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="89b32-110">Ağ</span><span class="sxs-lookup"><span data-stu-id="89b32-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="89b32-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="89b32-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="89b32-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="89b32-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="89b32-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="89b32-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="89b32-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="89b32-114">XML, XSLT</span></span>
