---
title: .NET Framework 4.6.1 'den 4,8 ' e geçiş için yeniden hedefleme değişiklikleri
description: .NET Framework 4.6.1 'den 4,8 ' e geçiş yaparken uygulamanızı etkileyebilecek uygulama uyumluluk sorunları hakkında bilgi edinin.
ms.date: 07/10/2019
...
ms.locfileid: "86443695"
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-48"></a><span data-ttu-id="f179a-103">.NET Framework 4.6.1 'den 4,8 ' e geçiş için yeniden hedefleme değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="f179a-103">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="f179a-104">.NET Framework 4.6.1 ' den 4,8 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="f179a-104">If you are migrating from the .NET Framework 4.6.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f179a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f179a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f179a-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="f179a-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="f179a-107">Ağ</span><span class="sxs-lookup"><span data-stu-id="f179a-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="f179a-108">Güvenlik</span><span class="sxs-lookup"><span data-stu-id="f179a-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f179a-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f179a-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="f179a-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="f179a-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f179a-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f179a-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f179a-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f179a-112">Windows Workflow Foundation (WF)</span></span>
