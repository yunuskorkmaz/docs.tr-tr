...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-472"></a>.NET Framework 4,6 ' den 4.7.2 'e geçiş için yeniden hedefleme değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

4,6 .NET Framework 'den 4.7.2 'e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
