...
ms.locfileid: "33389718"
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-471"></a>.NET Framework 4.5 için 4.7.1 geçiş için yeniden hedefleme değişiklikleri

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

4.7.1 için .NET Framework 4.5'ten geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
