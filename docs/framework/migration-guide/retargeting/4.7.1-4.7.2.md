---
title: .NET Framework 4.7.1 için 4.7.2 geçiş için yeniden hedefleme değişiklikleri
ms.date: 04/18/2019
ms.assetid: 0ced7995-26f3-4bdc-a37d-aa516cf43562
author: chlowell
ms.author: ronpet
ms.openlocfilehash: cd4a9762dd3452c95db1c25fc7db645ee8a91f79
ms.sourcegitcommit: 9b552addadfb57fab0b9e7852ed4f1f1b8a42f8e
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 04/23/2019
ms.locfileid: "61783415"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="92b9a-102">.NET Framework 4.7.1 için 4.7.2 geçiş için yeniden hedefleme değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="92b9a-102">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="92b9a-103">.NET Framework 4.7.1 için 4.7.2 geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="92b9a-103">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="92b9a-104">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="92b9a-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="92b9a-105">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="92b9a-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="92b9a-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="92b9a-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="92b9a-107">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="92b9a-107">Windows Workflow Foundation (WF)</span></span>
