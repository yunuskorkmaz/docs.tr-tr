...
ms.locfileid: "33387165"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a>.NET Framework için 4.7.1 4.7.2 geçiş için yeniden hedefleme değişiklikleri
