...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a>.NET Framework 4.0 için 4.5.1 geçiş için yeniden hedefleme değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

4.5.1 için .NET Framework 4.0 geçiriyorsanız, uygulamanızı etkileyebileceğini uygulama uyumluluğu sorunları için aşağıdaki konuları gözden geçirin:
