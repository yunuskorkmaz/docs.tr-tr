...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-46"></a>.NET Framework 4,5 ' den 4,6 ' ye geçiş için yeniden hedefleme değişiklikleri

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

4,5 .NET Framework ' den 4,6 ' e geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:
