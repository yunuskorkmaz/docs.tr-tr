...
ms.locfileid: "73194143"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="40ef3-102">.NET Framework 4.5.2 ' den 4.6.1 ' ye geçiş için yeniden hedefleme değişiklikleri</span><span class="sxs-lookup"><span data-stu-id="40ef3-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="40ef3-103">.NET Framework 4.5.2 ' den 4.6.1 ' ye geçiş yapıyorsanız, uygulamanızı etkileyebilecek uygulama uyumluluk sorunları için aşağıdaki konuları gözden geçirin:</span><span class="sxs-lookup"><span data-stu-id="40ef3-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="40ef3-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="40ef3-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="40ef3-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="40ef3-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="40ef3-106">Çekirdek</span><span class="sxs-lookup"><span data-stu-id="40ef3-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="40ef3-107">Varlık Çerçevesi</span><span class="sxs-lookup"><span data-stu-id="40ef3-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="40ef3-108">JIT</span><span class="sxs-lookup"><span data-stu-id="40ef3-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="40ef3-109">Ağ Oluşturma</span><span class="sxs-lookup"><span data-stu-id="40ef3-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="40ef3-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="40ef3-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="40ef3-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="40ef3-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="40ef3-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="40ef3-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="40ef3-113">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="40ef3-113">XML, XSLT</span></span>
