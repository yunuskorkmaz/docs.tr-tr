...
ms.locfileid: "73123703"
---
# <a name="com-interop-sample-com-client-and-net-server"></a><span data-ttu-id="404a4-102">COM Birlikte Çalışma Örneği: COM İstemcisi ve .NET Sunucusu</span><span class="sxs-lookup"><span data-stu-id="404a4-102">COM Interop Sample: COM Client and .NET Server</span></span>
<span data-ttu-id="404a4-103">Bu örnek, bir [com istemcisinin](#cpconcominteropsamplecomclientnetserveranchor1) ve ipotek hesaplamaları gerçekleştiren bir [.net sunucusunun](#cpconcominteropsamplecomclientnetserveranchor2) birlikte çalışmasını gösterir.</span><span class="sxs-lookup"><span data-stu-id="404a4-103">This sample demonstrates the interoperation of a [COM Client](#cpconcominteropsamplecomclientnetserveranchor1) and a [.NET Server](#cpconcominteropsamplecomclientnetserveranchor2) that performs mortgage calculations.</span></span> <span data-ttu-id="404a4-104">Bu örnekte istemci, yönetilen `Loan` sınıfının bir örneğini oluşturur ve çağırır, örnek olarak dört bağımsız değişken geçirir (Bu dördü sıfıra eşit bir tane) ve hesaplamalar görüntülenir.</span><span class="sxs-lookup"><span data-stu-id="404a4-104">In this example, the client creates and calls an instance of the managed `Loan` class, passes four arguments (one of those four being equal to zero) to the instance, and displays the computations.</span></span> <span data-ttu-id="404a4-105">Bu örnekteki kod örnekleri bu bölümün tamamında görüntülenir.</span><span class="sxs-lookup"><span data-stu-id="404a4-105">Code examples from this sample appear throughout this section.</span></span>  
  
<a name="cpconcominteropsamplecomclientnetserveranchor1"></a>   
## <a name="com-client"></a><span data-ttu-id="404a4-106">COM Istemcisi</span><span class="sxs-lookup"><span data-stu-id="404a4-106">COM Client</span></span>  
...
## <a name="net-server"></a><span data-ttu-id="404a4-107">.NET Server</span><span class="sxs-lookup"><span data-stu-id="404a4-107">.NET Server</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="404a4-108">Ayrıca bkz.</span><span class="sxs-lookup"><span data-stu-id="404a4-108">See also</span></span>

- [<span data-ttu-id="404a4-109">.NET Framework Bileşenlerini COM'da Gösterme</span><span class="sxs-lookup"><span data-stu-id="404a4-109">Exposing .NET Framework Components to COM</span></span>](exposing-dotnet-components-to-com.md)
