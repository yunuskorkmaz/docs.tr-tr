...
|Sonuç olarak.|Yönetilmeyen kod dizelerden döndürür.|[Dizeleri](http://msdn.microsoft.com/en-us/be9e82a3-dc95-4aaa-9396-61b66e467e02)|  
...
|Başvuruya göre bir yapı **(char\*)**.|Dizeleri giriş/çıkış parametresi bir yapısında geçirir. Yönetilmeyen işlev karakter arabellek için bir işaretçi bekler ve arabellek boyutu yapısı bir üyesidir.|[Dizeleri](http://msdn.microsoft.com/en-us/be9e82a3-dc95-4aaa-9396-61b66e467e02)|  
