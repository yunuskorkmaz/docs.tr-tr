...
### <a name="example"></a>Örnek  
 Bu örnekte yükleyen bir <xref:System.Data.DataTable> kullanarak sorgu sonuçları ile <xref:System.Data.DataTableExtensions.CopyToDataTable%2A> yöntemi.  
...
### <a name="example"></a>Örnek  
 Bu örnek iki farklı veri satırları kullanarak karşılaştırır <xref:System.Data.DataRowComparer>.  
