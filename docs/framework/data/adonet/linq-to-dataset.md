...
[!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)]daha kolay ve hızlı sorguya, önbelleğe alınan veriler üzerinde kolaylaştırır bir <xref:System.Data.DataSet> nesnesi. Özellikle, [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)] sorguları programlama dili kendisi yerine ayrı sorgu dilini kullanarak yazmak geliştiricilere etkinleştirerek sorgulama basitleştirir. Bu özellikle yararlı [!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)] şimdi, derleme zamanı sözdizimi denetimi, statik yazarak ve IntelliSense desteği tarafından sağlanan yararlanabilir geliştiriciler [!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)] kendi sorgularda.  
