...
Bu bölümde, SQL Server () için .NET Framework Veri Sağlayıcısı özgü özellikleri ve işlevleri SQL Server açıklanmaktadır <xref:System.Data.SqlClient> .  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 <xref:System.Data.SqlClient.SqlDataReader>Her bir örneği <xref:System.Data.SqlClient.SqlDataReader> ayrı bir komuttan başlatıldığında bir bağlantı üzerinde birden fazla açma işlemini açıklar.  
