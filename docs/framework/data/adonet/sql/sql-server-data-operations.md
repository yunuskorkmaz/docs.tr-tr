...
---
# <a name="sql-server-data-operations-in-adonet"></a>SQL Server veri işlemleri ADO.NET
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Birden fazla sahip açıklar <xref:System.Data.SqlClient.SqlDataReader> bağlantı üzerinde açık olduğunda her örneği <xref:System.Data.SqlClient.SqlDataReader> ayrı bir komutu başlatıldı.  
  
 [Zaman Uyumsuz İşlemler](../../../../../docs/framework/data/adonet/sql/asynchronous-operations.md)  
 .NET Framework tarafından kullanılan zaman uyumsuz modelini sonra Modellenen bir API kullanarak zaman uyumsuz veritabanı işlemleri gerçekleştirmek açıklar.  
