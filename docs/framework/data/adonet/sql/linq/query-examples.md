...
Bu bölümde [!INCLUDE[vbprvb](../../../../../../includes/vbprvb-md.md)] ve C# örnekleri tipik [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] sorgular. Kullanan geliştiriciler [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)] pek çok daha fazla örnek bir örnek çözümü kullanılabilir örnekleri bölümünde bulabilirsiniz. Daha fazla bilgi için bkz: [örnekleri](../../../../../../docs/framework/data/adonet/sql/linq/samples.md).  
