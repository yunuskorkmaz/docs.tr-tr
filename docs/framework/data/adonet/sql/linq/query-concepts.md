...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 Açıklayan konulara bağlantılar içerir [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] teknolojisi.  
  
 [Nesne Kimliği](../../../../../../docs/framework/data/adonet/sql/linq/object-identity.md)  
 Nesne Kimliği kavramını açıklar [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)].  
  
 [Giriş LINQ sorgularını (C#)](~/docs/csharp/programming-guide/concepts/linq/introduction-to-linq-queries.md)  
 Sorgu işlemlerinde tanıtılmaktadır [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)].
