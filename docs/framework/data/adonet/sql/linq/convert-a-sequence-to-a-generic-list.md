...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanır <xref:System.Linq.Enumerable.ToList%2A> hemen genel bir sorguyu değerlendirmek için <xref:System.Collections.Generic.List%601>.  
