...
---
# <a name="method-based-query-syntax-examples-conversion-operators-linq-to-dataset"></a>Yöntem temelli sorgu sözdizimi örnekler: Dönüşüm işleçleri (LINQ-DataSet)
Bu konudaki örnekler nasıl kullanılacağını gösteren <xref:System.Linq.Enumerable.ToArray%2A>, <xref:System.Linq.Enumerable.ToDictionary%2A>, ve <xref:System.Linq.Enumerable.ToList%2A> hemen bir sorgu ifadesi yürütmek için yöntemler.  
...
### <a name="example"></a>Örnek  
 Bu örnekte <xref:System.Linq.Enumerable.ToArray%2A> hemen bir dizi bir dizi içine değerlendirmek için bir yöntem.  
...
### <a name="example"></a>Örnek  
 Bu örnekte <xref:System.Linq.Enumerable.ToDictionary%2A> hemen bir sıra ve bir sözlük ilgili bir anahtar ifadesine değerlendirmek için bir yöntem.  
...
### <a name="example"></a>Örnek  
 Bu örnekte <xref:System.Linq.Enumerable.ToList%2A> hemen dizisi içine değerlendirmek için bir yöntem bir <xref:System.Collections.Generic.List%601>, burada `T` türü <xref:System.Data.DataRow>.  
