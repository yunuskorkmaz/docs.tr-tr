...
Bu konudaki örneklerde <xref:System.Linq.Enumerable.Average%2A> , <xref:System.Linq.Enumerable.Count%2A> <xref:System.Linq.Enumerable.Max%2A> <xref:System.Linq.Enumerable.Min%2A> <xref:System.Linq.Enumerable.Sum%2A> <xref:System.Data.DataSet> sorgu ifadesi söz dizimini kullanarak bir ve verileri sorgulamak için,,, ve yöntemlerinin nasıl kullanılacağı gösterilmektedir.  
...
### <a name="example"></a>Örnek  
 ...
 Bu örnek <xref:System.Linq.Enumerable.Average%2A> , her bir kışı kimliği için Ortalama toplamı almak için kullanır.  
...
### <a name="example"></a>Örnek  
 ...
 Bu örnek, <xref:System.Linq.Enumerable.Average%2A> her bir kişi için Ortalama olan siparişleri almak için kullanır `TotalDue` .  
...
### <a name="example"></a>Örnek  
 ...
 Bu örnek, <xref:System.Linq.Enumerable.Max%2A> her bir kışı kimliği için en fazla toplamı almak için yöntemini kullanır.  
...
### <a name="example"></a>Örnek  
 ...
 Bu örnek, <xref:System.Linq.Enumerable.Max%2A> `TotalDue` her BIR kişi kimliği için en büyük olan siparişleri almak için yöntemini kullanır.  
...
### <a name="example"></a>Örnek  
 ...
 Bu örnek, <xref:System.Linq.Enumerable.Min%2A> her bir kışı kimliği için en küçük toplamı almak için yöntemini kullanır.  
