...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Açıklar [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] destekleyen veri sağlayıcısı [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] bir SQL Server veritabanı ile kullanım için.  
  
## <a name="related-sections"></a>İlgili Bölümler  
 [Entity Framework (SQL Server Compact)](http://go.microsoft.com/fwlink/?LinkId=135638)  
 Sağlayıcı sınırlamalar ve nasıl kullanılacağını açıklar [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] SQL Server Compact veritabanına sahip.  
  
 [Entity Framework için üçüncü taraf sağlayıcılar](http://go.microsoft.com/fwlink/?LinkId=143699)  
