...
|`USER_NAME(` `id` `)`|Belirtilen bir kimlik numarasından veritabanı kullanıcı adını döndürür.<br /><br /> **Bağımsız değişkenler**<br /><br /> `expression`: `Int32` Bir veritabanı kullanıcısı ile ilişkili bir kimlik numarası.<br /><br /> **Dönüş Değeri**<br /><br /> Unicode `String` .<br /><br /> **Örnek**<br /><br /> `SqlServer.USER_NAME(0)`|  
