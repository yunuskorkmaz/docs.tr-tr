...
Tanımlayıcılar, sorgu ifadesi [!INCLUDE[esql](../../../../../../includes/esql-md.md)] diğer adlarını, değişken başvurularını, nesnelerin özelliklerini ve benzeri işlemleri temsil etmek için kullanılır. [!INCLUDE[esql](../../../../../../includes/esql-md.md)]iki tür tanımlayıcı sağlar: basit tanımlayıcılar ve alıntılanmış tanımlayıcılar.  
  
## <a name="simple-identifiers"></a>Basit tanımlayıcılar  
 İçindeki [!INCLUDE[esql](../../../../../../includes/esql-md.md)] basit bir tanımlayıcı, alfasayısal ve alt çizgi karakterlerinden oluşan bir dizidir. Tanımlayıcının ilk karakteri alfabetik bir karakter (a-z veya A-Z) olmalıdır.  
...
- Ek köşeli parantezler (yani, tanımlayıcıyı tanımlayan köşeli ayraç içinde köşeli ayraçlar).  
 ...
 Ayrıca, ayrılmış bir anahtar sözcük [!INCLUDE[esql](../../../../../../includes/esql-md.md)]olan bir tanımlayıcıyı belirtmek için tırnak işaretleri de kullanabilirsiniz. Örneğin, türün `Email` "from" adlı bir özelliği varsa, köşeli parantezler kullanarak aşağıdaki şekilde, öğesinden ayrılmış anahtar sözcükten ayırt edilebilir.  
...
## <a name="aliasing-rules"></a>Diğer ad kuralları  
 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] Aşağıdaki[!INCLUDE[esql](../../../../../../includes/esql-md.md)] yapılar dahil olmak üzere, her gerektiğinde sorgularda diğer adlar belirtilmesini öneririz:  
...
### <a name="valid-aliases"></a>Geçerli diğer adlar  
 İçindeki [!INCLUDE[esql](../../../../../../includes/esql-md.md)] geçerli diğer adlar herhangi bir basit tanımlayıcı veya tırnak içinde tanımlayıcıdır.  
  
### <a name="alias-generation"></a>Diğer ad oluşturma  
 Sorgu ifadesinde bir [!INCLUDE[esql](../../../../../../includes/esql-md.md)] diğer ad belirtilmemişse, [!INCLUDE[esql](../../../../../../includes/esql-md.md)] aşağıdaki basit kurallara göre bir diğer ad oluşturmaya çalışır:  
...
### <a name="aggregate-handling"></a>Toplu Işleme  
 [!INCLUDE[esql](../../../../../../includes/esql-md.md)]iki tür toplamaları destekler: koleksiyon tabanlı toplamalar ve grup tabanlı toplamalar. Koleksiyon tabanlı toplamalar içinde [!INCLUDE[esql](../../../../../../includes/esql-md.md)]tercih edilen yapıdır ve SQL uyumluluğu için grup tabanlı toplamalar desteklenir.  
