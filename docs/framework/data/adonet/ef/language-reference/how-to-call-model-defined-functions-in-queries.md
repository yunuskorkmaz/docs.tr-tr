...
## <a name="example"></a>Örnek  
 ...
 Bir eğitmen işe alındım olduğundan aşağıdaki kavramsal model işlevi yıl sayısını döndürür. Kavramsal bir modele işlevi ekleme hakkında daha fazla bilgi için bkz: [nasıl yapılır: Kavramsal modelde özel işlevleri tanımlamak](https://msdn.microsoft.com/library/0dad7b8b-58f6-4271-b238-f34810d68e5f).)  
