...
|`Contains(string, target)`|Döndürür `true` varsa `target` bulunan `string`.<br /><br /> **Bağımsız Değişkenler**<br /><br /> `string`: Aranacak dize.<br /><br /> `target`: İçin arama hedef dize.<br /><br /> **Dönüş değeri**<br /><br /> `true` varsa `target` bulunan `string`; Aksi takdirde `false`.<br /><br /> **Örnek**<br /><br /> `-- The following example returns true.`<br /><br /> `Contains('abc', 'bc')`|  
