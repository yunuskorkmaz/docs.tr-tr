...
|`GetTotalOffsetMinutes(datetimeoffset)`|Dakika sayısını döndüren `datetimeoffset` GMT uzaklığı. Bu, genellikle +780 arasında-780. (+ veya - 13 SA). **Not:** bu işlevi yalnızca SQL Server 2008'de desteklenir. <br /><br /> **Bağımsız Değişkenler**<br /><br /> A `DateTimeOffset`.<br /><br /> **Dönüş değeri**<br /><br /> Bir `Int32`.|  
