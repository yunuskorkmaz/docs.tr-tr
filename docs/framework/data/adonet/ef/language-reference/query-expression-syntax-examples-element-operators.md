...
---
# <a name="query-expression-syntax-examples-element-operators"></a>Sorgu ifade sözdizimi örnekleri: Öğesi işleçleri
...
### <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanır <xref:System.Linq.Enumerable.First%2A> ilk kişinin ilk adını döndürmek için yöntemdir "Brooke".  
