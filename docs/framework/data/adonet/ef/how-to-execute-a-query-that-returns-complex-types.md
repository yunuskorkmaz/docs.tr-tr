...
3.  Modelinde görüntülemek üzere .edmx dosyasına çift tıklayın [modeli tarayıcı penceresini](http://msdn.microsoft.com/en-us/94e836e8-a5ea-47ff-aa3e-599d8a02ebfd) Entity Designer. Entity Designer yüzeyine seçin `Email` ve `Phone` özelliklerini `Contact` varlık türü, sonra sağ tıklatın ve seçin **yeni karmaşık tür yeniden düzenlemeniz**.  
