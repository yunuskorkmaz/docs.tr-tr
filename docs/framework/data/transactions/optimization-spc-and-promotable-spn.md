...
5.  Dönüş değeri <xref:System.Transactions.ITransactionPromoter.Promote%2A> yöntemdir işlem için bir yayma belirteci içeren bayt dizisi. <xref:System.Transactions> yerel işlem dahil edebilirsiniz bir DTC hareket oluşturmak için bu propagaition belirteci kullanır.  
