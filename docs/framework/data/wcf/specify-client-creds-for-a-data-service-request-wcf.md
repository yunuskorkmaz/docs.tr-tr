...
## <a name="example"></a>Örnek  
 ...
 Aşağıdaki örnek, Windows Presentation Framework uygulamasının ana sayfası olan bir Extensible Application Markup Language (XAML) dosyası için arka plan kod sayfasından oluşur. Bu örnek, `LoginWindow` kullanıcıdan kimlik doğrulama kimlik bilgilerini toplamak için bir örnek görüntüler ve ardından veri hizmetine bir istek yaparken bu kimlik bilgilerini kullanır.  
