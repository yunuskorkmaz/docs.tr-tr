...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Windows Presentation Foundation öğelerine veri bağlama  
 ...
 Daha fazla bilgi için [nasıl yapılır: Verileri Windows Presentation Foundation öğelerine](bind-data-to-wpf-elements-wcf-data-services.md)bağlayın.  
...
## <a name="binding-paged-data"></a>Disk belleğine alınan verileri bağlama  
 ...
 İlgili nesneler benzer bir şekilde yüklenir. Daha fazla bilgi için [nasıl yapılır: Verileri Windows Presentation Foundation öğelerine](bind-data-to-wpf-elements-wcf-data-services.md)bağlayın.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]Bu Temsilcilerde uyguladığınız özel davranışlardan herhangi bir doğrulama gerçekleştirir.  
 ...
 Daha fazla bilgi için [nasıl yapılır: Veri bağlama davranışlarını](how-to-customize-data-binding-behaviors-wcf-data-services.md)özelleştirin.  
...
- [Nasıl yapılır: Istemci veri hizmeti sınıflarını el ile oluştur](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
