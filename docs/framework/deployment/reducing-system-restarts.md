...
description: .NET Framework 4,5 yüklemeleri sırasında sistem yeniden başlatmalarının azaltılmasını öğrenin. .NET Framework 4,5 yüklemesi sırasında bir .NET 4 uygulaması kullanılıyorsa yeniden başlatma gerekebilir.
ms.date: 03/30/2017
helpviewer_keywords:
