...
## <a name="manually-displaying-buffered-graphics"></a>Arabelleğe alınan grafikleri elle görüntüleme  
 ...
 Kullanma hakkında daha fazla bilgi için <xref:System.Drawing.BufferedGraphics> sınıfı [el ile arabelleğe alınan grafikleri oluşturma](../../../../docs/framework/winforms/advanced/how-to-manually-render-buffered-graphics.md). Grafik işleme hakkında daha fazla bilgi için bkz. [grafikler ve çizim Windows Forms](../../../../docs/framework/winforms/advanced/graphics-and-drawing-in-windows-forms.md)  
