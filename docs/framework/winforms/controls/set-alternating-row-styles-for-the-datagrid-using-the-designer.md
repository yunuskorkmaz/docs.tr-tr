...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Windows Forms DataGridView denetimi ile Tasarımcı kullanarak](../../../../docs/framework/winforms/controls/using-the-designer-with-the-windows-forms-datagridview-control.md)  
