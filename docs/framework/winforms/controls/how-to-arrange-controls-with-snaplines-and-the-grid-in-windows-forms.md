...
-   Seçin **Snaptogrıd** Düzen Windows Form Tasarımcısı modunda **seçenekleri** iletişim kutusu.  
     ...
     Daha fazla bilgi için bkz: [genel, Windows Form Tasarımcısı, Seçenekler iletişim kutusu](http://msdn.microsoft.com/en-us/8dd170af-72f0-4212-b04b-034ceee92834). Tüm denetimler şimdi kendilerini kılavuz noktalarında boyunca hizalar.  
