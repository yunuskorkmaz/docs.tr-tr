...
Sanal modda uygulamak için bir neden <xref:System.Windows.Forms.DataGridView> yalnızca gerekli verileri almak üzere denetimidir. Bu adlandırılır *tam zamanında veri yükleme*.  
 ...
 Bu konudaki tek bir liste olarak kodu kopyalamak için bkz: [nasıl yapılır: Windows tam zamanında veri yükleme ile sanal modu uygulama Forms DataGridView denetiminde](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md).  
...
- [Nasıl yapılır: Windows Forms DataGridView denetiminde tam zamanında veri yükleme ile sanal modu uygulama](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md)
