...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Bir onay kutusu, uygulamanızın eylemleri belirlemek için nasıl kullanılacağını açıklar.  
 ...
 Bir nesnenin özelliklerini gibi seçeneklerini ayarlamak için bir onay kutusu kullanmayı açıklar.  
