...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 [Nasıl yapılır: Lisans bileşenleri ve denetimleri](http://msdn.microsoft.com/library/8e66c1ed-a445-4b26-8185-990b6e2bbd57)  
 Denetimi veya bileşeni içinde lisans uygulamak açıklar.  
  
 Ayrıca bkz. [tasarım zamanında Windows Forms denetimleri geliştirme](http://msdn.microsoft.com/library/w29y3h59\(v=vs.110\)).
