...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl yapılır: Contextmenustrip'ni bir denetimle ilişkilendirme](how-to-associate-a-contextmenustrip-with-a-control.md)  
 ...
 [Nasıl yapılır: Yapılandırma ContextMenuStrip denetim kenar boşluklarını ve görüntü kenar boşluklarını](how-to-configure-contextmenustrip-check-margins-and-image-margins.md)  
 ...
 [Nasıl yapılır: ContextMenuStrip açma olayını işleme](how-to-handle-the-contextmenustrip-opening-event.md)  
