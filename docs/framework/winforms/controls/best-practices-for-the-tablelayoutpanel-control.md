...
### <a name="avoid-visual-inheritance"></a>Görsel devralmadan kaçının
 <xref:System.Windows.Forms.TableLayoutPanel> Denetimi desteklemez görsel devralma Windows Form Tasarımcısı'nda Visual Studio içinde. A <xref:System.Windows.Forms.TableLayoutPanel> "tasarım zamanında kilitli gibi" Denetim türetilmiş bir sınıf içinde görünür.
