...
## <a name="in-this-section"></a>Bu Bölümde  
 [Nasıl yapılır: Windows Forms denetimlerine iş parçacığı açısından güvenli çağrılar yapın](../../../../docs/framework/winforms/controls/how-to-make-thread-safe-calls-to-windows-forms-controls.md)  
 Windows Forms denetimlerine iş parçacığı güvenli aramalar yapma gösterir.  
  
 [Nasıl yapılır: dosya aramak için arka plan iş parçacığı kullanma](../../../../docs/framework/winforms/controls/how-to-use-a-background-thread-to-search-for-files.md)  
