...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Nasıl yapılır: DHTML koduyla istemci uygulaması kodu arasında iki yönlü iletişim](../../../../docs/framework/winforms/controls/implement-two-way-com-between-dhtml-and-client.md)  
