...
## <a name="in-this-section"></a>Bu Bölümde  
 [TrackBar Denetimine Genel Bakış](../../../../docs/framework/winforms/controls/trackbar-control-overview-windows-forms.md)  
 Genel kavramlarını tanıtır `TrackBar` sayısal bir ayar görsel olarak ayarlayarak aracılığıyla bilgi gitmek kullanıcılara denetim.  
