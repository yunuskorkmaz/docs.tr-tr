...
Aşağıdaki kod örneği, <xref:System.Windows.Forms.DataGridView> görüntü sütunlarının etkileşimli bir kullanıcı arabiriminde (UI) nasıl kullanılacağını gösterir. Örnek ayrıca <xref:System.Windows.Forms.DataGridViewImageColumn>görüntü boyutlandırma ve düzen olasılıklarını gösterir.  
