...
### <a name="to-make-a-column-read-only-by-using-the-designer"></a>Tasarımcı kullanarak bir sütun salt okunur yapmak için  
...
3.  İçinde **sütun özellikleri** kılavuzunu, ayarlamak <xref:System.Windows.Forms.DataGridViewColumn.ReadOnly%2A> özelliğine `true`.  
