...
## <a name="example"></a>Örnek  
 Aşağıdaki kod örneğinde nasıl birleştirileceğini gösterir <xref:System.Windows.Forms.ToolStrip> için denetimleri bir <xref:System.Windows.Forms.ToolStripPanel>.  
