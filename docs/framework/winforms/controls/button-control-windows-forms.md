...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Atama açıklar bir `Button` kabul et düğmesi olarak da bilinen varsayılan düğme olarak denetim.  
 ...
 Atama açıklar bir `Button` her kullanıcı ESC tuşuna bastığında tıklandığında iptal düğmesi olarak denetim.  
 ...
 Bir düğme seçme yöntemlerini listeler.  
