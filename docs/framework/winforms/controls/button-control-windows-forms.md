...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Bir Windows formunda bir düğme en temel kullanımını açıklar.  
 ...
 İçin nasıl açıklar bir `Button` kabul et düğmesi olarak da bilinen varsayılan düğme olarak denetimi.  
 ...
 İçin nasıl açıklar bir `Button` her kullanıcı ESC tuşuna bastığında tıklandığında iptal düğmesi olarak denetimi.  
...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 Ayrıca bkz: [iletişim kutularına kullanıcı girdisi](https://msdn.microsoft.com/library/63ad8645-6842-45e8-b215-73f778e29a55) ve [nasıl yapılır: iletişim kutularını kapatın ve kullanıcı girişi tut](https://msdn.microsoft.com/library/9e118fad-3bf4-4f70-a3de-a0cda2b0229d).
