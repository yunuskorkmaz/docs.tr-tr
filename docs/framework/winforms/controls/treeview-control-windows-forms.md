...
Ayrıca bkz: [nasıl yapılır: ekleme ve kaldırma ile Windows Forms TreeView denetimi kullanarak Tasarımcı düğümleri](add-and-remove-nodes-with-wf-treeview-control-using-the-designer.md), ve [nasıl yapılır: TreeNode kullanarak bir tasarımcı kısayol menüsü ekleme](how-to-attach-a-shortcut-menu-to-a-treenode-using-the-designer.md).  
