...
## <a name="key-properties"></a>Anahtar Özellikler  
 İsterseniz <xref:System.Windows.Forms.DateTimePicker> çekme veya tarihleri yerine zamanlarını düzenleme için bir denetim olarak görüntülenecek şekilde ayarlayabileceğiniz <xref:System.Windows.Forms.DateTimePicker.ShowUpDown%2A> özelliğini `true` ve <xref:System.Windows.Forms.DateTimePicker.Format%2A> özelliğini <xref:System.Windows.Forms.DateTimePickerFormat.Time>. Daha fazla bilgi için [nasıl yapılır: DateTimePicker denetimiyle zamanı görüntüleme](../../../../docs/framework/winforms/controls/how-to-display-time-with-the-datetimepicker-control.md).  
