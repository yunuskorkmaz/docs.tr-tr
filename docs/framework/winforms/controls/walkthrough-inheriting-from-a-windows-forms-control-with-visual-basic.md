...
4. **Çözüm Gezgini**, **tüm dosyaları göster** düğmesine tıklayın.

5. Tasarımcı tarafından oluşturulan kod dosyasını, **ValueButton. Designer. vb**öğesini göstermek Için **ValueButton. vb** düğümünü açın. Bu dosyayı **kod düzenleyicisinde**açın.

6. İfadesini bulun ve bu denetimin devraldığı <xref:System.Windows.Forms.UserControl> türü olarak <xref:System.Windows.Forms.Button>değiştirin. `Partial Public Class ValueButton` `Class` Bu, <xref:System.Windows.Forms.Button> devralınan denetiminizin tüm denetim işlevlerini devralmasını sağlar.
...
1. **Çözüm Gezgini**, **ValueButton. vb**öğesine sağ tıklayın ve ardından kısayol menüsünde **kodu görüntüle** ' ye tıklayın.

2. `Public Class ValueButton` İfadesini bulun. Bu deyimin hemen altına aşağıdaki kodu yazın:
...
2. Visual Basic projeler düğümünü seçin ve **Windows Forms uygulama**' ya tıklayın.

3. **Ad** kutusuna yazın `Test`.

4. **Çözüm Gezgini**, **tüm dosyaları göster** düğmesine tıklayın.

5. **Çözüm Gezgini**, test projeniz için **Başvurular** düğümüne sağ tıklayın ve ardından kısayol menüsünden **Başvuru Ekle** ' yi seçerek **Başvuru Ekle** iletişim kutusunu görüntüleyin.

6. **Projeler** sekmesine tıklayın.

7. Etiketli **Projeler**sekmesine tıklayın. Projeniz proje adı altında listelenir. `ValueButtonLib` Başvuruyu test projesine eklemek için projeye çift tıklayın.

8. **Çözüm Gezgini** ' de **Test** ' e sağ tıklayın ve **Oluştur**' u seçin.

### <a name="to-add-your-control-to-the-form"></a>Formunuza denetim eklemek için

1. **Çözüm Gezgini**, **Form1. vb** öğesine sağ tıklayıp kısayol menüsünden **tasarımcıyı görüntüle** ' yi seçin.
