...
|Senaryo|Uygulama|  
|--------------|--------------------|  
|Yatay kaydırma çubuğunu görüntülemeden, denetimin tamamının genişliğini kaplayan görece az sayıda sütunda benzer boyutta verileri görüntülemek için sütun dolgusu modunu kullanın.|<xref:System.Windows.Forms.DataGridView.AutoSizeColumnsMode%2A> özelliğini <xref:System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill>olarak ayarlayın.|  
|Sütun dolgusu modunu, değişen boyutlarda görüntüleme değerleriyle kullanın.|<xref:System.Windows.Forms.DataGridView.AutoSizeColumnsMode%2A> özelliğini <xref:System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill>olarak ayarlayın. Sütunları <xref:System.Windows.Forms.DataGridViewColumn.FillWeight%2A> özelliklerini ayarlayarak veya denetimi verilerle doldurduktan sonra Denetim <xref:System.Windows.Forms.DataGridView.AutoResizeColumns%2A> yöntemini çağırarak göreli sütun genişliklerini başlatın.|  
|Sütun dolgusu modunu, değişen önem derecesine sahip değerlerle birlikte kullanın.|<xref:System.Windows.Forms.DataGridView.AutoSizeColumnsMode%2A> özelliğini <xref:System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill>olarak ayarlayın. Bazı verileri her zaman görüntülemesi gereken sütunlar için büyük <xref:System.Windows.Forms.DataGridViewColumn.MinimumWidth%2A> değerleri ayarlayın veya belirli sütunlar için Fill modundan başka bir boyutlandırma seçeneği kullanın.|  
