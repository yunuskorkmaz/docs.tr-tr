...
## <a name="reference"></a>Başvuru  
 ...
 Özelliklerini açıklayan <xref:System.Windows.Forms.MenuStrip> menü sistemi için bir form sağlayan sınıf.  
  
 <xref:System.Windows.Forms.ContextMenuStrip>  
 Özelliklerini açıklayan <xref:System.Windows.Forms.ContextMenuStrip>, bir kısayol menüsü temsil eder.  
