...
-   Ayarlama <xref:System.Windows.Forms.ToolStripItem.Overflow%2A> özelliği <xref:System.Windows.Forms.ToolStripItem> istediğiniz değer. Olasılıklar `Always`, `Never`, ve `AsNeeded`. Defaultis `AsNeeded`.  
