...
> [!NOTE]
>  [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)]denetimleri sınıflar tarafından sağlanan temel [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)].  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 "FileDialog sınıfı"  
 Dosya iletişim kutuları için temel sınıf işlevselliğini sağlar.  
 ...
 "SoundPlayer sınıfı"  
 Ses uygulamalarınızda kolayca eklemenizi sağlar.  
 ...
 [Bölümlendirici denetimi](../../../../docs/framework/winforms/controls/splitter-control-windows-forms.md)  
