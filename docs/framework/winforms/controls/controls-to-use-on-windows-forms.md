...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [FileDialog sınıfı](filedialog-class.md) dosya iletişim kutuları için temel sınıf işlevlerini sağlar.
 ...
 [SoundPlayer sınıfı](soundplayer-class.md) sesleri uygulamalarınıza kolayca dahil etmenize imkan sağlar.
...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 Visual Basic 6.0 denetimlerinde karşılık gelen denetimin Visual Basic'te eşleyen bir tablo sağlar. Denetimleri artık .NET Framework sınıfları olduğunu unutmayın.  
