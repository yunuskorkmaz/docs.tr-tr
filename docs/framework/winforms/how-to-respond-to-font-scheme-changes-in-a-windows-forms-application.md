...
1. Formunuza oluşturun ve istediğiniz denetimi ekleyin. Daha fazla bilgi için [nasıl yapılır: Komut satırından bir Windows Forms uygulaması oluşturma](how-to-create-a-windows-forms-application-from-the-command-line.md) ve [Windows Forms'da kullanılacak denetimler](./controls/controls-to-use-on-windows-forms.md).  
