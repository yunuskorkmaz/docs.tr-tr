...
## <a name="related-sections"></a>İlgili Bölümler  
 ...
 [Nasıl yapılır: Güvenilen bir yayımcı ClickOnce uygulamaları için bir istemci bilgisayara ekleyin](/visualstudio/deployment/how-to-add-a-trusted-publisher-to-a-client-computer-for-clickonce-applications)  
 ...
 [İzlenecek yol: ClickOnce dağıtım API'si ile isteğe bağlı derlemeleri indirme](/visualstudio/deployment/walkthrough-downloading-assemblies-on-demand-with-the-clickonce-deployment-api)  
...
- [Komut Satırından ClickOnce Uygulamalarını Yapılandırma](/visualstudio/deployment/building-clickonce-applications-from-the-command-line)
