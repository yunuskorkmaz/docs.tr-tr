...
|Geç (T) (Func (T))|(<xref:System.Threading.LazyThreadSafetyMode.ExecutionAndPublication>)|Yes|Yes|  
...
|Geç (T) (Func (T), Boolean)|`True`( <xref:System.Threading.LazyThreadSafetyMode.ExecutionAndPublication> ) veya `false` (<xref:System.Threading.LazyThreadSafetyMode.None>)|Yes|Yes|  
|Geç (T) (LazyThreadSafetyMode)|Kullanıcı tarafından belirtilen|Hayır|Hayır|  
|Geç (T) (Func (T), LazyThreadSafetyMode)|Kullanıcı tarafından belirtilen|Yes|Kullanıcı belirttiğinde Hayır <xref:System.Threading.LazyThreadSafetyMode.PublicationOnly> ; Aksi takdirde, evet.|  
