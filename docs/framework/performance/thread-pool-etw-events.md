...
|Nedeni|Win: UInt32|Ayarlamanın nedeni.<br /><br /> 0x00-Warmup.<br /><br /> 0x01 başlatılıyor.<br /><br /> 0x02-rastgele taşı.<br /><br /> 0x03-taşıma hareketi.<br /><br /> 0x04-nokta değiştirme.<br /><br /> 0x05-sabitleniyor.<br /><br /> 0x06-başlangıça.<br /><br /> 0x07-Iş parçacığı zaman aşımına uğradı.|  
|ClrInstanceID|Win: UInt16|CLR veya CoreCLR örneği için benzersiz KIMLIK.|  
...
|Alan adı|Veri türü|Açıklama|  
|----------------|---------------|-----------------|  
|Süre|Win: Double|Bu istatistiklerin toplandığı sürenin saniye cinsinden miktarı.|  
...
|Güvenilirlik|Win: Double|ThroughputRatio alanının geçerlilik süresinin ölçüsü.|  
