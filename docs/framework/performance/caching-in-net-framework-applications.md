...
- Sınıfından türeten bir sınıf oluşturun <xref:System.Web.Caching.OutputCacheProvider> ve uygulamayı özel çıkış önbelleği sağlayıcısını kullanacak şekilde yapılandırın.
 ...
 Daha fazla bilgi için Scott Guthrie 'nin blogundan [ASP.NET 4 (VS 2010 ve .NET Framework 4,0 serisi) Ile Genişletilebilir çıktı önbelleği](https://weblogs.asp.net/scottgu/extensible-output-caching-with-asp-net-4-vs-2010-and-net-4-0-series) girişine bakın.
