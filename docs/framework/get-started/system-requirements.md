...
* .NET framework 4.7 ve kendi noktası (4.7.1 ve 4.7.2) serbest bırakır.
...
| ---------------- | ------------------ | ------------------------ | ---------------------- |
| Windows 10 Nisan 2018 güncelleştirme | 32 bit ve 64 bit | .NET framework 4.7.2 |--|
| Windows 10 sonbaharda oluşturucuları güncelleştir | 32 bit ve 64 bit | .NET framework 4.7.1 | .NET framework 4.7.2 |
| Windows 10 oluşturucuları güncelleştir | 32 bit ve 64 bit | .NET framework 4.7 | .NET framework 4.7.1<br/><br/>.NET framework 4.7.2 | 
