...
ms.locfileid: "75752555"
---
# <a name="net-core-and-open-source"></a>.NET Core ve açık kaynak

Bu makalede .NET Core 'un ne olduğuna ilişkin kısa bir genel bakış sağlanır ve nasıl daha fazla bilgi bulabileceğiniz gösterilmektedir. .NET Core belgelerinin tüm listesini bulmak için [.NET Core Kılavuzu](../../core/index.md)' nu ziyaret edin.
