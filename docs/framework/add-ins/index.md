...
<a name="top"></a><span data-ttu-id="e78fd-103">Eklentiler genişletilmiş özellikler veya bir ana bilgisayar uygulaması için hizmetleri sağlar.</span><span class="sxs-lookup"><span data-stu-id="e78fd-103">Add-ins provide extended features or services for a host application.</span></span> <span data-ttu-id="e78fd-104">[!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] Geliştiriciler eklentiler geliştirmek ve bunları kendi ana bilgisayar uygulamasında etkinleştirmek için kullanabileceğiniz bir programlama modelidir.</span><span class="sxs-lookup"><span data-stu-id="e78fd-104">The [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] provides a programming model that developers can use to develop add-ins and activate them in their host application.</span></span> <span data-ttu-id="e78fd-105">Model bu konak ve eklenti arasındaki iletişim ardışık düzeni oluşturarak elde eder.</span><span class="sxs-lookup"><span data-stu-id="e78fd-105">The model achieves this by constructing a communication pipeline between the host and the add-in.</span></span> <span data-ttu-id="e78fd-106">Model türler kullanılarak uygulanır <xref:System.AddIn>, <xref:System.AddIn.Hosting>, <xref:System.AddIn.Pipeline>, ve <xref:System.AddIn.Contract> ad alanları.</span><span class="sxs-lookup"><span data-stu-id="e78fd-106">The model is implemented by using the types in the <xref:System.AddIn>, <xref:System.AddIn.Hosting>, <xref:System.AddIn.Pipeline>, and <xref:System.AddIn.Contract> namespaces.</span></span>  
