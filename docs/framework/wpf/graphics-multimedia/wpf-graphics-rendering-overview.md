...
DrawingGroup işlemlerin sırası  
 ...
 Daha fazla bilgi için [çizim nesnelerine genel bakış](../../../../docs/framework/wpf/graphics-multimedia/drawing-objects-overview.md).  
...
## <a name="how-visual-objects-are-used-to-build-controls"></a>Görsel nesneler denetimleri oluşturmak için nasıl kullanılır  
 ...
 ![Görsel ağacı hiyerarşi diyagramı](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview03.gif "VisualLayerOverview03")  
...
### <a name="control-templates"></a>Denetim şablonları  
 ...
 ![Görsel ağacı ve verileri işleme diyagramı](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview04.png "VisualLayerOverview04")  
...
## <a name="visual-tree"></a>Görsel ağaç  
 ...
 ![Görsel ağacı hiyerarşi diyagramı](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview05.gif "VisualLayerOverview05")  
Görsel ağacı hiyerarşi diyagramı  
...
### <a name="relationship-to-the-logical-tree"></a>Mantıksal ağacı ilişki  
 ...
 ![Ağaç görünümünü](../../../../docs/framework/wpf/graphics-multimedia/media/tree1-wcp.gif "Tree1_wcp")  
...
### <a name="viewing-the-visual-tree-with-xamlpad"></a>Görsel ağacı XamlPad ile görüntüleme  
 ...
 ![Görsel ağacı Gezgini panelinde XamlPad](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview08.png "VisualLayerOverview08")  
...
### <a name="profiling-visual-performance"></a>Görsel performans profili oluşturma  
 ...
 ![Görsel Profiler görüntüleme çıkış](../../../../docs/framework/wpf/graphics-multimedia/media/wpfperf-visualprofiler-04.png "WPFPerf_VisualProfiler_04")  
...
### <a name="retained-mode-graphics"></a>Tutulan modu grafikleri  
 ...
 ![Win32 işleme sıralı diyagramı](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview01.png "VisualLayerOverview01")  
Win32 işleme sıralı diyagramı  
 ...
 ![WPF işleme sıralı diyagramı](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview02.png "VisualLayerOverview02")  
...
### <a name="vector-graphics"></a>Vektör grafikleri  
 ...
 ![Izgara ve vektör grafik arasındaki farklar](../../../../docs/framework/wpf/graphics-multimedia/media/vectorgraphics01.png "VectorGraphics01")  
...
### <a name="enumerating-the-visual-tree"></a>Görsel ağacı numaralandırma  
 ...
 Çoğu durumda, mantıksal ağacı öğeleri daha kullanışlı bir temsilini olduğu bir [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] uygulama. Mantıksal ağacı doğrudan değiştirmeyin ancak bu görünüm uygulamanın özellik devralma ve olay yönlendirmeyi anlamak için kullanışlıdır. Görsel ağacı mantıksal ağaç görsel olmayan veri nesneleri gibi temsil edebilen <xref:System.Windows.Documents.ListItem>. Mantıksal ağacı hakkında daha fazla bilgi için bkz. [WPF içinde ağaçlar](../../../../docs/framework/wpf/advanced/trees-in-wpf.md).  
