...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanır <xref:System.Windows.Controls.MediaElement> ve <xref:System.Windows.Media.MediaTimeline> içinde bir <xref:System.Windows.Media.Animation.Storyboard> medya klibi sonsuz bir döngüde yürütmek için.  
