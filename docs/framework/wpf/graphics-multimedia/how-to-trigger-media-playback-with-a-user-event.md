...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanır <xref:System.Windows.Controls.MediaElement> denetim ve <xref:System.Windows.Media.MediaTimeline> kullanıcı tıklattığında oluşan bir ses çalınmaya sınıfı bir <xref:System.Windows.Controls.Button>.  
