...
Bu örnek boyutunu ve konumunu dikdörtgenin değişiklikleri animasyon gösterilmektedir.  
  
## <a name="example"></a>Örnek  
 Aşağıdaki örnekte bir örneğini kullanan <xref:System.Windows.Media.Animation.RectAnimation> animasyon sınıfı <xref:System.Windows.Media.RectangleGeometry.Rect%2A> özelliği bir <xref:System.Windows.Media.RectangleGeometry>, boyutunu ve konumunu dikdörtgenin değişiklikler canlandırır.  
