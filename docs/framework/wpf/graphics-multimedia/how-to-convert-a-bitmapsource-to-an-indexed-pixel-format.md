---
title: "Nasıl yapılır: BitmapSource'u Dizinli Piksel Biçimine Dönüştürme"
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "61910019"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="5c188-102">Nasıl yapılır: BitmapSource'u Dizinli Piksel Biçimine Dönüştürme</span><span class="sxs-lookup"><span data-stu-id="5c188-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="5c188-103">Bu örnek nasıl dönüştürüleceğini gösterir bir <xref:System.Windows.Media.Imaging.BitmapSource> dizinli piksel biçimine.</span><span class="sxs-lookup"><span data-stu-id="5c188-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="5c188-104">Örnek</span><span class="sxs-lookup"><span data-stu-id="5c188-104">Example</span></span>  
