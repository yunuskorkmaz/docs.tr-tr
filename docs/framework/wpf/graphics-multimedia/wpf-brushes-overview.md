...
## <a name="painting-with-a-brush"></a>Fırça ile Boyama  
 ...
 ![Fırça türü](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brushtypes.jpg "graphicsmm_brushtypes")  
Fırça örnekleri  
...
## <a name="paint-with-a-solid-color"></a>Düz renk ile Boyama  
 ...
 ![Bir dikdörtgen boyanan SolidColorBrush kullanarak](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-solidcolorbrush.png "graphicsmm_brush_ovw_solidcolorbrush")  
SolidColorBrush'ı kullanarak bir dikdörtgen boyanır  
 ...
 Hakkında daha fazla bilgi için <xref:System.Windows.Media.SolidColorBrush> sınıfı [düz renkler ve gradyanlar genel bakış boyama](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
...
## <a name="paint-with-a-linear-gradient"></a>Doğrusal gradyan ile Boyama  
 ...
 ![Bir dikdörtgen boyanan LinearGradientBrush kullanılarak](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-lineargradientbrush.jpg "graphicsmm_brush_ovw_lineargradientbrush")  
Bir dikdörtgen LinearGradientBrush kullanılarak boyanır  
 ...
 Hakkında daha fazla bilgi için <xref:System.Windows.Media.LinearGradientBrush> sınıfı [düz renkler ve gradyanlar genel bakış boyama](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
...
## <a name="paint-with-a-radial-gradient"></a>Radyal gradyan ile Boyama  
 ...
 ![Bir dikdörtgen boyanan RadialGradientBrush kullanılarak](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-radialgradientbrush.jpg "graphicsmm_brush_ovw_radialgradientbrush")  
Bir dikdörtgen RadialGradientBrush kullanılarak boyanır  
 ...
 Hakkında daha fazla bilgi için <xref:System.Windows.Media.RadialGradientBrush> sınıfı [düz renkler ve gradyanlar genel bakış boyama](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
...
## <a name="paint-with-an-image"></a>Görüntü ile Boyama  
 ...
 ![Bir dikdörtgen boyanan ImageBrush tarafından](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-imagebrush.jpg "graphicsmm_brush_ovw_imagebrush")  
...
## <a name="paint-with-a-drawing"></a>Çizim ile Boyama  
 ...
 ![Bir dikdörtgen boyanan DrawingBrush'ı kullanarak](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-drawingbrush.jpg "graphicsmm_brush_ovw_drawingbrush")  
DrawingBrush'ı kullanarak bir dikdörtgen boyanır  
 ...
 Hakkında daha fazla bilgi için <xref:System.Windows.Media.DrawingBrush> sınıfı [görüntüler, çizimler ve görsellerle boyama](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md).  
...
## <a name="paint-with-a-visual"></a>Görsel ile Boyama  
 ...
 ![Bir dikdörtgen boyanan VisualBrush kullanılarak](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brush-ovw-visualbrush.jpg "graphicsmm_brush_ovw_visualbrush")  
VisualBrush'ı kullanarak bir dikdörtgen boyanır  
 ...
 Hakkında daha fazla bilgi için <xref:System.Windows.Media.VisualBrush> sınıfı [görüntüler, çizimler ve görsellerle boyama](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md).  
...
-   Kullanılabilir önceden tanımlanmış Fırçalar listesi için bkz. <xref:System.Windows.Media.Brushes> sınıfı. Önceden tanımlanmış bir fırçanın nasıl kullanılacağını gösteren bir örnek için bkz: [düz renk ile bir alanı boyama](../../../../docs/framework/wpf/graphics-multimedia/how-to-paint-an-area-with-a-solid-color.md).  
  
-   Kullanılabilir sistem fırçaları listesi için bkz. <xref:System.Windows.SystemColors> sınıfı. Bir örnek için bkz. [sistem fırçası ile bir alanı boyama](../../../../docs/framework/wpf/graphics-multimedia/how-to-paint-an-area-with-a-system-brush.md).  
...
>  Bir öğenin tamamını kullanmanın değiştirmek çok daha fırça opaklığını değerini değiştirmek için daha verimlidir, <xref:System.Windows.UIElement.Opacity%2A?displayProperty=nameWithType> özelliği.  
 ...
 Döndürme, ölçeklendirme, eğme ve kullanarak bir fırçanın içeriği Çevir kendi <xref:System.Windows.Media.Brush.Transform%2A> veya <xref:System.Windows.Media.Brush.RelativeTransform%2A> özellikleri. Daha fazla bilgi için [fırça dönüşümüne genel bakış](../../../../docs/framework/wpf/graphics-multimedia/brush-transformation-overview.md).  
  
 Çünkü bunlar <xref:System.Windows.Media.Animation.Animatable> nesneleri <xref:System.Windows.Media.Brush> nesneleri ettirilebilir. Daha fazla bilgi için [animasyona genel bakış](../../../../docs/framework/wpf/graphics-multimedia/animation-overview.md).  
...
### <a name="freezable-features"></a>Freezable Özellikleri  
 ...
 Tarafından sağlanan farklı özellikleri hakkında daha fazla bilgi için <xref:System.Windows.Freezable> nesneleri bkz [Freezable nesnelerine genel bakış](../../../../docs/framework/wpf/advanced/freezable-objects-overview.md).  
