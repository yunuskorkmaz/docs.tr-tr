...
Bu örnek bir ana bilgisayara bir Windows Presentation Foundation (WPF) döndürür bir eklenti oluşturmak nasıl gösterir [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] tek başına uygulama.  
