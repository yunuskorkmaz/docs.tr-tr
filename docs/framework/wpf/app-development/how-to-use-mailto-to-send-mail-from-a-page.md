...
---
# <a name="how-to-use-mailto-to-send-mail-from-a-page"></a>Nasıl yapılır: mailto kullanın: bir sayfanın posta göndermek için
...
## <a name="example"></a>Örnek  
 Aşağıdaki kodu nasıl kullanılacağını gösteren bir **mailto:** [!INCLUDE[TLA#tla_uri](../../../../includes/tlasharptla-uri-md.md)] bir e-posta adresini içeren yeni bir posta penceresi açın ve e-posta adresi ve bir konu ve bir e-posta adresini konu ve gövde.  
