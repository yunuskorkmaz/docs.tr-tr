...
## <a name="choosing-a-datatemplate-based-on-properties-of-the-data-object"></a>Veri nesnesinin özelliklerine dayalı bir DataTemplate seçme  
 ...
 Bu örnekte <xref:System.Windows.DataTemplate>kullanılmıştır.<xref:System.Windows.FrameworkTemplate.Resources%2A> özelliði. Bu bölümde tanımlanan kaynaklar <xref:System.Windows.DataTemplate>içindeki öğeler tarafından paylaşılır.  
