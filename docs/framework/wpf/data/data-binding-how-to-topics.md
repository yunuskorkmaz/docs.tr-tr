...
---
# <a name="data-binding-how-to-topics"></a>Veri bağlama ile ilgili nasıl yapılır konuları

Bu bölümdeki konularda, verileri ortak dil çalışma zamanı (CLR) nesneleri ve XML biçiminde çeşitli veri kaynaklarından verilere bağlamak için veri bağlamanın nasıl kullanılacağı açıklanır.
...
- [WPF 'de veri bağlama](data-binding-wpf.md)
