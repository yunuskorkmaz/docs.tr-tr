...
|[İzlenecek yol: Dinamik düzen oluşturma](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb514519(v=vs.100))|Panel denetimi kullanarak dinamik düzen oluşturmayı gösterir <xref:System.Windows.Controls.Grid> .|
...
|Başlık|Açıklama|
|-----------|-----------------|
|[İzlenecek yol: WPF içinde Windows Forms Denetimi Barındırma](../advanced/walkthrough-hosting-a-windows-forms-control-in-wpf.md)|WPF uygulamasında bir Windows Forms denetiminin nasıl barındırılacağını gösterir <xref:System.Windows.Forms.MaskedTextBox?displayProperty=nameWithType> .|
|[İzlenecek yol: WPF'de Windows Forms Bileşik Denetimini Barındırma](../advanced/walkthrough-hosting-a-windows-forms-composite-control-in-wpf.md)|Bir uygulamada Windows Forms veri girişi bileşik denetiminin nasıl barındırılacağını gösterir [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] .|
