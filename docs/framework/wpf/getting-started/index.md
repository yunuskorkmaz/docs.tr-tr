...
|||  
|-|-|  
|Hemen hızlı bir şekilde geçmek istiyorum...|[İzlenecek Yol: İlk WPF masaüstü uygulamam](walkthrough-my-first-wpf-desktop-application.md)|  
|Uygulama kullanıcı arabirimini tasarlamak Nasıl yaparım? mı?|[Visual Studio'da XAML Tasarlama](/visualstudio/designers/designing-xaml-in-visual-studio)|  
|.NET ile yeni misiniz?|[.NET Framework genel bakış](../../get-started/overview.md)<br /><br /> [.NET Framework Application Essentials](../../../standard/application-essentials.md)<br /><br /> [Visual C# ve Visual Basic'e Başlarken](/visualstudio/ide/quickstart-visual-basic-console)|  
|WPF hakkında daha fazla bilgi ver...|[Visual Studio’da WPF’ye Giriş](introduction-to-wpf-in-vs.md)<br /><br /> [XAML'ye Genel Bakış (WPF)](../advanced/xaml-overview-wpf.md)<br /><br /> [Denetimler](../controls/index.md)<br /><br /> [Veri Bağlamaya Genel Bakış](../../../desktop-wpf/data/data-binding-overview.md)|  
