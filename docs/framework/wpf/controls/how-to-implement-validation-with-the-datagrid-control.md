...
-   Bir veya daha fazla doğrulama kurallarını içeren bir sütun kullanılan bağlama belirtin. Bu bölümünde anlatıldığı gibi basit denetimler, veri doğrulamaya benzer [Data Binding Overview](../../../../docs/framework/wpf/data/data-binding-overview.md).  
