...
|Basılan|Ortak durumlar|<xref:System.Windows.Controls.Primitives.CalendarDayButton> basıldığında.|  
|Seçildi|SelectionStates|Düğme seçilidir.|  
...
|Basılan|Ortak durumlar|<xref:System.Windows.Controls.Primitives.CalendarButton> basıldığında.|  
|Seçildi|SelectionStates|Düğme seçilidir.|  
|Değilken|SelectionStates|Düğme seçili değil.|  
|Calendarbuttonodaklanmış|CalendarButtonFocusStates|Düğme odağa sahiptir.|  
|Calendarbuttonunodaklanmış|CalendarButtonFocusStates|Düğme odağa sahip değil.|  
