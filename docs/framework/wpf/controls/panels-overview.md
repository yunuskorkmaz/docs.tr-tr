...
#### <a name="defining-and-using-a-canvas"></a>Tanımlama ve tuval kullanma  
 ...
 ![Tipik bir tuvale öğe. ](./media/panel-intro-canvas.PNG "panel_intro_canvas")  
...
#### <a name="defining-and-using-a-grid"></a>Tanımlama ve kılavuz kullanma  
 ...
 ![Tipik bir kılavuz öğesi. ](./media/avalon-run-dialog.PNG "avalon_run_dialog")  
...
#### <a name="stackpanel-vs-dockpanel"></a>StackPanel vs. DockPanel  
 ...
 ![Ekran: StackPanel vs. DockPanel ekran](./media/layout-smiley-stackpanel.PNG "layout_smiley_stackpanel")  
...
## <a name="nested-panel-elements"></a>İç içe geçmiş Panel öğeleri  
 ...
 ![İç içe geçmiş paneller yararlanır bir kullanıcı Arabirimi. ](./media/nested-panels.PNG "nested_panels")  
