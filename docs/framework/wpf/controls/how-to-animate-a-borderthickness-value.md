...
Bu örnek kullanarak kalınlığını değişiklikleri animasyon gösterilmektedir <xref:System.Windows.Media.Animation.ThicknessAnimation> sınıfı.  
  
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanarak kalınlığını canlandırır <xref:System.Windows.Media.Animation.ThicknessAnimation>. Örnek kullanır <xref:System.Windows.Controls.Border.BorderThickness%2A> özelliği <xref:System.Windows.Controls.Border>.  
