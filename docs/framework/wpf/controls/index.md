...
### <a name="creating-a-style-for-a-control"></a>Bir denetim için stil oluşturma  
 ...
 Ayrıca bir stil belirli bir türdeki belirli denetimler stili için bir anahtar atama ve bu anahtar belirterek uygulayabilirsiniz `Style` denetiminizin özelliği.  Stilleri hakkında daha fazla bilgi için bkz. [stil ve şablon oluşturma](../../../../docs/framework/wpf/controls/styling-and-templating.md).  
