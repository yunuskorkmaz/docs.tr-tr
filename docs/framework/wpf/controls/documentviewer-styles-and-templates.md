...
## <a name="documentviewer-states"></a>DocumentViewer durumları  
 Aşağıdaki tabloda <xref:System.Windows.Controls.DocumentViewer> denetimi için görsel durumlar listelenmektedir.  
...
## <a name="documentviewer-controltemplate-example"></a>DocumentViewer ControlTemplate örneği  
 Aşağıdaki örnek, <xref:System.Windows.Controls.DocumentViewer> denetimi için <xref:System.Windows.Controls.ControlTemplate> tanımlanacağını gösterir.  
