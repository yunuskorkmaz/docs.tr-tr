...
## <a name="optimize-authenticode"></a>Authenticode en iyi duruma getirme  
 ...
 .NET Framework 3. 5 ' başlayarak, Authenticode doğrulama atlanmasına izin veren bir yapılandırma seçeneği yoktur. Bunu yapmak için aşağıdaki ayarı app.exe.config dosyasına ekleyin:  
