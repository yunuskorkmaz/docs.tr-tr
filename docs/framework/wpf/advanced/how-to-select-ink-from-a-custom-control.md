...
Ekleyerek bir <xref:System.Windows.Ink.IncrementalLassoHitTester> özel denetiminizi kullanıcı benzer şekilde, Serbest Şekil aracı ile mürekkep seçebilmeniz için Denetim etkinleştirebilirsiniz <xref:System.Windows.Controls.InkCanvas> mürekkebi seçer.  
 ...
 Bu örnekte, mürekkep özellikli bir özel denetim oluşturma konusunda bilgi sahibi olduğunuz varsayılır.  Mürekkep giriş kabul eden özel bir denetim oluşturmak için bkz: [mürekkep giriş denetimi oluşturma](../../../../docs/framework/wpf/advanced/creating-an-ink-input-control.md).  
