...
-   Gelişmiş özellikleri ile Eklenti serileştiricileri desteği:  
    ...
    -   Tüm tarafından kullanım için sistem genelinde erişim [!INCLUDE[TLA2#tla_winfx](../../../../includes/tla2sharptla-winfx-md.md)] uygulamalar.  
