...
## <a name="xaml-namespaces"></a>XAML Ad Uzayları  
 ...
 XAML ad alanları hakkında daha fazla bilgi için bkz. [XAML ad alanları ve WPF XAML Namespace eşleme](xaml-namespaces-and-namespace-mapping-for-wpf-xaml.md).  
