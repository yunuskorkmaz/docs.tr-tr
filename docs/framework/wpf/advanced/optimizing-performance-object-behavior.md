...
## <a name="freezable-objects"></a>Freezable nesneleri  
 A <xref:System.Windows.Freezable> iki durumlu nesnesi özel bir türdür: çözülmüş ve donmuş. Mümkün olduğunda nesneleri dondurma uygulamanızın performansını artırır ve çalışma kümesi azaltır. Daha fazla bilgi için [Freezable nesnelerine genel bakış](../../../../docs/framework/wpf/advanced/freezable-objects-overview.md).  
