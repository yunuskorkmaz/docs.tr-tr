...
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="14601-102">Nasıl yapılır: Sürükle ve Bırak Mürekkebi</span><span class="sxs-lookup"><span data-stu-id="14601-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="14601-103">Örnek</span><span class="sxs-lookup"><span data-stu-id="14601-103">Example</span></span>  
 <span data-ttu-id="14601-104">Aşağıdaki örnek, kullanıcının seçili vuruşları birinden sürükleyin olanak tanıyan bir uygulama oluşturur <xref:System.Windows.Controls.InkCanvas> diğer.</span><span class="sxs-lookup"><span data-stu-id="14601-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
