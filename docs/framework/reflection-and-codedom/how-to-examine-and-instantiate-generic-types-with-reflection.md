...
1. Genel türü temsil <xref:System.Type> eden bir örneğini alır. Aşağıdaki kodda, türü C# `typeof` işleci kullanılarak elde edilir (`GetType` Visual Basic `typeid` Visual C++). Nesne almanın <xref:System.Type> diğer yolları için bkz. sınıf konusu. <xref:System.Type> Bu yordamın geri kalanında, türünün adlı `t`bir yöntem parametresinde yer aldığı unutulmamalıdır.  
  
     [!code-cpp[HowToGeneric#2](../../../samples/snippets/cpp/VS_Snippets_CLR/HowToGeneric/cpp/ur.cpp#2)]
     [!code-csharp[HowToGeneric#2](../../../samples/snippets/csharp/VS_Snippets_CLR/HowToGeneric/CS/ur.cs#2)]
     [!code-vb[HowToGeneric#2](../../../samples/snippets/visualbasic/VS_Snippets_CLR/HowToGeneric/VB/ur.vb#2)]  
  
2. Türün genel <xref:System.Type.IsGenericType%2A> olup olmadığını anlamak için özelliğini kullanın ve türün genel tür tanımı olup <xref:System.Type.IsGenericTypeDefinition%2A> olmadığını anlamak için özelliğini kullanın.  
...
7. Bir tür <xref:System.Type.GenericParameterAttributes%2A> parametresindeki özel kısıtlamaları (örneğin, bir başvuru türü olması gerekir) bulmaya yönelik özelliğini kullanın. Özelliği, aşağıdaki kodda gösterildiği gibi, bir varyansı temsil eden değerleri de içerir.  
...
3. Tür bağımsız <xref:System.Type.MakeGenericType%2A> değişkenlerini tür parametrelerine bağlamak ve türü oluşturmak için yöntemini çağırın.  
  
     [!code-cpp[HowToGeneric#12](../../../samples/snippets/cpp/VS_Snippets_CLR/HowToGeneric/cpp/ur.cpp#12)]
     [!code-csharp[HowToGeneric#12](../../../samples/snippets/csharp/VS_Snippets_CLR/HowToGeneric/CS/ur.cs#12)]
     [!code-vb[HowToGeneric#12](../../../samples/snippets/visualbasic/VS_Snippets_CLR/HowToGeneric/VB/ur.vb#12)]  
  
4. Oluşturulmuş türden <xref:System.Activator.CreateInstance%28System.Type%29> bir nesne oluşturmak için yöntem aşırı yüklemesini kullanın. Aşağıdaki kod, elde edilen `Example` `Dictionary<String, Example>` nesnede sınıfının iki örneğini depolar.  
...
## <a name="example"></a>Örnek  
 ...
 Örnek, türünde bağımsız değişkenlerin bir dizisini <xref:System.Collections.Generic.Dictionary%602> oluşturarak ve <xref:System.Type.MakeGenericType%2A> yöntemini çağırarak sınıfından bir tür oluşturur. <xref:System.Type> Program, kullanılarak <xref:System.Type.MakeGenericType%2A> oluşturulan nesneyi <xref:System.Type> ( `typeof` `GetType` Visual Basic) kullanarak, aynı olduğunu gösteren ile karşılaştırır. Benzer şekilde, program, oluşturulan <xref:System.Type.GetGenericTypeDefinition%2A> türün genel tür tanımını elde etmek için yöntemini kullanır ve <xref:System.Type> <xref:System.Collections.Generic.Dictionary%602> sınıfı temsil eden nesneyle karşılaştırır.  
