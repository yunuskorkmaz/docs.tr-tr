...
---
# <a name="attributeimplies-element-net-native"></a>\<Attribute> öğesi (.NET Native)
...
## <a name="remarks"></a>Açıklamalar  
 Öğesi, kapsayan türü bir öznitelik (diğer bir deyişle, öğesinden <xref:System.Attribute?displayProperty=nameWithType>türetilmiş bir sınıf) ise kullanılır. `<AttributeImplies>` Özniteliği belirli bir program öğesine uygulanırsa, `<AttributeImplies>` öğesi tarafından tanımlanan ilke bu program öğesine uygulanır.  
