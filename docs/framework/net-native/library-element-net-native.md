...
## <a name="remarks"></a>Açıklamalar  
 ...
 `<Library>` yönergeler koşullu olarak kullanılıyor olabilir. `<Library>`Öğenin adı bir yıldız işaretiyle başlıyorsa ve bitiyorsa \* , `<Library>` yönerge yalnızca yıldız işaretleri arasında belirtilen derlemeye uygulama tarafından başvuruluyorsa bir etkiye sahiptir. Örneğin, aşağıdaki çalışma zamanı yönergesi yalnızca uygulama tarafından Utilities.dll derlemeye başvuruluyorsa geçerlidir.  
