...
- [Bir dizeden öğeleri Ayıkla](../standard/base-types/parse-strings.md) -taşıma alternatifleri `String.Split` başvuru dışında
...
- [SYSLIB0004: kısıtlanmış yürütme bölgesi (cer) özelliği desteklenmiyor](../core/compatibility/syslib0004.md) -geçici çözüm içeren SYSLIB0004 belgelerini Güncelleştir
...
- Yenilikler [(.net Windows Forms)](/dotnet/desktop/winforms/whats-new/?view=netdesktop-5.0) -WinForms içindeki yenilikler makalesine ekleme

### <a name="updated-articles"></a>Güncelleştirilmiş makaleler

- [Windows Forms masaüstü uygulamasını .NET 5 ' e geçirme](/dotnet/desktop/winforms/migration/?view=netdesktop-5.0) -WinForms geçiş makalesine Visual Basic notlar ekleme
- [Masaüstü Kılavuzu](/dotnet/desktop/?view=netdesktop-5.0) -açık sorunlarla ilgili birden çok sorunu giderin.

## <a name="c-language"></a>C# dili

### <a name="new-articles"></a>Yeni makaleler

- [#nullable (C# Başvurusu)](../csharp/language-reference/preprocessor-directives/preprocessor-nullable.md) -null olabilen özniteliklerin oluşturulan dosyalarda nasıl işlendiğini açıklayın
- [Kayıt türleri oluşturma](../csharp/tutorials/exploration/records.md) -öğretici: kayıt türlerini keşfet
