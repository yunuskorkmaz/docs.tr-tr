...
- .NET Framework [Ngen. exe (yerel görüntü Oluşturucu)](../framework/tools/ngen-exe-native-image-generator.md).  
...
## <a name="running-code"></a>Kod çalıştırma  
 ...
 Microsoft Windows Vista 'da, işletim sistemi yükleyicisi, COFF üstbilgisindeki bir bit inceleyerek yönetilen modülleri denetler. Ayarlanan bit, yönetilen bir modül gösterir. Yükleyici yönetilen modülleri algılarsa, mscoree. dll dosyasını yükler ve `_CorValidateImage` `_CorImageUnloading` yönetilen modül görüntüleri yüklenip kaldırıldığında yükleyiciyi bilgilendirir. `_CorValidateImage`Aşağıdaki eylemleri gerçekleştirir:  
...
- [Meta veriler ve kendi kendine açıklama bileşenleri](metadata-and-self-describing-components.md)
- [Ilasm. exe (Il derleyici)](../framework/tools/ilasm-exe-il-assembler.md)
