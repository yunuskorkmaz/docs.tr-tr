...
### [Üstel geri alma ile özel HTTP çağrı yeniden denemelerini uygulama](implement-resilient-applications/implement-custom-http-call-retries-exponential-backoff.md)
