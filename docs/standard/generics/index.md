...
- Genel türler, dinamik olarak üretilen kod kolaylaştırın. Genel türler ile dinamik olarak üretilen kod kullandığınızda tür oluşturma gerekmez. Bu, tüm derlemeler üretmek yerine basit dinamik yöntemler kullanmak senaryoları sayısını artırır. Daha fazla bilgi için [nasıl yapılır: Dinamik yöntemleri tanımlama ve yürütme](../../../docs/framework/reflection-and-codedom/how-to-define-and-execute-dynamic-methods.md) ve <xref:System.Reflection.Emit.DynamicMethod>.  
