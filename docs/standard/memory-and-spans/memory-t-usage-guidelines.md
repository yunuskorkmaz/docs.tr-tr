...
Örneğin, giriş alanı boş `pbData` ise, önceki örnekte null olabilir. İçe aktarılmış Yöntem, 0 `pbData` `cbData` olsa bile null olmayan bir değer gerektiriyorsa, yöntemi aşağıdaki gibi uygulanabilir:
