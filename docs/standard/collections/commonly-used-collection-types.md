...
|Başlık|Açıklama|  
|-----------|-----------------|  
|[Koleksiyonlar ve veri yapıları](index.md)|Yığınlar, kuyruklar, listeler, diziler ve sözlükler dahil olmak üzere .NET 'te kullanılabilen çeşitli koleksiyon türlerini açıklar.|  
