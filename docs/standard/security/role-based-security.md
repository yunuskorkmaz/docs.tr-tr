...
|Başlık|Açıklama|  
|-----------|-----------------|  
|[Sorumlu ve Kimlik Nesneleri](principal-and-identity-objects.md)|Hem Windows hem de genel kimliklerin ve sorumluların nasıl ayarlanacağını ve yönetileceğini açıklar.|  
|[Temel Güvenlik Kavramları](key-security-concepts.md)|.NET Framework güvenliği kullanmadan önce anlamanız gereken temel kavramları tanıtır.|  
