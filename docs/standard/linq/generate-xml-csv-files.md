...
---
# <a name="how-to-generate-xml-from-csv-files-linq-to-xml"></a>CSV dosyalarından XML oluşturma (LINQ to XML)

Bir virgülle ayrılmış değerler (CSV) dosyasından XML oluşturmak için C# veya Visual Basic LINQ to XML kullanabilirsiniz.

## <a name="example-generate-xml-from-a-csv-file"></a>Örnek: CSV dosyasından XML oluşturma

Bu örnek, bir dize dizisinde bir LINQ sorgusu yapar ve ardından `let` her dizeyi bir alan dizisine bölmek için yan tümcesini kullanır.
