...
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace-linq-to-xml"></a>Örnek XML dosyası: bir ad alanında birden fazla satın alma siparişi (LINQ to XML)

Aşağıdaki XML dosyası LINQ to XML belgelerindeki çeşitli örneklerde kullanılır. Bu dosya birkaç satın alma siparişi içerir. XML bir ad alanıdır.
