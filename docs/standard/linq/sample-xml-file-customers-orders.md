...
description: Örneklerde kullanılan bu XML dosyası, müşteriler ve siparişler hakkında verilere sahiptir.
ms.date: 07/20/2015
...
ms.locfileid: "89553605"
---
# <a name="sample-xml-file-customers-and-orders-linq-to-xml"></a><span data-ttu-id="35f20-103">Örnek XML dosyası: müşteriler ve siparişler (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="35f20-103">Sample XML file: Customers and orders (LINQ to XML)</span></span>

<span data-ttu-id="35f20-104">Aşağıdaki XML dosyası LINQ to XML belgelerindeki çeşitli örneklerde kullanılır.</span><span class="sxs-lookup"><span data-stu-id="35f20-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="35f20-105">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="35f20-105">This file contains customers and orders.</span></span>

<span data-ttu-id="35f20-106">[Örnek xsd dosyası: müşteriler ve siparişler](sample-xsd-file-customers-orders.md) , bu belgeyi doğrulamak için KULLANıLABILECEK bir xsd içerir.</span><span class="sxs-lookup"><span data-stu-id="35f20-106">The article [Sample XSD file: Customers and orders](sample-xsd-file-customers-orders.md) contains an XSD that can be used to validate this document.</span></span> <span data-ttu-id="35f20-107">`xs:key`Özniteliğin ve özelliklerini kullanarak `xs:keyref` `CustomerID` `Customer` öğe özniteliğinin bir anahtar olduğunu ve her bir öğe `CustomerID` içindeki öğe ile her bir öğedeki özniteliği arasında bir ilişki kurmayı kullanır `Order` `CustomerID` `Customer` .</span><span class="sxs-lookup"><span data-stu-id="35f20-107">It uses the `xs:key` and `xs:keyref` features of XSD to establish that the `CustomerID` attribute of the `Customer` element is a key, and to establish a relationship between the `CustomerID` element in each `Order` element and the `CustomerID` attribute in each `Customer` element.</span></span>

<span data-ttu-id="35f20-108">Yan tümcesini kullanarak bu ilişkiden faydalanan LINQ sorguları yazma örneği için `Join` bkz. [nasıl birleşme iki koleksiyon](join-two-collections.md).</span><span class="sxs-lookup"><span data-stu-id="35f20-108">For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to join two collections](join-two-collections.md).</span></span>

## <a name="customersordersxml"></a><span data-ttu-id="35f20-109">CustomersOrders.xml</span><span class="sxs-lookup"><span data-stu-id="35f20-109">CustomersOrders.xml</span></span>
