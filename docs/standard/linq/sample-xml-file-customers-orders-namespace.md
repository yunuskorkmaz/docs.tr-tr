...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a>Örnek XML dosyası: bir ad alanındaki müşteriler ve siparişler (LINQ to XML)

Aşağıdaki XML dosyası LINQ to XML belgelerindeki çeşitli örneklerde kullanılır. Bu dosya müşteriler ve siparişler içerir. XML bir ad alanıdır.
