---
title: 'Örnek XML dosyası: bir ad alanındaki müşteriler ve siparişler-LINQ to XML'
description: Örneklerde kullanılan bu XML dosyası, müşteriler ve siparişler hakkında bir ad alanında bulunan verilere sahiptir.
ms.date: 07/20/2015
...
ms.locfileid: "89553622"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="1a56e-103">Örnek XML dosyası: bir ad alanındaki müşteriler ve siparişler (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="1a56e-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="1a56e-104">Aşağıdaki XML dosyası LINQ to XML belgelerindeki çeşitli örneklerde kullanılır.</span><span class="sxs-lookup"><span data-stu-id="1a56e-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="1a56e-105">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="1a56e-105">This file contains customers and orders.</span></span> <span data-ttu-id="1a56e-106">XML bir ad alanıdır.</span><span class="sxs-lookup"><span data-stu-id="1a56e-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="1a56e-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="1a56e-107">CustomersOrdersInNamespace.xml</span></span>
