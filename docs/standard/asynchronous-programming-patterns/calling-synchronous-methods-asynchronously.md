...
> [!NOTE]
>  IntelliSense özelliği [!INCLUDE[vsprvslong](../../../includes/vsprvslong-md.md)] parametrelerini görüntüler `BeginInvoke` ve `EndInvoke`. Visual Studio veya benzer bir araç kullanmıyorsanız veya C# ile kullanıyorsanız [!INCLUDE[vsprvslong](../../../includes/vsprvslong-md.md)], bkz: [zaman uyumsuz programlama modeli (APM)](../../../docs/standard/asynchronous-programming-patterns/asynchronous-programming-model-apm.md) bu yöntemler için tanımlanan parametrelerin bir açıklaması.  
