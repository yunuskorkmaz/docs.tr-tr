...
> [!NOTE]
>  <xref:System.Threading.Tasks.Dataflow> Ad alanı kullanılabilir [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] aracılığıyla **NuGet**. İçeren derlemeyi yüklemek için <xref:System.Threading.Tasks.Dataflow> ad içerisinde projenizi açın [!INCLUDE[vs_dev11_long](../../../includes/vs-dev11-long-md.md)], seçin **NuGet paketlerini Yönet** proje menüsünden ve çevrimiçi Microsoft.Tpl.Dataflow paketini arayın.  
