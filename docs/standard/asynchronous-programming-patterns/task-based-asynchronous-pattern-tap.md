...
.NET, <xref:System.Progress%601> uygulayan sınıfını sağlar <xref:System.IProgress%601> . <xref:System.Progress%601>Sınıfı şu şekilde bildirilmiştir:  
