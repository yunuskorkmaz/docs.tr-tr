...
Daha fazla bilgi için [EventWaitHandle](eventwaithandle.md) makalesi. API Başvurusu için bkz: <xref:System.Threading.EventWaitHandle>, <xref:System.Threading.AutoResetEvent>, <xref:System.Threading.ManualResetEvent>, ve <xref:System.Threading.ManualResetEventSlim>.
