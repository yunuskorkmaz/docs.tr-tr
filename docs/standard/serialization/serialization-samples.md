...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Bir akışa bellekte bir nesne grafiğinin seri hale getirmek nasıl gösterir.  
 ...
 .NET seri hale getirme sürümü tolerans özelliklerini gösterir.  
 ...
 ASP.NET Web Hizmetleri genel türler serileştirmek denetlemek ve nasıl kullanılacağını gösterir. 
  
 [SchemaImporterExtension Teknoloji Örneği](../../../docs/standard/serialization/schemaimporterextension-technology-sample.md)  
 Özel bir gösterir <xref:System.Xml.Serialization.Advanced.SchemaImporterExtension>.  
  
 [XmlSerializer ile Özel Serileştirme Düzeni](../../../docs/standard/serialization/custom-serialization-order-with-xmlserializer.md)  
 Serileştirilmiş ve seri durumdan çıkarılmış öğelerin sırasını XML Serileştirmenin denetlemek nasıl gösterir.  
