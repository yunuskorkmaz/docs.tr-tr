...
* [Yığın \< için gidiş dönüş desteği T>](#support-round-trip-for-stackt).
...
### <a name="support-round-trip-for-stackt"></a>Yığın T> için gidiş dönüş desteği \<
