...
> [!IMPORTANT]
>  .NET Framework Araçları düzgün şekilde çalışabilmesi doğru yol, Ekle ve kitaplığı ortam değişkenlerini ayarlamanız gerekir. Bulunan SDKVars.bat çalıştırarak bu ortam değişkenlerini ayarlama \<SDK > \v2.0\Bin dizin. Her komut kabuğu'nu SDKVars.bat yürütülmelidir.  
