...
*Ildadsm. exe*' yi kullanarak bir derlemenin içeriğini göstermek için, bir komut isteminde **ıldadsm** \<*bütünleştirilmiş kod adı*> yazın. Örneğin, aşağıdaki komut *Hello. exe* derlemesini ayrıştırır.  
