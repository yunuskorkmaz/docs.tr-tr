...
- Bilgileri konsola veya bir değişkene aktarmak için kodu kullanabilir veya tam adı içeren derlemenin meta verilerini incelemek için [Ildasm.exe (IL Disassembler)](../../framework/tools/ildasm-exe-il-disassembler.md) kullanabilirsiniz.
...
- Tam adı içeren derlemenin meta verilerini incelemek için [Ildasm.exe (IL Disassembler)](../../framework/tools/ildasm-exe-il-disassembler.md) kullanabilirsiniz.
