...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Eşdüzey, alt öğe, öznitelik düğümleri ve değerleri için ekleme açıklar bir <xref:System.Xml.XmlDocument> kullanarak nesne <xref:System.Xml.XPath.XPathNavigator> sınıfı.  
 ...
 Düğümleri kaldırmayı açıklar ve gelen değerleri bir <xref:System.Xml.XmlDocument> kullanarak nesne <xref:System.Xml.XPath.XPathNavigator> sınıfı.  
