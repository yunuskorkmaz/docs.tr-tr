...
## <a name="see-also"></a>Ayrıca Bkz.  
 [XmlSchemaCollection ile XDR doğrulama](../../../../docs/standard/data/xml/xdr-validation-with-xmlschemacollection.md)  
 [XML Şeması (XSD) doğrulama XmlSchemaCollection ile](../../../../docs/standard/data/xml/xml-schema-xsd-validation-with-xmlschemacollection.md)
