...
|Düğüm kümesi belge işleve ikinci bağımsız değişken boş ve göreli URI başvurusu|Kurtarma|Errata e14|  
 ...
 Errata bölümlerinden www.w3.org/1999/11/REC-xslt-19991116-errata bulunan World Wide Web Consortium (W3C) XSLT Dönüşümleri (XSLT) sürüm 1.0 belirtimi Errata bulunabilir.  
...
|Sayı|Sayısal değerlerin XML Path Language (XPath) sayı olarak kabul edilir ve W3C XML Path Language (XPath) sürüm 1.0 öneri, Bölüm 3.5 (www.w3.org/TR/xpath.html#numbers) ana hatlarıyla belirtilen ayrıntılara göre sıralanır.|  
