...
---
# <a name="accessing-xml-data-using-xpathnavigator"></a>XML XPathNavigator kullanarak verilerine erişme
<xref:System.Xml.XPath.XPathNavigator> Sınıfı düğümleri gidin, XML verileri ayıklamak ve kesin türü belirtilmiş XML verilerine erişmek için yöntemler sağlar bir <xref:System.Xml.XPath.XPathDocument> veya <xref:System.Xml.XmlDocument> nesnesi.  
...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Düğüm kümesi gezinti yöntemlerini açıklar <xref:System.Xml.XPath.XPathNavigator> düğümler gitmek için kullanılan sınıf bir <xref:System.Xml.XPath.XPathDocument> veya <xref:System.Xml.XmlDocument> nesnesi.  
 ...
 Öznitelik ve ad alanı düğümünü gezinti yöntemlerini açıklar <xref:System.Xml.XPath.XPathNavigator> sınıfı.  
  
 [XPathNavigator Kullanarak XML Verilerini Ayıklama](../../../../docs/standard/data/xml/extract-xml-data-using-xpathnavigator.md)  
 XML veri ayıklanıyor çeşitli yöntemleri açıklayan bir <xref:System.Xml.XPath.XPathDocument> veya <xref:System.Xml.XmlDocument> nesnesi.  
 ...
 Kesin türü belirtilmiş XML veri erişimi açıklayan bir <xref:System.Xml.XPath.XPathDocument> veya <xref:System.Xml.XmlDocument> kullanarak nesne <xref:System.Xml.XPath.XPathNavigator> sınıfı.  
  
 [Kullanıcı Tanımlı İşlevler ve Değişkenler](../../../../docs/standard/data/xml/user-defined-functions-and-variables.md)  
 Özel bir uygulama açıklar <xref:System.Xml.Xsl.XsltContext> arabirimler birlikte sınıfı <xref:System.Xml.Xsl.IXsltContextFunction> ve <xref:System.Xml.Xsl.IXsltContextVariable> uzantısı işlevleri ve değişkenler destekler.  
