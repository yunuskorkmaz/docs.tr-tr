...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Hızlı Başlangıç: Okuma ve yazma dosyası (Windows)](https://msdn.microsoft.com/library/windows/apps/hh464978.aspx)  
 [.NET için Windows mağazası uygulamalarına genel bakış](http://msdn.microsoft.com/library/windows/apps/br230302.aspx)  
 [.NET için Windows mağazası uygulamaları – desteklenen API'leri](https://msdn.microsoft.com/library/windows/apps/br230232.aspx)
