...
## <a name="creating-a-console-application"></a>Bir konsol uygulaması oluşturma  
 İçinde [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)], oluşturma bir [!INCLUDE[csprcs](../../../includes/csprcs-md.md)] veya [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)] konsol uygulama projesi. System.Threading.Tasks.Dataflow NuGet paketini yükleyin.
