...
## <a name="robust-programming"></a>Güçlü Programlama  
 Önceki örnekte, kaynak verileri işlemek için yalnızca tek bir tüketici kullanır. Birden çok tüketiciye uygulamanızda varsa, <xref:System.Threading.Tasks.Dataflow.IReceivableSourceBlock%601.TryReceive%2A> yöntemi aşağıdaki örnekte gösterildiği gibi kaynak bloğundan veri okunamıyor.  
