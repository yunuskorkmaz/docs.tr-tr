...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl yapılır: PLINQ sorgusunda özel durumları işleme](../../../docs/standard/parallel-programming/how-to-handle-exceptions-in-a-plinq-query.md)  
  
 [Nasıl yapılır: PLINQ sorgusunu iptal etme](../../../docs/standard/parallel-programming/how-to-cancel-a-plinq-query.md)  
  
 [Nasıl yapılır: Özel bir PLINQ toplama işlevi yazma](../../../docs/standard/parallel-programming/how-to-write-a-custom-plinq-aggregate-function.md)  
 ...
 [Nasıl yapılır: Ölçü PLINQ sorgu performansını](../../../docs/standard/parallel-programming/how-to-measure-plinq-query-performance.md)  
