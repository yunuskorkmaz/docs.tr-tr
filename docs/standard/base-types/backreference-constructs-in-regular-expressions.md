...
> [!NOTE]
>  Ayrı bir söz dizimi, adlandırılmış veya numaralandırılmış yakalama grupları değiştirme Dizelerdeki başvurmak için kullanılır. Daha fazla bilgi için [değişimler](substitutions-in-regular-expressions.md).  
