...
|Numaralandırma türleri (tüm türleri türetilmiş <xref:System.Enum?displayProperty=nameWithType>)|[Numaralandırma biçimi dizeleri](../../../docs/standard/base-types/enumeration-format-strings.md)|  
