...
<a name="Specifier0"></a>   
## <a name="the-0-custom-specifier"></a>"0" özel tanımlayıcısı  
...
<a name="SpecifierD"></a>   
## <a name="the--custom-specifier"></a>"#" Özel tanımlayıcısı  
...
## <a name="the-e-and-e-custom-specifiers"></a>"E" ve "e" özel tanımlayıcıları  
...
Özel sayısal biçim dizesi içinde görünür biçim belirticileri her zaman biçimlendirme ve hiçbir zaman sabit değer olarak karakterler yorumlanır. Bu, şu karakterleri içerir:  
...
- [.](#SpecifierPt)
- [,](#SpecifierTh)
- [E veya e](#SpecifierExponent)dize biçiminde konumuna bağlı olarak.
...
Aşağıdaki örnekte, (Bu durumda, binlerce) karakterinden birimlerinin yaygın olarak kullanıldığı gösterilmektedir:
 ...
 Karakterlerin böylece sonuç dizesinde veya başarılı bir şekilde bir giriş dizesi içinde Ayrıştırılan değişmez değer ve olarak biçimlendirme karakterlerini yorumlanması olduğunu göstermek için iki yol vardır:  
  
- Biçimlendirme karakteri kaçış tarafından. Daha fazla bilgi için bkz: ["\\" kaçış karakteri](#SpecifierEscape).
  
- Tırnak işaretleri tüm değişmez değer dize kapsayan.

Aşağıdaki örnekte her iki yaklaşımın özel sayısal biçim dizesi içinde ayrılmış karakterleri eklemek için kullanır.  
