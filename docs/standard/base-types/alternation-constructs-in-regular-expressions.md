...
-   [Deseni ile eşleşen &#124;](#Either_Or)  
  
-   [Koşullu ile eşleşen (? () ifade) Evet &#124; Hayır)](#Conditional_Expr)  
  
-   [Koşullu eşleşen bir geçerli yakalanan grubuna bağlı](#Conditional_Group)  
  
<a name="Either_Or"></a>   
## <a name="pattern-matching-with-124"></a>İle eşleşen kalıbı &#124;  
