...
Visual Basic, yazdırma ve raporlama için çeşitli seçenekler sunar. Aşağıdaki konular, genel bakışlar ve yazdırma ve Raporlama ile ilgili ilgili belgelere bağlantılar sağlar.  
  
## <a name="in-this-section"></a>Bu Bölümde  
 [PrintForm Bileşeni](../../../visual-basic/developing-apps/printing/printform-component.md)  
 Genel bir bakış sağlar `PrintForm` form içeriklerini yazdırma sağlayan bileşeni.  
 ...
 Kullanarak bir formun istemci alanını yazdırma açıklanmaktadır `PrintForm` bileşeni.  
 ...
 Kullanarak temel bir form yazdırma açıklanmaktadır `PrintForm` bileşeni.  
 ...
 Rapor yazmak için kullanılabilir seçenekleri açıklar.
