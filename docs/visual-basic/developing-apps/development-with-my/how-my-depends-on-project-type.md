...
## <a name="project-details"></a>Proje ayrıntıları  
 ...
 `My.Application` nesnesinin üç sürümü, `My.Computer` nesnesinin iki sürümü ve `My.User` nesnesinin iki sürümü vardır. Bu sürümler hakkındaki ayrıntılar, tablodan sonraki dipnotlara göre verilmiştir.  
