...
2. Uygulama yapılandırma dosyasında `<listeners>` bölümünü bulun.
     ...
     En üst düzey \<Yapılandırma > bölümünde iç içe yerleştirilmiş olan \<System. Diagnostics > bölümünde iç içe yerleştirilmiş olan "DefaultSource" adlı \<kaynak > bölümündeki \<dinleyicileri > bölümünü bulabilirsiniz.
...
5. Bu öğeyi bu `<sharedListeners>` bölümüne ekleyin:
    ...
    ```
     ...
     `customlocation` özniteliğinin değerini günlük dizinine değiştirin.
