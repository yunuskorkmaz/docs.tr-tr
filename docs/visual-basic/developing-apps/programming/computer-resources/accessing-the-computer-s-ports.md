---
title: Bilgisayarın erişim&#39;s bağlantı noktaları (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
- serial ports
...
## <a name="reference"></a>Başvuru  
 ...
 Açıklar `OpenSerialPort` oluşturur ve açar, yöntemi bir <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> nesnesi.  
