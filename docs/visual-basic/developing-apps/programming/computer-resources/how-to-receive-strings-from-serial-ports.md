...
### <a name="to-receive-strings-from-the-serial-port"></a>To receive strings from the serial port  
...
3. Use the `My.Computer.Ports.OpenSerialPort` method to obtain a reference to the port. Daha fazla bilgi için bkz. <xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort%2A>.  
