...
Klasör ilgili eylemi gerçekleştirme girişimi sırasında bir dosya belirtiyorsanız.  
  
## <a name="to-correct-this-error"></a>Bu hatayı düzeltmek için  
  
-   Bir dosya yerine bir klasör belirtme emin olmak için sağlamış olursunuz yolunu denetleyin.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Dosya, dizin ve sürücü özellikleri Visual Basic'te](http://msdn.microsoft.com/library/131593e9-d1b0-4c89-9c03-ae8afc458829)  
 [Nasıl yapılır: Visual Basic'te dosya mutlak yolu belirleme](http://msdn.microsoft.com/library/4c6769df-e9b9-4b69-bfdf-ce4cfbda30ff)
