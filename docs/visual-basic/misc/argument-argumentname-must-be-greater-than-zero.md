...
ms.locfileid: "59312897"
---
# <a name="argument-argumentname-must-be-greater-than-zero"></a>Bağımsız değişken '\<argumentname >' sıfırdan büyük olmalıdır
Bağımsız değişken, sıfıra eşit veya daha az olduğundan geçerli değil.  
