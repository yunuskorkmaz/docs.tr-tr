...
---
# <a name="argument-ltargumentnamegt-must-be-greater-than-or-equal-to--1"></a>Bağımsız değişken '&lt;argumentname&gt;' değerinden büyük veya -1 değerine eşit olmalıdır
-1'den daha az bir bağımsız değişkenin değeridir.  
