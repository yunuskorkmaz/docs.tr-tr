...
---
# <a name="argument-life-cannot-be-zero"></a>'Kullanım ömrü' bağımsız değişkeni sıfır olamaz
Bir bağımsız değişken `Life`, olması gereken bir `Double` varlık faydalı ömrünü belirtir, geçerli değil.  
