...
1.  İfade değişkenlerde yazımını denetleyin. Yanlış yazılmış bir değişken adı örtük olarak sıfır olarak başlatılan sayısal bir değişken oluşturabilirsiniz.  
