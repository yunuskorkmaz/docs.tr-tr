...
---
# <a name="property-accessors-cannot-be-declared-accessmodifier-in-a-notoverridable-property"></a>Özellik erişimcisi bildirilemez '\<değiştiriciye erişememelidir >' bir 'NotOverridable' özelliğinde
