...
`TextFieldParser` `Delimiters` Özellik, veya boş olarak ayarlandığından dosyayı okuyamadı `Nothing` .  
  
## <a name="to-correct-this-error"></a>Bu hatayı düzeltmek için  
  
- İçin geçerli bir değer sağlayın `Delimiters` .  
