...
- Doğru açıklama belirteci sağlayın.  
  
## <a name="see-also"></a>Ayrıca bkz.

- [TextFieldParser.CommentTokens özelliği](xref:Microsoft.VisualBasic.FileIO.TextFieldParser.CommentTokens%2A)
