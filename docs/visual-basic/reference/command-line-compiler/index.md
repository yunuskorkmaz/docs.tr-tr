...
Visual Basic komut satırı derleyicisi programlardan Visual Studio tümleşik geliştirme ortamı (IDE) içinde derleme için bir alternatif sunar. Bu bölümde Visual Basic derleyici seçenekleri açıklamalarını içerir.
...
Visual Studio IDE içinde programları derleme alternatif olarak sağlanan Visual Basic komut satırı derleyicisi açıklar.
...
Derleyici seçenekleri alfabetik bir tabloda listeler
...
Derleyici Seçenekleri işlevsel gruplarında gösterir.
