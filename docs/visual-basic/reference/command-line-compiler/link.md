...
## <a name="example"></a>Örnek  
 Aşağıdaki `OfficeApp.vb` komut satırı, `COMData1.dll` ve `COMData2.dll` için kaynak dosya ve başvuru derlemelerini derler. `OfficeApp.exe`  
