...
Visual Basic dil belirtimi, Visual Basic dilbilgisi ve dizilim hakkındaki tüm soruların yanıtları için yetkili kaynaktır. Visual Basic başvuru belgelerinde kapsanmayan pek çok nokta dahil dil hakkında ayrıntılı bilgiler içerir.  
 ...
 Belirtimi kullanılabilir [Microsoft Download Center](https://go.microsoft.com/fwlink/?LinkId=188623).  
  
Bu sitedeki [VB 11 belirtimi](../../../../_vblang/spec/introduction.md). Bulunan Markdown dosyalarından oluşturulmuş [dotnet/vblang GitHub deposunu](https://github.com/dotnet/vblang/blob/master/spec/README.md).
