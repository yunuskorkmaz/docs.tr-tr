...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Mouse` nesne için bkz: <xref:Microsoft.VisualBasic.Devices.Mouse>.  
 ...
 **Sınıfı:**<xref:Microsoft.VisualBasic.Devices.Mouse>  
