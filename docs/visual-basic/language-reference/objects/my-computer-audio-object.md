...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Audio` nesne, bkz: <xref:Microsoft.VisualBasic.Devices.Audio>.  
  
 Daha fazla bilgi için [oyun sesleri](../../../visual-basic/developing-apps/programming/computer-resources/playing-sounds.md).  
