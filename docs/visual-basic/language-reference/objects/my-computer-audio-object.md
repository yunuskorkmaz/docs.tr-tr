...
Ses çalma için yöntemleri sağlar.  
  
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Audio` nesne için bkz: <xref:Microsoft.VisualBasic.Devices.Audio>.  
  
 Daha fazla bilgi için bkz: [oyun ses](../../../visual-basic/developing-apps/programming/computer-resources/playing-sounds.md).  
  
## <a name="requirements"></a>Gereksinimler  
 **Namespace:**<xref:Microsoft.VisualBasic.Devices>  
  
 **Sınıfı:**<xref:Microsoft.VisualBasic.Devices.Audio>  
