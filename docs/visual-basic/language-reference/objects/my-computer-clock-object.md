...
Geçerli yerel saat ve Evrensel Eşgüdümlü saate (Greenwich saati eşdeğer) sistem saatinden erişmek için özellikleri sağlar.  
  
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Clock` nesne için bkz: <xref:Microsoft.VisualBasic.Devices.Clock>.  
  
## <a name="requirements"></a>Gereksinimler  
 **Namespace:**<xref:Microsoft.VisualBasic.Devices>  
  
 **Sınıfı:**<xref:Microsoft.VisualBasic.Devices.Clock>  
