...
- <span data-ttu-id="b9512-124">Kategori, özelliğin türünü belirler:</span><span class="sxs-lookup"><span data-stu-id="b9512-124">The category determines the type of the property:</span></span>  
