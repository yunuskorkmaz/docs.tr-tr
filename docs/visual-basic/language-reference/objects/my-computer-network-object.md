...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Network` nesne için bkz: <xref:Microsoft.VisualBasic.Devices.Network>.  
  
 Daha fazla bilgi için bkz: [ağ işlemlerini gerçekleştirme](../../../visual-basic/developing-apps/programming/computer-resources/performing-network-operations.md).  
  
## <a name="requirements"></a>Gereksinimler  
 **Namespace:** <xref:Microsoft.VisualBasic.Devices?displayProperty=nameWithType>  
  
 **Sınıfı:** <xref:Microsoft.VisualBasic.Devices.Network>  
