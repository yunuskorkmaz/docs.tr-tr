...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Application.Log` nesne için bkz: <xref:Microsoft.VisualBasic.Logging.Log>.  
  
 Daha fazla bilgi için bkz: [uygulama günlüğü bilgilerinden](../../../visual-basic/developing-apps/programming/log-info/logging-information-from-the-application.md).  
