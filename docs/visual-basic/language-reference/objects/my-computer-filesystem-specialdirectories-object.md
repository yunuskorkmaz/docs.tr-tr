...
## <a name="remarks"></a>Açıklamalar  
 ...
 Daha fazla bilgi için [nasıl yapılır: İçeriğini alma Belgelerim dizini](../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-retrieve-the-contents-of-the-my-documents-directory.md).  
