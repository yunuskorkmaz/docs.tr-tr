...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.FileSystem.SpecialDirectories` nesne için bkz: <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>.  
  
 Daha fazla bilgi için bkz: [nasıl yapılır: Belgelerim Belgelerim dizini içeriğini alma](../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-retrieve-the-contents-of-the-my-documents-directory.md).  
  
## <a name="requirements"></a>Gereksinimler  
 **Namespace:** <xref:Microsoft.VisualBasic.MyServices>  
  
 **Sınıfı:** <xref:Microsoft.VisualBasic.MyServices.SpecialDirectoriesProxy> (erişim sağlayan <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>)  
