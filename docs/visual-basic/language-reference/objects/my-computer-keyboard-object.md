...
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Keyword` nesne, bkz: <xref:Microsoft.VisualBasic.Devices.Keyboard>.  
  
 Daha fazla bilgi için [klavyeye erişme](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-keyboard.md).  
