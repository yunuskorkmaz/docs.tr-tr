...
ms.locfileid: "33595166"
---
# <a name="mycomputerclipboard-object"></a>My.Computer.Clipboard Nesnesi
Pano düzenleme için yöntemleri sağlar.  
  
## <a name="remarks"></a>Açıklamalar  
 Yöntemleri ve özellikleri hakkında bilgi için `My.Computer.Clipboard` nesne için bkz: <xref:Microsoft.VisualBasic.MyServices.ClipboardProxy>.  
  
 Daha fazla bilgi için bkz: [veri depolama ve panodan okuma](../../../visual-basic/developing-apps/programming/computer-resources/storing-data-to-and-reading-from-the-clipboard.md).  
