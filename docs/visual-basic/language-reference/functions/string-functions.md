...
|---------------------------|-----------------|
|<xref:Microsoft.VisualBasic.Strings.Asc%2A>, <xref:Microsoft.VisualBasic.Strings.AscW%2A>|Bir karaktere karşılık gelen karakter kodunu temsil eden bir `Integer` değeri döndürür.|
...
Bu örnek, bir dize değişkeninden sondaki boşlukları atmak için `LTrim` işlevini, baştaki boşlukları ve `RTrim` işlevini eklemek için kullanır. Her iki boşluk türünü de atmak için `Trim` işlevini kullanır.
