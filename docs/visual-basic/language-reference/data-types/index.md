...
|-----------------------|--------------------------------------------|--------------------------------|-----------------|  
|[Boole değeri](../../../visual-basic/language-reference/data-types/boolean-data-type.md)|<xref:System.Boolean>|Uygulama platformuna bağlıdır|`True` veya `False`|  
...
|[Tarih](../../../visual-basic/language-reference/data-types/date-data-type.md)|<xref:System.DateTime>|8 bayt|1 Ocak 0:00:00 ' de (gece yarısı), 31 Aralık 9999 tarihinde 11:59:59 PM|  
...
|[Uzun](../../../visual-basic/language-reference/data-types/long-data-type.md) (uzun tamsayı)|<xref:System.Int64>|8 bayt|-9223372036854775808 ila 9.223.372.036.854.775.807 (9.2... E + 18 <sup>†</sup>) (imzalı)|  
|[Nesne](../../../visual-basic/language-reference/data-types/object-data-type.md)|<xref:System.Object>sınıfı|32 bit platformda 4 bayt<br /><br /> 64 bit platformda 8 bayt|Herhangi bir tür, türünde bir değişkende depolanabilir`Object`|  
|[SByte](../../../visual-basic/language-reference/data-types/sbyte-data-type.md)|<xref:System.SByte>|1 bayt|-128-127 (imzalı)|  
|[Kısa](../../../visual-basic/language-reference/data-types/short-data-type.md) (kısa tamsayı)|<xref:System.Int16>|2 bayt|-32.768-32.767 (imzalı)|  
...
|[Dize](../../../visual-basic/language-reference/data-types/string-data-type.md) (değişken uzunlukta)|<xref:System.String>sınıfı|Uygulama platformuna bağlıdır|0 ile yaklaşık 2.000.000.000 Unicode karakter|  
...
|[Kullanıcı tanımlı](../../../visual-basic/language-reference/data-types/user-defined-data-type.md) yapısı|(öğesinden <xref:System.ValueType>devralır)|Uygulama platformuna bağlıdır|Yapının her üyesi, veri türü ve diğer üyelerin aralıklarından bağımsız olarak belirlenen aralığa sahiptir|  
...
> [!NOTE]
> Metin içeren dizeler için, bir metin <xref:Microsoft.VisualBasic.Strings.StrConv%2A> biçiminden diğerine dönüştürmek için işlevini kullanın.  
...
### <a name="object-overhead"></a>Nesne ek yükü  
 Herhangi `Object` bir öğesel veya bileşik veri türüne başvuran, veri türünde bulunan verilere ek olarak 4 bayt kullanır.  
