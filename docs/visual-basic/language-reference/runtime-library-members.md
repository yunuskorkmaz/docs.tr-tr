---
description: 'Hakkında daha fazla bilgi edinin: Visual Basic çalışma zamanı kitaplığı üyeleri'
title: Çalışma zamanı kitaplığı üyeleri
ms.date: 07/20/2015
f1_keywords:
- VisualBasic
helpviewer_keywords:
...
ms.locfileid: "99674187"
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="c1d0e-103">Visual Basic Çalışma Süresi Kitaplık Üyeleri</span><span class="sxs-lookup"><span data-stu-id="c1d0e-103">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="c1d0e-104">`Microsoft.VisualBasic`Ad alanı, Visual Basic çalışma zamanı kitaplığını oluşturan sınıfları, modülleri, sabitleri ve numaralandırmaları içerir.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-104">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="c1d0e-105">Bu kitaplık üyeleri, kodunuzda kullanabileceğiniz yordamları, özellikleri ve sabit değerleri sağlar.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-105">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="c1d0e-106">Her modül ve sınıf belirli bir işlev kategorisini temsil eder.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-106">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="c1d0e-107">Microsoft. VisualBasic. Collection sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-107">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="c1d0e-108">Microsoft. VisualBasic. ComClassAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-108">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="c1d0e-109">Microsoft. VisualBasic. ControlChars sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-109">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="c1d0e-110">Microsoft. VisualBasic. sabitleri sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-110">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="c1d0e-111">Microsoft. VisualBasic. dönüştürme modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-111">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="c1d0e-112">Microsoft. VisualBasic. DateAndTime Modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-112">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="c1d0e-113">Microsoft. VisualBasic. ErrObject sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-113">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="c1d0e-114">Microsoft. VisualBasic. FileSystem Modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-114">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="c1d0e-115">Microsoft. VisualBasic. Financial Module</span><span class="sxs-lookup"><span data-stu-id="c1d0e-115">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="c1d0e-116">Microsoft. VisualBasic. Globals modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-116">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="c1d0e-117">Microsoft. VisualBasic. HideModuleNameAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-117">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="c1d0e-118">Microsoft. VisualBasic. Information modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-118">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="c1d0e-119">Microsoft. VisualBasic. Inter-Module</span><span class="sxs-lookup"><span data-stu-id="c1d0e-119">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="c1d0e-120">Microsoft. VisualBasic. MyGroupCollectionAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-120">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="c1d0e-121">Microsoft. VisualBasic. Strings Modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-121">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="c1d0e-122">Microsoft. VisualBasic. VBFixedArrayAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-122">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="c1d0e-123">Microsoft. VisualBasic. VBFixedStringAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="c1d0e-123">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="c1d0e-124">Microsoft. VisualBasic. VbMath modülü</span><span class="sxs-lookup"><span data-stu-id="c1d0e-124">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="c1d0e-125">Microsoft. VisualBasic sabitleri ve numaralandırmalar</span><span class="sxs-lookup"><span data-stu-id="c1d0e-125">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="c1d0e-126">`Microsoft.VisualBasic`Ad alanı, Visual Basic çalışma zamanı kitaplığının bir parçası olarak sabitler ve numaralandırmalar sağlar.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-126">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="c1d0e-127">Kodunuzda bu sabit değerleri kullanabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-127">You can use these constant values in your code.</span></span> <span data-ttu-id="c1d0e-128">Her numaralandırma belirli bir işlev kategorisini temsil eder.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-128">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="c1d0e-129">Daha fazla bilgi için bkz. [sabitler ve numaralandırmalar](constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="c1d0e-129">For more information, see [Constants and Enumerations](constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="c1d0e-130">Ayrıca bkz.</span><span class="sxs-lookup"><span data-stu-id="c1d0e-130">See also</span></span>

- [<span data-ttu-id="c1d0e-131">Sabitler ve numaralandırmalar</span><span class="sxs-lookup"><span data-stu-id="c1d0e-131">Constants and Enumerations</span></span>](constants-and-enumerations.md)
- [<span data-ttu-id="c1d0e-132">Anahtar sözcükler</span><span class="sxs-lookup"><span data-stu-id="c1d0e-132">Keywords</span></span>](keywords/index.md)
