...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="adef3-102">Visual Basic Çalışma Süresi Kitaplık Üyeleri</span><span class="sxs-lookup"><span data-stu-id="adef3-102">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="adef3-103">`Microsoft.VisualBasic` ad alanı, Visual Basic çalışma zamanı kitaplığını oluşturan sınıfları, modülleri, sabitleri ve numaralandırmaları içerir.</span><span class="sxs-lookup"><span data-stu-id="adef3-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="adef3-104">Bu kitaplık üyeleri, kodunuzda kullanabileceğiniz yordamları, özellikleri ve sabit değerleri sağlar.</span><span class="sxs-lookup"><span data-stu-id="adef3-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="adef3-105">Her modül ve sınıf belirli bir işlev kategorisini temsil eder.</span><span class="sxs-lookup"><span data-stu-id="adef3-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="adef3-106">Microsoft. VisualBasic. Collection sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="adef3-107">Microsoft. VisualBasic. ComClassAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="adef3-108">Microsoft. VisualBasic. ControlChars sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="adef3-109">Microsoft. VisualBasic. sabitleri sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="adef3-110">Microsoft. VisualBasic. dönüştürme modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="adef3-111">Microsoft. VisualBasic. DateAndTime Modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="adef3-112">Microsoft. VisualBasic. ErrObject sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="adef3-113">Microsoft. VisualBasic. FileSystem Modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="adef3-114">Microsoft. VisualBasic. Financial Module</span><span class="sxs-lookup"><span data-stu-id="adef3-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="adef3-115">Microsoft. VisualBasic. Globals modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="adef3-116">Microsoft. VisualBasic. HideModuleNameAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="adef3-117">Microsoft. VisualBasic. Information modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="adef3-118">Microsoft. VisualBasic. Inter-Module</span><span class="sxs-lookup"><span data-stu-id="adef3-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="adef3-119">Microsoft. VisualBasic. MyGroupCollectionAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="adef3-120">Microsoft. VisualBasic. Strings Modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="adef3-121">Microsoft. VisualBasic. VBFixedArrayAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="adef3-122">Microsoft. VisualBasic. VBFixedStringAttribute sınıfı</span><span class="sxs-lookup"><span data-stu-id="adef3-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="adef3-123">Microsoft. VisualBasic. VbMath modülü</span><span class="sxs-lookup"><span data-stu-id="adef3-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="adef3-124">Microsoft. VisualBasic sabitleri ve numaralandırmalar</span><span class="sxs-lookup"><span data-stu-id="adef3-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="adef3-125">`Microsoft.VisualBasic` ad alanı, Visual Basic çalışma zamanı kitaplığının bir parçası olarak sabitler ve numaralandırmalar sağlar.</span><span class="sxs-lookup"><span data-stu-id="adef3-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="adef3-126">Kodunuzda bu sabit değerleri kullanabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="adef3-126">You can use these constant values in your code.</span></span> <span data-ttu-id="adef3-127">Her numaralandırma belirli bir işlev kategorisini temsil eder.</span><span class="sxs-lookup"><span data-stu-id="adef3-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="adef3-128">Daha fazla bilgi için bkz. [sabitler ve numaralandırmalar](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="adef3-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="adef3-129">Ayrıca bkz.</span><span class="sxs-lookup"><span data-stu-id="adef3-129">See also</span></span>

- [<span data-ttu-id="adef3-130">Sabitler ve Sabit Listeleri</span><span class="sxs-lookup"><span data-stu-id="adef3-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="adef3-131">Anahtar Sözcükler</span><span class="sxs-lookup"><span data-stu-id="adef3-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
