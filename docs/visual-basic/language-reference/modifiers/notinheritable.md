...
Bir sınıfın temel sınıf olarak kullanılan belirtir.  
  
## <a name="remarks"></a>Açıklamalar  
 **Alternatif terimler**. Devralınan olamaz bir sınıf adlandırılan bir *korumalı* sınıfı.  
  
 `NotInheritable` Bu bağlamda değiştirici kullanılabilir:  
