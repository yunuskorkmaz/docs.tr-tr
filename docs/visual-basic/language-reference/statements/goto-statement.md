...
|---------------------|-------------------------------|-------------------------------|  
|`Try` bloğu|Yalnızca `Catch` aynı yapım <sup>1</sup> bloğundan|Yalnızca tüm oluşturma dışında|  
|`Catch` bloğu|Hiçbir izin verilmiyor|Yalnızca tüm oluşturma veya `Try` aynı yapı <sup>1</sup> bloğunun dışında|  
