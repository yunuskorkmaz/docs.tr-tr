...
## <a name="remarks"></a>Açıklamalar  
 Kullanıldıysa, `Inherits` deyimin bir sınıf veya arabirim tanımında ilk boş olmayan, yorum olmayan satırı olması gerekir. @No__t_0 veya `Interface` deyiminizi hemen izlemelidir.  
...
## <a name="example"></a>Örnek  
 ...
 @No__t_0 adlı arabirim, <xref:System.IComparable>, <xref:System.IDisposable> ve <xref:System.IFormattable> arabirimleri, devralınan üyelerin, iki nesnenin türüne özgü karşılaştırması, ayrılmış kaynakları serbest bırakmak ve değerini ifade etmek için sırasıyla sağladığı tüm tanımları içerir. `String` olarak bir nesne. @No__t_0 uygulayan bir sınıf, her temel arabirimin her üyesini uygulamalıdır.  
