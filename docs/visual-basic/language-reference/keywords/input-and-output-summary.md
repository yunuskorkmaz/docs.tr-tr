...
|Bir dosyaya kopyalayın.|<xref:Microsoft.VisualBasic.FileSystem.FileCopy%2A>|  
...
|Veya bir denetim iletişim kutusu yoluyla / için kullanıcı bilgilerini edinin.|<xref:Microsoft.VisualBasic.Interaction.InputBox%2A>, <xref:Microsoft.VisualBasic.Interaction.MsgBox%2A>|  
...
|Bir dosyadan okuma.|<xref:Microsoft.VisualBasic.FileSystem.FileGet%2A>, <xref:Microsoft.VisualBasic.FileSystem.FileGetObject%2A>, <xref:Microsoft.VisualBasic.FileSystem.Input%2A>, <xref:Microsoft.VisualBasic.FileSystem.InputString%2A>, <xref:Microsoft.VisualBasic.FileSystem.LineInput%2A>|  
|Bir dosya uzunluğunu döndürür.|<xref:Microsoft.VisualBasic.FileSystem.FileLen%2A>|  
|Ayarlayın veya dosya özniteliklerini alma.|<xref:Microsoft.VisualBasic.FileSystem.FileAttr%2A>, <xref:Microsoft.VisualBasic.FileSystem.GetAttr%2A>, <xref:Microsoft.VisualBasic.FileSystem.SetAttr%2A>|  
|Dosya okuma / yazma konumunu ayarlayın.|<xref:Microsoft.VisualBasic.FileSystem.Seek%2A>|  
