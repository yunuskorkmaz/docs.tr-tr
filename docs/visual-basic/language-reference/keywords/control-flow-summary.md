...
|Kararlar.|<xref:Microsoft.VisualBasic.Interaction.Choose%2A>, [Varsa... Then... Else](../../../visual-basic/language-reference/statements/if-then-else-statement.md), [seçin durumda](../../../visual-basic/language-reference/statements/select-case-statement.md),<xref:Microsoft.VisualBasic.Interaction.Switch%2A>|  
