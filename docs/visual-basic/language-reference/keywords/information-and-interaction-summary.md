...
|Bir yöntemi veya özelliği çağırın.|<xref:Microsoft.VisualBasic.Interaction.CallByName%2A>|  
|Bilgisayardan bir bip sesi.|<xref:Microsoft.VisualBasic.Interaction.Beep%2A>|  
|Komut satırı bir dize sağlayın.|<xref:Microsoft.VisualBasic.Interaction.Command%2A>|  
|COM nesneleri düzenleyebilirsiniz.|<xref:Microsoft.VisualBasic.Interaction.CreateObject%2A>, <xref:Microsoft.VisualBasic.Interaction.GetObject%2A>|  
|Renk bilgi alın.|<xref:Microsoft.VisualBasic.Information.QBColor%2A>, <xref:Microsoft.VisualBasic.Information.RGB%2A>|  
