...
## <a name="reserved-keywords"></a>Reserved Keywords
...
|[CInt](../functions/type-conversion-functions.md)|[Class Constraint](../statements/type-list.md)|[Class Deyimi](../statements/class-statement.md)|[CLng](../functions/type-conversion-functions.md)|  
...
|[Each](../statements/for-each-next-statement.md)|[Else](../statements/else-statement.md)|[ElseIf](../statements/if-then-else-statement.md)|[End Deyimi](../statements/end-statement.md)|  
...
|[Hata:](../statements/on-error-statement.md)|[Event](../statements/event-statement.md)|[Çıkış](../statements/exit-statement.md)|[False](../data-types/boolean-data-type.md)|  
...
|[If](../statements/if-then-else-statement.md)|[If()](../operators/if-operator.md)|[Implements](../statements/implements-clause.md)|[Implements Deyimi](../statements/implements-statement.md)|  
|[Imports (.NET Namespace and Type)](../statements/imports-statement-net-namespace-and-type.md)|[Imports (XML Namespace)](../statements/imports-statement-xml-namespace.md)|[In](../statements/in-clause.md)|[In (Genel Değiştirici)](../modifiers/in-generic-modifier.md)|  
...
|[Narrowing](../modifiers/narrowing.md)|[New Constraint](../statements/type-list.md)|[New İşleci](../operators/new-operator.md)|[Next](../statements/for-next-statement.md)|
...
|[Resume](../statements/resume-statement.md)|[Return](../statements/return-statement.md)|[SByte](../data-types/sbyte-data-type.md)|[Seçin](../statements/select-case-statement.md)|
...
|[Dize](../data-types/string-data-type.md)|[Structure Constraint](../statements/type-list.md)|[Structure Deyimi](../statements/structure-statement.md)|[Sub](../statements/sub-statement.md)|
...
## <a name="unreserved-keywords"></a>Unreserved Keywords
...
|[Özel](../statements/event-statement.md)|[Distinct](../queries/distinct-clause.md)|[Equals](../queries/equals-clause.md)|[Explicit](../statements/option-explicit-statement.md)|  
...
|[Take](../queries/take-clause.md)|[Take While](../queries/take-while-clause.md)|[Metin](../statements/option-compare-statement.md)|[Unicode](../modifiers/unicode.md)|  
...
|Başlık|Açıklama|  
|-----------|-----------------|  
|[Dizi Özeti](arrays-summary.md)|Lists language elements that are used to create, define, and use arrays.|  
|[Koleksiyon Nesnesi Özeti](collection-object-summary.md)|Lists language elements that are used for collections.|  
|[Denetim Akışı Özeti](control-flow-summary.md)|Lists statements that are used for looping and controlling procedure flow.|  
|[Dönüştürme Özeti](conversion-summary.md)|Lists functions that are used to convert numbers, dates, times, and strings.|  
|[Veri Türleri Özeti](data-types-summary.md)|Lists data types. Also lists functions that are used to convert between data types and verify data types.|  
|[Tarihler ve Saatlere İlişkin Özet](dates-and-times-summary.md)|Lists language elements that are used for dates and times.|  
|[Bildirimler ve Sabitlere İlişkin Özet](declarations-and-constants-summary.md)|Lists statements that are used to declare variables, constants, classes, modules, and other programming elements. Also lists language elements that are used to obtain object information, handle events, and implement inheritance.|  
|[Dizinler ve Dosyalar Özeti](directories-and-files-summary.md)|Lists functions that are used to control the file system and to process files.|  
|[Hatalara İlişkin Özet](errors-summary.md)|Lists language elements that are used to catch and return run-time error values.|  
|[Mali Özet](financial-summary.md)|Lists functions that are used to perform financial calculations.|  
|[Giriş ve Çıkış Özeti](input-and-output-summary.md)|Lists functions that are used to read from and write to files, manage files, and print output.|  
|[Bilgi ve Etkileşim Özeti](information-and-interaction-summary.md)|Lists functions that are used to run other programs, obtain command-line arguments, manipulate COM objects, retrieve color information, and use control dialog boxes.|  
|[Matematik Özeti](math-summary.md)|Lists functions that are used to perform trigonometric and other mathematical calculations.|  
|[Başvurum](my-reference.md)|Lists the objects contained in `My`, a feature that provides access to frequently used methods, properties, and events of the computer on which the application is running, the current application, the application's resources, the application's settings, and so on.|  
|[İşleçlere İlişkin Özet](operators-summary.md)|Lists assignment and comparison expressions and other operators.|  
|[Kayıt Defteri Özeti](registry-summary.md)|Lists functions that are used to read, save, and delete program settings.|  
|[Dize Düzenleme Özeti](string-manipulation-summary.md)|Lists functions that are used to manipulate strings.|  
