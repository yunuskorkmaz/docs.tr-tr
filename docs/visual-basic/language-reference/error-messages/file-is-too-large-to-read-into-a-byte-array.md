...
Bir bayt dizisine okunamayacak kadar çalıştığınız dosya boyutu 4 GB aşıyor. `My.Computer.FileSystem.ReadAllBytes` Yöntemi bu boyuttan daha büyük bir dosya okunamaz.  
  
## <a name="to-correct-this-error"></a>Bu hatayı düzeltmek için  
  
-   Kullanım bir <xref:System.IO.StreamReader> dosya okunamıyor. Daha fazla bilgi için bkz: [temelleri, .NET Framework dosyası g/ç ve dosya sistemi (Visual Basic)](../../../visual-basic/developing-apps/programming/drives-directories-files/basics-of-net-framework-file-io-and-the-file-system.md).  
