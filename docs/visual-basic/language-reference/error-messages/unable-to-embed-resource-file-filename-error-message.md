...
Visual Basic derleyici, bildirime sahip bir derleme oluşturmak için derleme bağlayıcı (Al.exe, Alink olarak da bilinir) çağırır. Bağlayıcı, yerel bir COM+ kaynak dosyasını doğrudan derlemeye eklerken bir hata bildirdi.
