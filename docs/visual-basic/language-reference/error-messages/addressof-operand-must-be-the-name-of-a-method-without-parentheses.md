...
`AddressOf` İşleci belirli bir yordamı başvuruda bulunan bir yordam temsilci örneği oluşturur. Söz dizimi aşağıdaki gibidir.  
 ...
 Bağımsız değişkeni aşağıdaki parantezler eklenen `AddressOf`, burada Hiçbiri gereklidir.  
  
 **Hata Kimliği:** BC30577  
  
## <a name="to-correct-this-error"></a>Bu hatayı düzeltmek için  
  
1.  Bağımsız değişkeni aşağıdaki parantezler kaldırmak `AddressOf`.  
  
2.  Bağımsız değişkeni bir yöntem adı olduğundan emin olun.  
