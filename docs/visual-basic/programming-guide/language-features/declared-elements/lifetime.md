...
## <a name="end-of-lifetime"></a>Yaşam süresi sonu  
 Bir yordam sonlandırıldığında kendi yerel değişkenlerin değerleri korunmaz, ve [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] kendi bellek geri kazanır. Yordam çağrısı başlatıldığında tüm yerel değişkenler afresh oluşturulur ve yeniden başlatıldı.  
