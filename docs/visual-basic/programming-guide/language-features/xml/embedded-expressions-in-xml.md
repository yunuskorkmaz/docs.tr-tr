...
|---|---|---|  
|XML element name|<xref:System.Xml.Linq.XName>|Hata|  
|XML element content|`Object` or array of `Object`|Yoksayıldı|  
...
|XML element attribute|<xref:System.Xml.Linq.XAttribute> or a collection of <xref:System.Xml.Linq.XAttribute>|Yoksayıldı|  
|XML document root element|<xref:System.Xml.Linq.XElement> or a collection of one <xref:System.Xml.Linq.XElement> object and an arbitrary number of <xref:System.Xml.Linq.XProcessingInstruction> and <xref:System.Xml.Linq.XComment> objects|Yoksayıldı|  
