---
title: 'Nasıl yapılır: XML Ad Alanı Öneklerini Bildirme ve Kullanma (Visual Basic)'
ms.date: 07/20/2015
helpviewer_keywords:
...
Bu örnek XML ad alanı öneki içeri aktarmak nasıl gösterir `ns` ve XML değişmez değeri ve XML eksen özellikleri kullanın.  
