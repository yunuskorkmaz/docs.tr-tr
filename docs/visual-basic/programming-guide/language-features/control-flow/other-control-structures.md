...
## <a name="usingend-using-construction"></a>Kullanarak... Son yapı kullanma  
 `Using...End Using` Yapım kurar, içinde yaptığınız bir deyim bloğunu bir kaynağın SQL bağlantısı kullanın. İsteğe bağlı olarak kaynak edinebileceğinizi `Using` deyimi. Çıktığınızda `Using` blok, Visual Basic böylece diğer kod kullanmak kullanılabilir kaynak otomatik olarak atar. Kaynak, yerel ve atılabilir olması gerekir. Daha fazla bilgi için [Using deyimi](../../../../visual-basic/language-reference/statements/using-statement.md).  
