...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl Yapılır: Visual Basic'de Bir StringBuilder Kullanarak Dize Oluşturma](how-to-create-strings-using-a-stringbuilder.md)  
 ...
 [İzlenecek yol: Visual Basic'de Dizeleri Şifreleme ve Şifresini Çözme](walkthrough-encrypting-and-decrypting-strings.md)  
...
- [Visual Basic Dil Özellikleri](../index.md)
