...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 [Nasıl yapılır: Visual Basic COM nesnelerine başvuru](../../../visual-basic/programming-guide/com-interop/how-to-reference-com-objects.md)  
 ...
 User32. dll içinde `MessageBox` işlevin nasıl tanımlanacağını ve çağrılacağını gösterir.  
