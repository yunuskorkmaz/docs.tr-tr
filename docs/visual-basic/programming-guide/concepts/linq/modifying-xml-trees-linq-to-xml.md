...
|Konu|Açıklama|  
|-----------|-----------------|  
|[Bellek içi XML ağaç değişikliği vs. İşlev yapımı (LINQ-XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/in-memory-xml-tree-modification-vs-functional-construction.md)|İşlev oluşturma için bellek XML ağacında değiştirme karşılaştırır.|  
...
|[Öğeleri, öznitelikleri ve bir XML ağacında düğümlerin değiştirme](../../../../visual-basic/programming-guide/concepts/linq/modifying-elements-attributes-and-nodes-in-an-xml-tree.md)|Varolan öğeleri, öznitelikleri veya düğümler değiştirme hakkında bilgi sağlar.|  
