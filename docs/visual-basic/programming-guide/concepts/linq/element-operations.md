...
|Tek|Bir koleksiyonun tek öğe veya bir koşulu karşılayan tek öğe döndürür.|Geçerli değildir.|<xref:System.Linq.Enumerable.Single%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Single%2A?displayProperty=nameWithType>|  
|SingleOrDefault|Bir koleksiyonun tek öğe veya bir koşulu karşılayan tek öğe döndürür. Böyle bir öğe var veya tam bir öğe koleksiyonu içermiyor varsayılan bir değer döndürür.|Geçerli değildir.|<xref:System.Linq.Enumerable.SingleOrDefault%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.SingleOrDefault%2A?displayProperty=nameWithType>|  
