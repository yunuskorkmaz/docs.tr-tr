...
|Tek|Bir koleksiyonun tek bir öğesini veya bir koşulu karşılayan tek öğeyi döndürür.|Geçerli değildir.|<xref:System.Linq.Enumerable.Single%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Single%2A?displayProperty=nameWithType>|  
|SingleOrDefault|Bir koleksiyonun tek bir öğesini veya bir koşulu karşılayan tek öğeyi döndürür. Böyle bir öğe yoksa veya koleksiyon tam olarak bir öğe içermiyorsa varsayılan bir değer döndürür.|Geçerli değildir.|<xref:System.Linq.Enumerable.SingleOrDefault%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.SingleOrDefault%2A?displayProperty=nameWithType>|  
