...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 LINQ to DataSet, LINQ to SQL ve LINQ to Entities hakkındaki belgeler için bir giriş noktası sağlar. LINQ to DataSet, diğer veri kaynakları için kullanılabilen aynı sorgu işlevini kullanarak <xref:System.Data.DataSet> daha zengin sorgu özellikleri oluşturmanızı sağlar. LINQ to SQL ilişkisel verileri nesne olarak yönetmeye yönelik bir çalışma zamanı altyapısı sağlar. LINQ to Entities, geliştiricilerin, kullanarak C#Entity Framework kavramsal modele yönelik sorgular yazmasını sağlar.  
