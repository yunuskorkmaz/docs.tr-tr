...
## <a name="linq-aware-code-editor"></a>LINQ algılayan Kod Düzenleyicisi  
 Visual Basic kod düzenleyicisinde LINQ yaygın IntelliSense ve biçimlendirme yetenekleri ile destekler.  
  
## <a name="visual-studio-debugger-support"></a>Visual Studio hata ayıklayıcı desteği  
 Visual Studio hata ayıklayıcısı hata ayıklama sorgu ifadeleri destekler. Daha fazla bilgi için bkz: [hata ayıklama LINQ](/visualstudio/debugger/debugging-linq).  
