...
ms.locfileid: "84413342"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="0f1b8-102">Örnek XML Dosyası: Bir Ad Alanında Müşteriler ve Siparişler</span><span class="sxs-lookup"><span data-stu-id="0f1b8-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="0f1b8-103">Aşağıdaki XML dosyası belgelerindeki çeşitli örneklerde kullanılır [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] .</span><span class="sxs-lookup"><span data-stu-id="0f1b8-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="0f1b8-104">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="0f1b8-104">This file contains customers and orders.</span></span> <span data-ttu-id="0f1b8-105">XML bir ad alanıdır.</span><span class="sxs-lookup"><span data-stu-id="0f1b8-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="0f1b8-106">CustomersOrdersInNamespace. xml</span><span class="sxs-lookup"><span data-stu-id="0f1b8-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="0f1b8-107">Ayrıca bkz.</span><span class="sxs-lookup"><span data-stu-id="0f1b8-107">See also</span></span>

- [<span data-ttu-id="0f1b8-108">Örnek XML Belgeleri (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="0f1b8-108">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
