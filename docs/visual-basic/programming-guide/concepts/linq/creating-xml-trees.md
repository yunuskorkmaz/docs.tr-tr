...
|[Visual Basic'de XML değişmez değerleri giriş](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-xml-literals.md)|Ağaçlarında oluşturmanın hızlı bir giriş sağlar [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] XML değişmez değerleri kullanarak. Bu konuda bağlantılarını içerir [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] XML değişmez değerleri belgeleri.|  
|[Kopyalama vs. Düğmelere (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/cloning-vs-attaching.md)|(Düğümler kopyalanabilen ve daha sonra eklenen) bir varolan XML ağacından düğüm ekleme ve üst (yalnızca takılı oldukları) yok düğüm ekleme arasındaki farkı gösterir.|  
...
|[Geçerli içerik XElement ve XDocument nesneleri](../../../../visual-basic/programming-guide/concepts/linq/valid-content-of-xelement-and-xdocument-objects.md)|Oluşturucular ve içerik öğelerini ve belgeleri eklemek için kullanılan yöntemleri geçirilen geçerli değişkenler açıklanmaktadır.|  
