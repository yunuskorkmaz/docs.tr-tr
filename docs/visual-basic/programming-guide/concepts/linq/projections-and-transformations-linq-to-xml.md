...
|Konu|Açıklama|  
|-----------|-----------------|  
|[Nasıl yapılır: LINQ to XML kullanarak sözlüklerle çalışma (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)|Sözlüklerin XML 'e nasıl dönüştürüleceğini ve XML 'in sözlüklere nasıl dönüştürüleceğini gösterir.|  
|[Nasıl yapılır: bir XML ağacının şeklini dönüştürme (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-transform-the-shape-of-an-xml-tree.md)|Bir XML belgesi şeklinin nasıl dönüştürüleceğini gösterir.|  
|[Nasıl yapılır: projeksiyon türünü denetleme (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-control-the-type-of-a-projection.md)|Bir [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] sorgusunun türünü denetlemeyi gösterir.|  
|[Nasıl yapılır: yeni bir tür proje (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-project-a-new-type-linq-to-xml.md)|Bir [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] sorgusundan Kullanıcı tanımlı bir türün toplanmasını nasıl kullanacağınızı gösterir.|  
