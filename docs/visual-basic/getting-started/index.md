...
[Bir sınıf kitaplığı Visual Basic ve Visual Studio 2017 .NET çekirdek ile derleme](../../core/tutorials/vb-library-with-visual-studio.md)  
...
[Visual Basic, Visual Studio'da yeni değişiklikler](breaking-changes-in-visual-studio.md)  
...
[Visual Basic Hello yapı Visual Studio 2017 .NET çekirdek World uygulamayla](../../core/tutorials/vb-with-visual-studio.md) 

[Bir sınıf kitaplığı Visual Basic ve Visual Studio 2017 .NET çekirdek ile derleme](../../core/tutorials/vb-library-with-visual-studio.md) 

## <a name="see-also"></a>Ayrıca bkz.
 [Visual Basic Al](https://www.visualstudio.com/downloads/)  
