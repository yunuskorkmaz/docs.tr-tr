...
|URL|Açıklama|
|----------|----------------|
|[Visual Basic belge örnekleri](https://github.com/dotnet/samples/tree/master/snippets/visualbasic)|Visual Basic ve .NET belgelerinin tamamında kullanılan örnekleri içerir.|
