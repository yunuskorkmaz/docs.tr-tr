...
### [Yapı hazırlamayı özelleştirme](standard/native-interop/customize-struct-marshalling.md)
...
##### [?() İşleci](visual-basic/language-reference/operators/null-conditional-operators.md)
...
#### [İstenen işlem kullanılamıyor (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
## Genel Bakış
### [ML.NET nedir?](machine-learning/what-is-mldotnet.md)
### [Model eğitimi kavramları](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Kategorik özellik mühendisliği uygulama](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
### [Metin tabanlı özellik mühendisliği uygulama](machine-learning/how-to-guides/train-model-textual-ml-net.md)
...
### [Çok sayıda sütun içeren verileri yükleme](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
### [Birden çok dosyadan veri yükleme](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
### [Metin dosyasından veri yükleme](machine-learning/how-to-guides/load-data-from-text-file-ml-net.MD)
### [PredictionFunction ile bir kerede bir tahmin](machine-learning/how-to-guides/single-predict-model-ml-net.md)
...
### [Genelleştirilmiş Eklenebilir Modeller için model açıklanabilirliği kullanma](machine-learning/how-to-guides/use-gams-for-model-explainability.md)
### [Model kalitesini değerlendirmek için ölçüm kullanma](machine-learning/how-to-guides/verify-model-quality-ml-net.md)
## Başvuru
### [API Başvurusu](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
