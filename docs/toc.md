...
## [Paralel İşleme ve Eşzamanlılık](standard/parallel-processing-and-concurrency.md)
...
#### [Tür Sağlayıcılarını Kullanarak OData Hizmetine Erişim](fsharp/tutorials/type-providers/accessing-an-odata-service.md)
#### [Tür Sağlayıcılarını Kullanarak Web Hizmetine Erişim](fsharp/tutorials/type-providers/accessing-a-web-service.md)
#### [DBML Dosyasından F# Türleri Oluşturma](fsharp/tutorials/type-providers/generating-fsharp-types-from-dbml.md)
#### [EDMX Dosyasından F# Türleri Oluşturma](fsharp/tutorials/type-providers/generating-fsharp-types-from-edmx.md)
