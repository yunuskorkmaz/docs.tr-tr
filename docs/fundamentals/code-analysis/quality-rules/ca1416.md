...
Bu kural, yalnızca .NET 5,0 veya üstünü hedefleyen projeler için varsayılan olarak etkindir. Ancak, diğer çerçeveleri hedefleyen projeler için [etkinleştirebilirsiniz](#configurability) .
