...
Bu stil kuralı, Dizin oluşturucular için [expression bodies](../../../csharp/programming-guide/statements-expressions-operators/expression-bodied-members.md) blok gövdelerinin ve dizinleyicilerle ilgili kullanımını beraberinde getirir.
