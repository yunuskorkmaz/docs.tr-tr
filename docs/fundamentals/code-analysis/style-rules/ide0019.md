...
Bu stil kuralı, bir ifadenin üzerinde [pattern matching](../../../csharp/pattern-matching.md) `as` ve ardından bir denetim gelen C# deseninin kullanılması ile ilgilidir `null` .
