...
|[Listelemeler](enumerations.md)|Numaralandırmaların tanımlanmış bir adlandırılmış değerler kümesine sahip türleri olduğunu açıklar. Kodu daha okunaklı ve bakım yapılabilir hale getirmek için bunları değişmez değerler yerine kullanabilirsiniz.|
