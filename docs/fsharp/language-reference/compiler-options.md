...
|**--help**<br /><br />**-?**|Derleyici Seçenekleri kısa bir açıklaması da dahil olmak üzere kullanım bilgilerini görüntüler.|
...
|**--resource:&lt;resource-filename&gt;**|Yönetilen kaynak dosyasını oluşturulan derlemeye katıştırır.<br /><br />Bu derleyici seçeneği C# derleyici seçeneği aynı ada eşdeğerdir. Daha fazla bilgi için bkz: [ &#47;kaynak &#40;C&#35; derleyici seçenekleri&#41;](https://msdn.microsoft.com/library/c0tyye07.aspx).|
