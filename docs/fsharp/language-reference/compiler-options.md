...
ms.locfileid: "84493727"
---
# <a name="compiler-options"></a>Derleyici Seçenekleri

Bu konu, F # derleyicisi, FSC. exe için derleyici komut satırı seçeneklerini açıklar.
...
|`--out:output-filename`<br /><br />`-o:output-filename`|Derlenen derleme veya modülün adını belirtir.<br /><br />Bu derleyici seçeneği aynı ada sahip C# derleyici seçeneğine eşdeğerdir. Daha fazla bilgi için bkz. [&#47;out &#40;C&#35; derleyici seçenekleri&#41;](https://msdn.microsoft.com/library/bw3t50f3.aspx).|
...
|`--quotations-debug`|F # teklif değişmez değerleri ve yansıtılan tanımlardan türetilmiş ifadeler için ek hata ayıklama bilgilerinin yayınlanmasının gerektiğini belirtir. Hata ayıklama bilgileri bir F # ifade ağacı düğümünün özel özniteliklerine eklenir. Bkz. [kod teklifleri](code-quotations.md) ve [Expr. CustomAttributes](https://msdn.microsoft.com/library/eb89943f-5f5b-474e-b125-030ca412edb3).|
...
|`--resource:resource-filename`|Yönetilen bir kaynak dosyasını oluşturulan derlemeye gömer.<br /><br />Bu derleyici seçeneği aynı ada sahip C# derleyici seçeneğine eşdeğerdir. Daha fazla bilgi için bkz. [&#47;kaynak &#40;C&#35; derleyici seçenekleri&#41;](https://msdn.microsoft.com/library/c0tyye07.aspx).|
...
|Başlık|Açıklama|
|-----|-----------|
|[F# Etkileşimli Seçenekleri](fsharp-interactive-options.md)|F # yorumlayıcı, fsi. exe tarafından desteklenen komut satırı seçeneklerini açıklar.|
