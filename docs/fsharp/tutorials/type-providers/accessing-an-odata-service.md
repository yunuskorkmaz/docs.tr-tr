...
Açık Veri Protokolü, yani OData Internet üzerinden veri aktarımı için bir protokoldür. Birçok veri sağlayıcısı, bir OData web hizmetini yayımlayarak verilerine erişimi kullanıma sunar. F # veri türleri kullanılarak otomatik olarak oluşturulan 3.0 içinde herhangi bir OData kaynaktan veri erişim `ODataService` türü sağlayıcısı. OData hakkında daha fazla bilgi için bkz: https://msdn.microsoft.com/library/da3380cc-f6da-4c6c-bdb2-bb86afa59d62.
