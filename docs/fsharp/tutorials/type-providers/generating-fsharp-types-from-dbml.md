...
4. Ayrıca, diğer kullanılabilir komut satırı seçenekleri da bakabilirsiniz. Örneğin, görünümler ve oluşturulan türler dahil SQL işlevleri istiyorsanız kullanabileceğiniz seçenekleri vardır. Daha fazla bilgi için bkz: [SqlMetal.exe &#40;kod üretme aracı&#41;](https://msdn.microsoft.com/library/bb386987).
<br />
