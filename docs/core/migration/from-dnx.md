...
Diğer kullanıyorsanız `dnx` gibi hedefler `dnx451` olanlar da değiştirmeniz gerekir. `dnx451` değiştirilmelidir `net451`. Lütfen [.NET Standard](../../standard/net-standard.md) konusuna bakın. 
