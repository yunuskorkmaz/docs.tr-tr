...
## <a name="create-applications-with-visual-studio"></a>Visual Studio ile uygulama oluşturma

- [Merhaba Dünya konsol uygulaması oluşturma](with-visual-studio.md)
- [Merhaba Dünya uygulamanızda hata ayıklama](debugging-with-visual-studio.md)
- [Merhaba Dünya uygulamanızı yayımlama](publishing-with-visual-studio.md)
...
## <a name="build-applications-with-visual-studio-code"></a>Visual Studio Code ile uygulama oluşturma
...
## <a name="build-applications-with-visual-studio-for-mac"></a>Mac için Visual Studio ile uygulama oluşturma
