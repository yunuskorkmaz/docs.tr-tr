...
Aşağıdaki öğreticiler .NET Core hakkında bilgi almak için kullanılabilir.

## <a name="building-applications-with-visual-studio-2017"></a>Visual Studio 2017 ile uygulamaları oluşturma

- [C# Hello World uygulaması oluşturma](with-visual-studio.md)
- [C# Hello World uygulamanızın hatalarını ayıklama](debugging-with-visual-studio.md)
- [C# Hello World uygulamanızı yayımlama](publishing-with-visual-studio.md)
- [C# sınıf kitaplığı oluşturma](library-with-visual-studio.md)
- [Bir sınıf kitaplığı Visual Basic ile oluşturma](vb-library-with-visual-studio.md)
...
- [C# ve Visual Studio Code ile çalışmaya başlama](with-visual-studio-code.md)
- [MacOS üzerinde .NET Core kullanmaya başlama](using-on-macos.md)

## <a name="building-applications-with-visual-studio-for-mac"></a>Mac için Visual Studio ile uygulamaları oluşturma
...
- [.NET Core üzerinde Windows/Linux/macOS .NET Core CLI araçlarını kullanarak ile çalışmaya başlama](using-with-xplat-cli.md)
- [Düzenleme ve projeleri .NET Core CLI araçları ile test etme](testing-with-cli.md)
- [F # ile çalışmaya başlama](../../fsharp/get-started/get-started-command-line.md)

## <a name="other"></a>Diğer
- [.NET Core dotnet test kullanarak, birim sınama](../testing/unit-testing-with-dotnet-test.md)
- [Birim mstest'i ve .NET Core testi](../testing/unit-testing-with-mstest.md)
