...
* [Bir C# Hello World uygulaması ile Visual Studio 2017 .NET çekirdek oluşturma](./tutorials/with-visual-studio.md) -çok yapı, hata ayıklama ve C# ve Visual Studio 2017 kullanarak basit bir .NET Core konsol uygulaması yayımlama hakkında bilgi edinin.
...
* [Visual Basic Hello World uygulamasının Visual Studio 2017 .NET çekirdek ile yapı](./tutorials/vb-with-visual-studio.md) -çok yapı, hata ayıklama ve Visual Basic ve Visual Studio 2017 kullanarak basit bir .NET Core konsol uygulaması yayımlama hakkında bilgi edinin. 
