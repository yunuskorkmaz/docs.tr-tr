...
* <span data-ttu-id="4a9f5-119"><a name="support-vs"></a>[**Var olan projeleri ve yeni .NET Core projeler ayrı tut**][option-csproj-folder]</span><span class="sxs-lookup"><span data-stu-id="4a9f5-119"><a name="support-vs"></a>[**Keep existing projects and new .NET Core projects separate**][option-csproj-folder]</span></span>
