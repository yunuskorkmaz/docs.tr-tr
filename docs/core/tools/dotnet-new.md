...
| <span data-ttu-id="aba42-212">Blazor Sunucu uygulaması</span><span class="sxs-lookup"><span data-stu-id="aba42-212">Blazor Server App</span></span>                            | [<span data-ttu-id="aba42-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="aba42-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="aba42-214">Þ</span><span class="sxs-lookup"><span data-stu-id="aba42-214">[C#]</span></span>         | <span data-ttu-id="aba42-215">WebBlazor</span><span class="sxs-lookup"><span data-stu-id="aba42-215">Web/Blazor</span></span>                            | <span data-ttu-id="aba42-216">3,0</span><span class="sxs-lookup"><span data-stu-id="aba42-216">3.0</span></span>        |
| <span data-ttu-id="aba42-217">BlazorWebAssemblyUygulama</span><span class="sxs-lookup"><span data-stu-id="aba42-217">Blazor WebAssembly App</span></span>                       | [<span data-ttu-id="aba42-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="aba42-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="aba42-219">Þ</span><span class="sxs-lookup"><span data-stu-id="aba42-219">[C#]</span></span>         | <span data-ttu-id="aba42-220">WebBlazor/WebAssembly</span><span class="sxs-lookup"><span data-stu-id="aba42-220">Web/Blazor/WebAssembly</span></span>                | <span data-ttu-id="aba42-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="aba42-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="aba42-477">Uygulama için bir ASP.NET Core Konağı içerir Blazor WebAssembly .</span><span class="sxs-lookup"><span data-stu-id="aba42-477">Includes an ASP.NET Core host for the Blazor WebAssembly app.</span></span>
