...
|----------------------------------------------|----------------|---------------|
| Konsol uygulaması                          | konsolu        | [C#] F #, VB  |
| Sınıf kitaplığı                                | ClassLib       | [C#] F #, VB  |
| Birim testi projesi                            | mstest'i         | [C#] F #, VB  |
...
| ASP.NET Core Açısal ile                    | Açısal        | [C#]          |
| ASP.NET Core React.js ile                   | tepki          | [C#]          |
| ASP.NET Core React.js ve Redux         | reactredux     | [C#]          |
| ASP.NET Core Web API'si                         | webapı         | [C#] F #      |
...
[Dotnet için özel bir şablon yeni oluştur](~/docs/core/tutorials/create-custom-template.md)  
