...
Klasörü çıktı derlemelerinin nereye yerleştireceğinizi belirtir... Çıktı derlemelerinin (ve diğer çıktı dosyaları) ilgili framework klasörlerine kopyalanır.
