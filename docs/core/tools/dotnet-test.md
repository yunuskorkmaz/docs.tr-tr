...
Testleri çalıştırmak için kullanılacak dosya.`.runsettings` [Birim testlerini bir `.runsettings` dosya kullanarak yapılandırın.](/visualstudio/test/configure-unit-tests-by-using-a-dot-runsettings-file)
