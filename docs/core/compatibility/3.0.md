...
---
# <a name="breaking-changes-in-net-core-30"></a>.NET Core 3,0 'deki son değişiklikler

.NET Core 'un 3,0 sürümüne geçiş yapıyorsanız, ASP.NET Core veya EF Core, bu makalede listelenen son değişiklikler uygulamanızı etkileyebilir.
...
- [GroupCollection 'ı IEnumerable alan genişletme yöntemlerine geçirme, \<T> Kesinleştirme gerektirir](#passing-groupcollection-to-extension-methods-taking-ienumerablet-requires-disambiguation)
