...
Aşağıdaki sürüm ve alan seçicileri, .NET Core 'un farklı sürümleri, ASP.NET Core ve EF Core arasındaki ilgili önemli değişikliklerin filtrelenmiş bir listesini sağlar. Ayrıca, içindekiler tablosundaki sürümden sürüme veya teknoloji alanı makalelerine göz atabilirsiniz.
...
## <a name="by-technology-area"></a>Teknoloji alanından
...
## <a name="github-issues-and-announcements"></a>GitHub sorunları ve duyuruları

Ayrıca, aşağıdaki GitHub depolarında .NET Core 'da ortaya çıkan son değişiklikleri ayrıntılı olarak görebilirsiniz:
...
- [.NET Framework 'den .NET Core 'a geçiş](../porting/index.md)
