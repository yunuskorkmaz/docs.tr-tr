...
Bu tür kullanır *otomatik uygulanan salt okunur özellikler* oluşturucuda ayarlayın ve sonra değiştirilemez. Bu ayrıca yeni kullanır *dize ilişkilendirme* biçim dizesi çıkışı kolaylaştırır özelliği.
