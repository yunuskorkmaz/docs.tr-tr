...
* [REST istemcisi](console-webapiclient.md): web iletişimi, JSON seri hale getirme ve C# dilinde nesne yönelimli özellikleri gösterir.
...
* [Dize ilişkilendirme](string-interpolation.md): kullanımları birçoğu gösteren `$` dize ilişkilendirme C#.

* [Öznitelikleri kullanarak](attributes.md): oluşturma ve özniteliklerini C# kullanın.
