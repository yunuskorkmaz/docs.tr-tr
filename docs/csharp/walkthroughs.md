...
---
# <a name="c-walkthroughs"></a>C#yollarda
...
- [Izlenecek yol: tasarımcı eylemlerini kullanarak ortak görevleri gerçekleştirme](../framework/winforms/controls/perform-common-tasks-design-actions.md)\
...
- [(LINQ)\ sorgu yazma C# ](./programming-guide/concepts/linq/walkthrough-writing-queries-linq.md)
...
- \ [görselleştiricisi C# yazma](/visualstudio/debugger/walkthrough-writing-a-visualizer-in-csharp)
