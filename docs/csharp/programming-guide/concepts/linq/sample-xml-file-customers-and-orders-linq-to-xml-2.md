...
---
# <a name="sample-xml-file-customers-and-orders-linq-to-xml"></a><span data-ttu-id="9db90-102">Örnek XML Dosyası: Müşteriler ve Siparişler (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="9db90-102">Sample XML File: Customers and Orders (LINQ to XML)</span></span>
<span data-ttu-id="9db90-103">Aşağıdaki XML dosyası [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] belgelerdeki çeşitli örneklerde kullanılır.</span><span class="sxs-lookup"><span data-stu-id="9db90-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="9db90-104">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="9db90-104">This file contains customers and orders.</span></span>  
  
 <span data-ttu-id="9db90-105">Konu [Örnek XSD Dosyası: Müşteriler ve Siparişler,](./sample-xsd-file-customers-and-orders1.md) bu belgeyi doğrulamak için kullanılabilecek bir XSD içerir.</span><span class="sxs-lookup"><span data-stu-id="9db90-105">The topic [Sample XSD File: Customers and Orders](./sample-xsd-file-customers-and-orders1.md) contains an XSD that can be used to validate this document.</span></span> <span data-ttu-id="9db90-106">XSD'nin `xs:key` `xs:keyref` özelliklerini, `CustomerID` `Customer` öğenin özniteliğinin bir anahtar olduğunu belirlemek ve her `CustomerID` `Order` öğedeki `CustomerID` öğe ile öznitelik `Customer` arasında bir ilişki kurmak için kullanır.</span><span class="sxs-lookup"><span data-stu-id="9db90-106">It uses the `xs:key` and `xs:keyref` features of XSD to establish that the `CustomerID` attribute of the `Customer` element is a key, and to establish a relationship between the `CustomerID` element in each `Order` element and the `CustomerID` attribute in each `Customer` element.</span></span>  
  
 <span data-ttu-id="9db90-107">`Join` Yan tümceyi kullanarak bu ilişkiden yararlanan LINQ sorguları yazma örneği için [bkz.](./how-to-join-two-collections-linq-to-xml.md)</span><span class="sxs-lookup"><span data-stu-id="9db90-107">For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to join two collections (LINQ to XML) (C#)](./how-to-join-two-collections-linq-to-xml.md).</span></span>  
  
## <a name="customersordersxml"></a><span data-ttu-id="9db90-108">MüşterilerSiparişler.xml</span><span class="sxs-lookup"><span data-stu-id="9db90-108">CustomersOrders.xml</span></span>  
