...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="7e55c-102">Örnek XML Dosyası: Bir Ad Alanında Müşteriler ve Siparişler</span><span class="sxs-lookup"><span data-stu-id="7e55c-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="7e55c-103">Aşağıdaki XML dosyasını çeşitli örneklerde kullanılan [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] belgeleri.</span><span class="sxs-lookup"><span data-stu-id="7e55c-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="7e55c-104">Bu dosya, müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="7e55c-104">This file contains customers and orders.</span></span> <span data-ttu-id="7e55c-105">Bir ad alanında XML'dir.</span><span class="sxs-lookup"><span data-stu-id="7e55c-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="7e55c-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="7e55c-106">CustomersOrdersInNamespace.xml</span></span>  
