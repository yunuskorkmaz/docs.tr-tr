...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="290a7-102">Örnek XML Dosyası: Bir Ad Alanında Müşteriler ve Siparişler</span><span class="sxs-lookup"><span data-stu-id="290a7-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="290a7-103">Aşağıdaki XML dosyası [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] belgelerdeki çeşitli örneklerde kullanılır.</span><span class="sxs-lookup"><span data-stu-id="290a7-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="290a7-104">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="290a7-104">This file contains customers and orders.</span></span> <span data-ttu-id="290a7-105">XML bir ad alanında.</span><span class="sxs-lookup"><span data-stu-id="290a7-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="290a7-106">MüşterilerOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="290a7-106">CustomersOrdersInNamespace.xml</span></span>  
