...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="3ea8d-105">Örnek XML Dosyası: Bir Ad Alanında Müşteriler ve Siparişler</span><span class="sxs-lookup"><span data-stu-id="3ea8d-105">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="3ea8d-106">Aşağıdaki XML dosyası belgelerindeki çeşitli örneklerde kullanılır [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] .</span><span class="sxs-lookup"><span data-stu-id="3ea8d-106">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="3ea8d-107">Bu dosya müşteriler ve siparişler içerir.</span><span class="sxs-lookup"><span data-stu-id="3ea8d-107">This file contains customers and orders.</span></span> <span data-ttu-id="3ea8d-108">XML bir ad alanıdır.</span><span class="sxs-lookup"><span data-stu-id="3ea8d-108">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="3ea8d-109">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="3ea8d-109">CustomersOrdersInNamespace.xml</span></span>  
