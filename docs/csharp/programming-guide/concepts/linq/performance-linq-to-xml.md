...
## <a name="in-this-section"></a>Bu Bölümde  
 [Performans zincirleme sorgu (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/performance-of-chained-queries-linq-to-xml.md)  
 ...
 [Parçalara ayırma öncesi XName nesneleri (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)  
 ...
 [Sorgular (LINQ to XML)'statik olarak derlenmiş (C#)](../../../../csharp/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)  
