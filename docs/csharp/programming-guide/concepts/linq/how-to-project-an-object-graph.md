...
```  
 ...
 <span data-ttu-id="8823d-109">Bu örnek aşağıdaki çıktıyı üretir:</span><span class="sxs-lookup"><span data-stu-id="8823d-109">The example produces the following output:</span></span>  
