...
---
# <a name="no-locjoin-operations-c"></a><span data-ttu-id="77bb6-104">Joinİşlemler (C#)</span><span class="sxs-lookup"><span data-stu-id="77bb6-104">Join Operations (C#)</span></span>
...
|-----------------|-----------------|---------------------------------|----------------------|  
|Join|<span data-ttu-id="77bb6-122">Joinanahtar Seçici işlevlerine dayanan ve değer çiftlerini çıkaran iki sıra.</span><span class="sxs-lookup"><span data-stu-id="77bb6-122">Joins two sequences based on key selector functions and extracts pairs of values.</span></span>|`join … in … on … equals …`|<xref:System.Linq.Enumerable.Join%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Join%2A?displayProperty=nameWithType>|  
|GroupJoin|<span data-ttu-id="77bb6-123">Joiniki sıra, anahtar Seçici işlevlerine dayalıdır ve her öğe için elde edilen eşleşmeleri gruplandırır.</span><span class="sxs-lookup"><span data-stu-id="77bb6-123">Joins two sequences based on key selector functions and groups the resulting matches for each element.</span></span>|`join … in … on … equals … into …`|<xref:System.Linq.Enumerable.GroupJoin%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.GroupJoin%2A?displayProperty=nameWithType>|  
...
- [<span data-ttu-id="77bb6-130">JoinVe çoklu ürün sorgularını formüller</span><span class="sxs-lookup"><span data-stu-id="77bb6-130">Formulate Joins and Cross-Product Queries</span></span>](../../../../framework/data/adonet/sql/linq/formulate-joins-and-cross-product-queries.md)
...
- [<span data-ttu-id="77bb6-132">Joinbileşik anahtarlar kullanarak</span><span class="sxs-lookup"><span data-stu-id="77bb6-132">Join by using composite keys</span></span>](../../../linq/join-by-using-composite-keys.md)
