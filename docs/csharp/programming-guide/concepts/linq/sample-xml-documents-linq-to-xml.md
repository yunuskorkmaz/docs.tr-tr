...
|[Örnek XML dosyası: Bir Namespace, tipik satın alma siparişi](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)|Bir ad alanında tipik satın alma siparişi içeren bir XML belgesi.|  
...
|[Örnek XML dosyası: Bir Namespace, birden fazla satın alma siparişi](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)|Bir XML belgesi birden çok içeren bir ad alanında satınalma siparişleri.|  
...
|[Örnek XML dosyası: Bir Namespace, test yapılandırması](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-in-a-namespace1.md)|Bazı sahte test yapılandırma verilerini içeren bir ad alanında bir XML belgesi.|  
...
|[Örnek XML dosyası: Bir Namespace alanında müşteriler ve siparişler](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)|Müşteriler ve siparişler içeren bir ad alanında bir XML belgesi.|  
...
|[Örnek XML dosyası: Bir Namespace alanında sayısal veriler](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-in-a-namespace.md)|Veri toplama ve Gruplama için uygun içeren bir ad alanında bir XML belgesi.|  
