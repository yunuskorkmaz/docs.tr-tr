...
|Konu|Açıklama|  
|-----------|-----------------|  
|[Nasıl yapılır: XmlSerializer (C#) kullanarak serileştirme](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)|Kullanarak serileştirme gösterilmektedir <xref:System.Xml.Serialization.XmlSerializer>.|  
|[Nasıl yapılır: DataContractSerializer (C#) kullanarak serileştirme](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)|Kullanarak serileştirme gösterilmektedir <xref:System.Runtime.Serialization.DataContractSerializer>.|  
