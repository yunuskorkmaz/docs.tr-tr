...
ms.locfileid: "66483715"
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace"></a><span data-ttu-id="4ab30-102">Örnek XML Dosyası: Bir Ad Alanında Birden Fazla Satın Alma Siparişi</span><span class="sxs-lookup"><span data-stu-id="4ab30-102">Sample XML File: Multiple Purchase Orders in a Namespace</span></span>
<span data-ttu-id="4ab30-103">Aşağıdaki XML dosyasını çeşitli örneklerde kullanılan [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] belgeleri.</span><span class="sxs-lookup"><span data-stu-id="4ab30-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="4ab30-104">Bu dosya, çeşitli satın alma siparişleri içerir.</span><span class="sxs-lookup"><span data-stu-id="4ab30-104">This file contains several purchase orders.</span></span> <span data-ttu-id="4ab30-105">Bir ad alanında XML'dir.</span><span class="sxs-lookup"><span data-stu-id="4ab30-105">The XML is in a namespace.</span></span>  
  
## <a name="purchaseordersinnamespacexml"></a><span data-ttu-id="4ab30-106">PurchaseOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="4ab30-106">PurchaseOrdersInNamespace.xml</span></span>  
