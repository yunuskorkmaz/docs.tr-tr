...
description: Bu XSD dosyası LINQ to XML belgelerindeki çeşitli örneklerde kullanılır. Müşteriler ve siparişler içeren örnek bir XML dosyası için bir şema tanımıdır.
ms.date: 07/20/2015
