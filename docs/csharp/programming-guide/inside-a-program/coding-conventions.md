...
- [Foreach](../../language-reference/keywords/foreach-in.md) Döngülerde döngü değişkeninin türünü öğrenmek için örtük yazma kullanmayın.
     ...
     Aşağıdaki örnek, `foreach` bildiriminde açık bir yazma kullanır.

     [!code-csharp[csProgGuideCodingConventions#12](../../../../samples/snippets/csharp/VS_Snippets_VBCSharp/csprogguidecodingconventions/cs/program.cs#12)]

     > [!NOTE]
     > Yinelenebilir bir koleksiyonun öğe türünü yanlışlıkla değiştirmemeye dikkat edin. Örneğin, bir sorgunun yürütülmesini değiştiren bir `foreach` deyimindeki <xref:System.Collections.IEnumerable?displayProperty=nameWithType> <xref:System.Linq.IQueryable?displayProperty=nameWithType> geçiş yapmak kolaydır.
