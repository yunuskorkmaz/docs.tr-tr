...
|Başlık|Açıklama|  
|-----------|-----------------|  
|[Nasıl yapılır: Başvuru Eşitliği Testi (Kimlik)](../../../csharp/programming-guide/statements-expressions-operators/how-to-test-for-reference-equality-identity.md)|İki değişkenin başvuru eşitliğine sahip olup olmadığını belirlemek açıklar.|  
