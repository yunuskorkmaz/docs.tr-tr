...
## <a name="operator-precedence-and-associativity"></a>İşleç önceliği ve ilişkilendirilebilirlik  
 Bir ifadenin değerlendirilme şekli, birleşim ve işleç önceliği kurallarına tabidir. Daha fazla bilgi için bkz. [işleçler](./operators.md).  
...
## <a name="query-expressions"></a>Sorgu ifadeleri  
 Genel içindeki ifadelerle ilgili kuralların aynı kuralları sorgu ifadeleri için de geçerlidir. Daha fazla bilgi için bkz. [LINQ sorgu ifadeleri](../linq-query-expressions/index.md).  
