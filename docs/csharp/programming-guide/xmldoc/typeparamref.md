...
## <a name="remarks"></a>Açıklamalar  
 Genel türler ve yöntemler tür parametreleri hakkında daha fazla bilgi için bkz. [genel türler](../../../csharp/programming-guide/generics/index.md).  
  
 Soubor dokumentace tüketicilerinin bazı farklı bir yolla, örneğin italik sözcüğü biçimlendirmek etkinleştirmek için bu etiketi kullanın.  
