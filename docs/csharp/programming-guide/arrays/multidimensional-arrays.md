...
## <a name="array-initialization"></a>Dizi başlatma
 ...
 Başlatma olmadan bir dizi değişkeni tanımlamayı seçerseniz, değişkenine bir dizi atamak için `new` işlecini kullanmanız gerekir. Öğesinin `new` kullanımı aşağıdaki örnekte gösterilmiştir.  
