...
```  
 ...
 <span data-ttu-id="5a535-109">İçinde `Main` yöntemi, değişkenleri `bc`, `dc`, ve `bcdc`.</span><span class="sxs-lookup"><span data-stu-id="5a535-109">In the `Main` method, declare variables `bc`, `dc`, and `bcdc`.</span></span>  
