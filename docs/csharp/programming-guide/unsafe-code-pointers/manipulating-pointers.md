---
title: İşaretçileri İşleme (C# Programlama Kılavuzu)
ms.date: 07/20/2015
helpviewer_keywords:
...
Bu bölüm, aşağıdaki işaretçi işlemleri içerir:  
 ...
 [Artırma ve azaltma](../../../csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)  
  
 [Aritmetik işlemler](../../../csharp/programming-guide/unsafe-code-pointers/arithmetic-operations-on-pointers.md)  
  
 [Karşılaştırma](../../../csharp/programming-guide/unsafe-code-pointers/pointer-comparison.md)  
