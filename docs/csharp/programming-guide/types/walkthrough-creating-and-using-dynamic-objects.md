...
4. **Araştır** sekmesinde, IronPython kitaplıklarının yüklendiği klasöre gidin. Örneğin, .NET Framework 4,0 için C:\Program Files\ıronpython 2,6. **IronPython.dll**, **IronPython.Modules.dll**, **Microsoft.Scripting.dll** ve **Microsoft.Dynamic.dll** kitaplıklarını seçin. **Tamam** düğmesine tıklayın.
