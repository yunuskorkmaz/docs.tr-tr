...
Gereksinim duyduğunuz [IronPython](https://ironpython.net/) Bu izlenecek yolu tamamlamak .NET için. Git, [indirme sayfası](https://ironpython.net/download/) en güncel sürümü edinmek için.
