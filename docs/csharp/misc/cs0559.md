...
İçin parametre türü ++ veya--işleci içeren türde olması gerekir  
  
 İşleç aşırı yüklemesi için yöntem bildirimi belirli yönergeleri izlemeniz gerekir. İçin ++ ve--işleçleri gereklidir, parametre aynı türde içinde işleci aşırı yüklenmiş olmalıdır.  
