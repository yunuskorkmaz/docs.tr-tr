...
Out parametresi '[In]' özniteliği olamaz  
  
 Şu anda **içinde** özniteliği üzerinde izin verilmez bir [çıkışı](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametresi.  
