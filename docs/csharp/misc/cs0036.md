...
Out parametresi '[In]' özniteliğine sahip olamaz  
  
 Şu anda **içinde** özniteliği izin verilmez bir [kullanıma](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametresi.  
