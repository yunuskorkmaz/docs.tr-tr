...
'özniteliği değiştiricisi' Bu bildirim için geçerli öznitelik konumu değil. Bu bildirim için geçerli öznitelik konumları ' konumlarının '. Bu bloktaki tüm öznitelikler yoksayılacak.  
 ...
 Derleyici bir öznitelik değiştiricisi geçersiz bir konumda bulunamadı. Bkz: [öznitelik hedefleri](http://msdn.microsoft.com/en-us/59a261f0-1cfb-4aa5-b610-6b735389882c) daha fazla bilgi için.  
