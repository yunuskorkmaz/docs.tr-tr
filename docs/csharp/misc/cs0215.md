...
Kullanıcı tanımlı [true ve false](../language-reference/operators/true-false-operators.md) işleçleri, dönüş türü olmalıdır [bool](../language-reference/keywords/bool.md).
