...
' % S'olayı 'event' yalnızca += veya-= işaretlerinin sol tarafında görünebilir  
  
 Bir [olay](../../csharp/language-reference/keywords/event.md) hatalı çağrıldı. Daha fazla bilgi için [olayları](../../csharp/programming-guide/events/index.md) ve [Temsilciler](../../csharp/programming-guide/delegates/index.md).  
