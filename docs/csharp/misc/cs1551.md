...
Dizin oluşturucular en az bir parametresi olmalıdır  
  
 Bir [dizin oluşturucu](../../csharp/programming-guide/indexers/index.md) alır bağımsız değişkenler bildirilmedi.  
