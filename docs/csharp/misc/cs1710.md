...
'Type' üzerindeki XML açıklamasında 'parametresi' için yinelenen typeparam etiketi var  
  
 Belgelere genel bir türün tür parametresi için yinelenen bir etiket içerir.  
  
## <a name="example"></a>Örnek  
 Aşağıdaki kodu, görüntülenecek CS1710 uyarısına neden olur.  
