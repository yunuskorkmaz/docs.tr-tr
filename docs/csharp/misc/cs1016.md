...
Adlandırılmış öznitelik bağımsız değişkeni bekleniyor  
  
 Adlandırılmamış öznitelik bağımsız değişkenleri, adlandırılmış bağımsız değişkenlerden önce gelmelidir.  
