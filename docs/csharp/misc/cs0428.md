...
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="c0607-102">Derleyici Hatası CS0428</span><span class="sxs-lookup"><span data-stu-id="c0607-102">Compiler Error CS0428</span></span>
<span data-ttu-id="c0607-103">Yöntem Grup 'türü 'type' temsilci tanımlayıcısı' dönüştürülemiyor.</span><span class="sxs-lookup"><span data-stu-id="c0607-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="c0607-104">Yöntemini çağırmak istiyordunuz?</span><span class="sxs-lookup"><span data-stu-id="c0607-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="c0607-105">Temsilci olmayan türü veya parantez kullanmadan bir yöntemi çağırmak çalışırken yöntemi grubu dönüştürme bu hata oluşur.</span><span class="sxs-lookup"><span data-stu-id="c0607-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="c0607-106">Örnek</span><span class="sxs-lookup"><span data-stu-id="c0607-106">Example</span></span>  
 <span data-ttu-id="c0607-107">Aşağıdaki örnek CS0428 oluşturur:</span><span class="sxs-lookup"><span data-stu-id="c0607-107">The following sample generates CS0428:</span></span>  
