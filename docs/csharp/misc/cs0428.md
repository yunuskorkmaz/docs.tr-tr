...
' Identifier ' Yöntem grubu temsilci olmayan ' Type ' türüne dönüştürülemiyor.  Yöntemi çağırmak mı istiyordunuz?  
  
 Bu hata, bir yöntem grubunu temsilci olmayan bir türe dönüştürürken veya parantez kullanılmadan bir yöntemi çağırmaya çalıştığında oluşur.  
