...
Türü 'type' temsilci ' Identifier' yöntem grubu dönüştürülemiyor.  Bir yöntemi çağırmak mı istiyordunuz?  
  
 Bir yöntem grubu bir temsilci olmayan türüne veya parantez kullanmadan bir yöntem çağrılmaya çalışılırken dönüştürme yaparken bu hata oluşur.  
