...
Tür iletici 'assembly' derlemesindeki ' type' türünün bir döngüye neden oluyor  
  
 Bu hata yalnızca Düzensiz biçimlendirilmiş içeri aktarılan meta verileriyle oluşabilir. Yalnızca C# kaynağı ile gerçekleşemez.  
  
## <a name="example"></a>Örnek  
 Aşağıdaki örnek CS0731 oluşturur. Örneğin, üç dosyaları içerir:  
 ...
 İlk derleyin. IL dosyaları kitaplıkları ve ardından derleme iki dosya başvuran .cs kod olarak.  
