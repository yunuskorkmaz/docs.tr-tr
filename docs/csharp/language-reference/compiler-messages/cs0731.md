...
---
# <a name="compiler-error-cs0731"></a>Derleyici Hatası CS0731

' Assembly ' derlemesinde ' Type ' türü için tür ileticisi bir döngüye neden oluyor  
  
 Bu hata yalnızca hatalı oluşturulmuş içeri aktarılan meta veriler ile oluşabilir. Yalnızca C# kaynağı ile gerçekleştirilemez.  
  
## <a name="example"></a>Örnek  

 Aşağıdaki örnek CS0731 oluşturur. Örnek üç dosyadan oluşur:  
 ...
 İlk olarak derleyin. Dosyaları kitaplık olarak derleyin ve ardından iki dosyaya başvuran. cs kodunu derleyin.  
