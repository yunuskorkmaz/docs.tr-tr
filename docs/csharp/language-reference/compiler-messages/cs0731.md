...
Montaj 'derleme' türü 'tip' için tip iletme bir döngü neden olur  
  
 Bu hata yalnızca yanlış biçimlendirilmiş içe aktarılan meta verilerle oluşabilir. Yalnızca C# kaynağıile oluşamaz.  
...
## <a name="example"></a>Örnek  
 ...
 İlk derle . IL kitaplıklar olarak dosyaları ve sonra iki dosya başvuru.cs kodu derlemek.  
