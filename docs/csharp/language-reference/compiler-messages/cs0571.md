...
'function' : operatör veya aksesuarı açıkça arayamaz  
  
 Bazı operatörlerin iç adları vardır. Örneğin, **op_Increment** ++ işlecinin iç adıdır. Bu tür yöntem adlarını kullanmamalı veya açıkça aramamalısınız.  
