...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="bd2fa-102">Derleyici Hatası CS0015</span><span class="sxs-lookup"><span data-stu-id="bd2fa-102">Compiler Error CS0015</span></span>
<span data-ttu-id="bd2fa-103">Türü 'type' adı çok uzun.</span><span class="sxs-lookup"><span data-stu-id="bd2fa-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="bd2fa-104">Kullanıcı tanımlı bir tür tam adını dönemler dahil olmak üzere, 1024'ten az karakter olmalıdır.</span><span class="sxs-lookup"><span data-stu-id="bd2fa-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="bd2fa-105">Aşağıdaki örnek CS0015 oluşturur:</span><span class="sxs-lookup"><span data-stu-id="bd2fa-105">The following sample generates CS0015:</span></span>  
