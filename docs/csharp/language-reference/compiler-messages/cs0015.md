...
ms.locfileid: "33210288"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="801cb-102">Derleyici Hatası CS0015</span><span class="sxs-lookup"><span data-stu-id="801cb-102">Compiler Error CS0015</span></span>
<span data-ttu-id="801cb-103">Türü 'type' adı çok uzun.</span><span class="sxs-lookup"><span data-stu-id="801cb-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="801cb-104">Kullanıcı tanımlı bir tür tam adını dönemler dahil olmak üzere, 1024'ten az karakter olmalıdır.</span><span class="sxs-lookup"><span data-stu-id="801cb-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="801cb-105">Aşağıdaki örnek CS0015 oluşturur:</span><span class="sxs-lookup"><span data-stu-id="801cb-105">The following sample generates CS0015:</span></span>  
