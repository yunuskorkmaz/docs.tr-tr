...
ms.locfileid: "71332101"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="ed3ec-102">Derleyici Hatası CS0015</span><span class="sxs-lookup"><span data-stu-id="ed3ec-102">Compiler Error CS0015</span></span>

<span data-ttu-id="ed3ec-103">' Type ' türünün adı çok uzun</span><span class="sxs-lookup"><span data-stu-id="ed3ec-103">The name of type 'type' is too long</span></span>

 <span data-ttu-id="ed3ec-104">Kullanıcı tanımlı bir türün tam adı, noktalar dahil 1024 karakterden kısa olmalıdır.</span><span class="sxs-lookup"><span data-stu-id="ed3ec-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="ed3ec-105">Aşağıdaki örnek CS0015 oluşturur:</span><span class="sxs-lookup"><span data-stu-id="ed3ec-105">The following sample generates CS0015:</span></span>
