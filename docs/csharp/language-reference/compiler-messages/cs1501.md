...
Hiçbir aşırı yüklemesi 'yöntemi' yönteminin 'numara' bağımsız değişkenleri alır  
  
 Sınıf yöntemine bir çağrı yapıldı, ancak belirtilen sayıda bağımsız değişken tanımı yok yönteminin alır.  
