...
|[-lib](../../../csharp/language-reference/compiler-options/lib-compiler-option.md)|Tarafından başvurulan derlemelerin konumunu belirtir [-başvuru](../../../csharp/language-reference/compiler-options/reference-compiler-option.md).|  
...
|[-Yardım](../../../csharp/language-reference/compiler-options/help-compiler-option.md)|Stdout derleyici seçenekleri listeler.|  
