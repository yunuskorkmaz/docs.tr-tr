...
Aşağıdaki derleyici seçenekleri alfabetik olarak sıralanır. Kategorik bir liste için, bkz. [kategoriye göre listelenen C# derleyici seçenekleri](listed-by-category.md).
...
|[-Hata Ayıkla](debug-compiler-option.md)|Hata ayıklama bilgilerini yayar.|
...
|hata günlüğü\<file>|Tüm derleyici ve çözümleyici tanılamayı günlüğe kaydetmek için bir dosya belirtin.|
...
|[langversion\<string>](langversion-compiler-option.md)|Dil sürümünü belirtin: varsayılan, ISO-1, ISO-2, 3, 4, 5, 6, 7, 7,1, 7,2, 7,3 veya en son |
...
|[-başvuru](reference-compiler-option.md)|Belirtilen derleme dosyalarından meta verilere başvurur.|
