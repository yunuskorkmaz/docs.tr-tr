...
.NET Framework kaynağına bağlantı çıktı dosyasında oluşturur. Kaynak dosyanın çıkış dosyasına eklenmez. Bu farklıdır [/Resource](../../../csharp/language-reference/compiler-options/resource-compiler-option.md) kaynak dosyasını çıktı dosyasına katıştırma seçeneği.  
 ...
 **/ linkresource** birini gerektirir [/target](../../../csharp/language-reference/compiler-options/target-compiler-option.md) dışında seçenekleri **/target: Module**.  
