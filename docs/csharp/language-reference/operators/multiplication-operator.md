...
Çarpma işleci (`*`), işlenenleri çarpımını hesaplar.  Okuma ve yazma için bir işaretçi sağlayan Ayrıca, başvuru işleci.  
  
## <a name="remarks"></a>Açıklamalar  
 Tüm sayısal türler çarpma işleçleri önceden.  
