...
## <a name="remarks"></a>Açıklamalar  
 Kullanıcı tanımlı türler aşırı yükleme `<` işleci (bkz [işleci](../../../csharp/language-reference/keywords/operator.md)). Varsa `<` aşırı yüklendi [ > ](../../../csharp/language-reference/operators/greater-than-operator.md) da aşırı yüklenmiş gerekir.
