...
|[(T)x](type-testing-and-conversion-operators.md#cast-operator-)|Atama işleci aşırı yüklenemez, ancak yeni dönüştürme işleçleri tanımlayabilirsiniz (bkz [açık](../keywords/explicit.md) ve [örtük](../keywords/implicit.md)).|
