...
|----------|-----------------------|---------------|-------------------------|  
|`float`|-3.4 × 10<sup>38</sup> +3.4 × 10<sup>38</sup>|7 basamakla|<xref:System.Single?displayProperty=nameWithType>|  
...
- Kayan nokta türlerinden biri ise [çift](double.md), ifadenin değerlendirdiği [çift](double.md) veya [bool](bool.md) ilişkisel veya Boolean ifadeler içinde.

- Yoksa hiçbir [çift](double.md) değerlendirilen ifade ifadenin türü `float` veya [bool](bool.md) ilişkisel veya Boolean ifadeler içinde.
