...
Aşağıdaki örnekte, bir [int](../builtin-types/integral-numeric-types.md), [kısa](../../../csharp/language-reference/builtin-types/integral-numeric-types.md), [float](../../../csharp/language-reference/keywords/float.md)ve `double` vererek birlikte eklenen bir `double` sonucu.
