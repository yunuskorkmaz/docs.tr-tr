...
Burada tabi atık koleksiyonu olması gerekmez ve bu nedenle sabitlenmiş gerekmez yığında bellek ayırabilirsiniz. Kullanan yapmak için [ `stackalloc` işleci](../operators/stackalloc.md).
