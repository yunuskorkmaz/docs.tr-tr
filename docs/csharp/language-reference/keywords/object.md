...
## <a name="example"></a>Örnek  
 Aşağıdaki örnekte gösterildiği nasıl türündeki değişkenler `object` herhangi bir veri türü değerlerini kabul edebilir ve nasıl türündeki değişkenler `object` yöntemlerini kullanabilirsiniz <xref:System.Object> .NET çerçeveden.  
