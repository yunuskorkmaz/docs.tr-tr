...
- [null birleşim işlecinin](../operators/null-conditional-operator.md). Aşağıdaki örnekte, bir `throw` ifadesi null birleşim işlecinin ile dize için atanmışsa bir özel durum için kullanılan bir `Name` özelliği `null`.
