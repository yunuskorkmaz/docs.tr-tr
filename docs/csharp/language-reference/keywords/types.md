...
-   [İşaretçi türleri](../../../csharp/programming-guide/unsafe-code-pointers/pointer-types.md)  
 ...
 Değer türleri olan değişkenler verileri depolamak ve başvuru türleri olan depolama başvurularının gerçek veriler. Başvuru türleri, nesneleri olarak da adlandırılır. İşaretçi türleri yalnızca kullanılabilir [güvenli](../../../csharp/language-reference/keywords/unsafe.md) modu.  
 ...
 Değer türleri de ek bir değer olmayan durum depolayabilecekleri anlamına gelir boş değer atanabilir,. Daha fazla bilgi için [boş değer atanabilir türler](../../../csharp/programming-guide/nullable-types/index.md).  
