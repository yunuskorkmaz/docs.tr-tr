...
Aşağıdaki başvuru tablolarda C# türleri özetlenmektedir:  
 ...
 [Varsayılan değerler](../../../csharp/language-reference/keywords/default-values-table.md)  
  
 [Değer türleri](../../../csharp/language-reference/keywords/value-types-table.md)  
  
 [Örtük sayısal dönüşümler](../../../csharp/language-reference/keywords/implicit-numeric-conversions-table.md)  
