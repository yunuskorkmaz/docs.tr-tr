...
Bu bölümde kısa, hızlı bir şekilde olanak tanıyan basit öğreticiler C# ve .NET Core kullanarak uygulama oluşturun. Visual Studio 2017 ve Visual Studio Code için başlangıç konuları var. hazırlanıyoruz. Ya da basit bir Hello World uygulaması oluşturabilir veya Visual Studio 2017, diğer uygulamalar tarafından kullanılabilen bir basit sınıf kitaplığı varsa.
