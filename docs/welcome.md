...
ms.locfileid: "33656083"
---
# <a name="welcome-to-net"></a>.NET için Hoş Geldiniz

Bkz: [.NET Core'u kullanmaya başlama](core/get-started.md) .NET Core uygulamaları oluşturmayı öğrenmek için.
...
- [.NET Framework 4.7.2 tanışın](https://blogs.msdn.microsoft.com/dotnet/2018/04/30/announcing-the-net-framework-4-7-2/)
- [.NET Core 2.1 önizleme 2 Duyurusu](https://blogs.msdn.microsoft.com/dotnet/2018/04/11/announcing-net-core-2-1-preview-2/)
- [ASP.NET Core 2.1.0-preview2 artık kullanılabilir](https://blogs.msdn.microsoft.com/webdev/2018/04/12/asp-net-core-2-1-0-preview2-now-available/)
- [Entity Framework Çekirdek 2.1 önizleme 2 Duyurusu](https://blogs.msdn.microsoft.com/dotnet/2018/04/11/announcing-entity-framework-core-2-1-preview-2/)
- [Visual Studio 2017 sürüm 15,6, Visual Studio sürümü 7.4 Mac için yayımlanan](https://blogs.msdn.microsoft.com/visualstudio/2018/03/06/visual-studio-2017-version-15-6-visual-studio-for-mac-version-7-4-released/)
- [C# 7.2 ve Span Hoş Geldiniz](https://blogs.msdn.microsoft.com/dotnet/2017/11/15/welcome-to-c-7-2-and-span/)
...
Bu belgesidir tamamen [açık kaynak](https://github.com/dotnet/docs). Belgeleri yazma sorunları oluşturma gibi herhangi bir şekilde katkıda bulunabilirsiniz.  Ayrıca, .NET kendisini çoğunu de açık kaynaklıdır şöyledir:
