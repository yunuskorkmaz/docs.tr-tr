...
---
### <a name="parameter-names-changed-in-reference-assemblies"></a><span data-ttu-id="e5e31-101">Başvuru derlemelerindeki parametre adları değiştirildi</span><span class="sxs-lookup"><span data-stu-id="e5e31-101">Parameter names changed in reference assemblies</span></span>

<span data-ttu-id="e5e31-102">Bazı başvuru derleme parametresi adları, uygulama derlemelerindeki parametre adlarıyla eşleşecek şekilde değiştirilmiştir.</span><span class="sxs-lookup"><span data-stu-id="e5e31-102">Some reference assembly parameter names have changed to match parameter names in the implementation assemblies.</span></span>

#### <a name="change-description"></a><span data-ttu-id="e5e31-103">Açıklamayı Değiştir</span><span class="sxs-lookup"><span data-stu-id="e5e31-103">Change description</span></span>

<span data-ttu-id="e5e31-104">Önceki .NET sürümlerinde, bazı [Başvuru derleme](../../../../docs/standard/assembly/reference-assemblies.md) parametresi adları, uygulama derlemesinde karşılık gelen parametrelere farklıdır.</span><span class="sxs-lookup"><span data-stu-id="e5e31-104">In previous .NET versions, some [reference assembly](../../../../docs/standard/assembly/reference-assemblies.md) parameter names are different to their corresponding parameters in the implementation assembly.</span></span> <span data-ttu-id="e5e31-105">Bu, adlandırılmış bağımsız değişkenler ve yansıma kullanılırken soruna neden olabilir.</span><span class="sxs-lookup"><span data-stu-id="e5e31-105">This can cause problems while using named arguments and reflection.</span></span>

<span data-ttu-id="e5e31-106">.NET 5,0 ' de, bu eşleşmeyen parametre adları, başvuru derlemelerinde, uygulama derlemelerindeki karşılık gelen parametre adlarıyla tam olarak eşleşecek şekilde güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="e5e31-106">In .NET 5.0, these mismatched parameter names were updated in the reference assemblies to exactly match the corresponding parameter names in the implementation assemblies.</span></span>

<span data-ttu-id="e5e31-107">Aşağıdaki tabloda, değiştirilen API 'Ler ve parametre adları gösterilmektedir.</span><span class="sxs-lookup"><span data-stu-id="e5e31-107">The following table shows the APIs and parameter names that changed.</span></span>

| <span data-ttu-id="e5e31-108">API</span><span class="sxs-lookup"><span data-stu-id="e5e31-108">API</span></span> | <span data-ttu-id="e5e31-109">Eski parametre adı</span><span class="sxs-lookup"><span data-stu-id="e5e31-109">Old parameter name</span></span> | <span data-ttu-id="e5e31-110">Yeni parametre adı</span><span class="sxs-lookup"><span data-stu-id="e5e31-110">New parameter name</span></span> |
| - | - | - |
...
#### <a name="reason-for-change"></a><span data-ttu-id="e5e31-111">Değişiklik nedeni</span><span class="sxs-lookup"><span data-stu-id="e5e31-111">Reason for change</span></span>

<span data-ttu-id="e5e31-112">Parametre adları tutarlılık için değiştirilmiştir ve adlandırılmış bağımsız değişkenler ve yansıma kullanılırken hatalardan kaçınmak için.</span><span class="sxs-lookup"><span data-stu-id="e5e31-112">The parameter names were changed for consistency and to avoid failures when using named arguments and reflection.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="e5e31-113">Sunulan sürüm</span><span class="sxs-lookup"><span data-stu-id="e5e31-113">Version introduced</span></span>

<span data-ttu-id="e5e31-114">5.0</span><span class="sxs-lookup"><span data-stu-id="e5e31-114">5.0</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="e5e31-115">Önerilen eylem</span><span class="sxs-lookup"><span data-stu-id="e5e31-115">Recommended action</span></span>

<span data-ttu-id="e5e31-116">Bir parametre adı değişikliği nedeniyle bir derleyici hatasıyla karşılaşırsanız parametre adını uygun şekilde güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="e5e31-116">If you encounter a compiler error due to a parameter name change, update the parameter name accordingly.</span></span>

#### <a name="category"></a><span data-ttu-id="e5e31-117">Kategori</span><span class="sxs-lookup"><span data-stu-id="e5e31-117">Category</span></span>

<span data-ttu-id="e5e31-118">Core .NET kitaplıkları</span><span class="sxs-lookup"><span data-stu-id="e5e31-118">Core .NET libraries</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="e5e31-119">Etkilenen API’ler</span><span class="sxs-lookup"><span data-stu-id="e5e31-119">Affected APIs</span></span>
