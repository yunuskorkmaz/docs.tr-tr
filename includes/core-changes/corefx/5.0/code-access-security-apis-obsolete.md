...
- İhtiyaç duymanız durumunda <xref:System.Security.Permissions.PrincipalPermission> , [PrincipalPermissionAttribute kılavuzuna hata olarak artık kullanımdan](../../../../docs/core/compatibility/corefx.md#permission-action)bakın. Bu kılavuz hem hem de için geçerlidir <xref:System.Security.Permissions.PrincipalPermission> <xref:System.Security.Permissions.PrincipalPermissionAttribute> .
