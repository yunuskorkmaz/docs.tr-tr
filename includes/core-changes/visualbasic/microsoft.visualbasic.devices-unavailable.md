...
<xref:Microsoft.VisualBasic.Devices?displayProperty=fullName> ad alanındaki türler, bazı .NET Core 3,0 önizleme sürümlerinde bulunmaktadır. .NET Core 3,0 Preview 9 ' dan itibaren artık kullanılabilir değildir.
