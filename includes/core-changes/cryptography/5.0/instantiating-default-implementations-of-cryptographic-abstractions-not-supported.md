...
Ayrıca, programlama yoluyla çağırmak gerekmeden varsayılan algoritmayı değiştirmek için [makine genelinde yapılandırma](../../../../docs/framework/configure-apps/map-algorithm-names-to-cryptography-classes.md) kullanabilirsiniz `CryptoConfig` .
