...
|   |   |
|---|---|
|Ayrıntılar|Bazı durumlarda, iki veya daha fazla uygulama etki alanları ile farklı bir uygulamayı kullanırken uygulama tabanları, uygulama etki alanları arasında mantıksal çağrısı bağlamda nesneleri seri durumdan çıkarılırken bir özel durum oluşturur.|
