### <a name="a-concurrentdictionary-serialized-in-net-45-with-netdatacontractserializer-cannot-be-deserialized-by-net-451-or-452"></a>NetDataContractSerializer ile .NET 4.5 serileştirilmiş bir ConcurrentDictionary 4.5.1 veya 4.5.2 .NET tarafından kaldırılamaz
