### <a name="right-clicking-on-a-wpf-datagrid-row-header-changes-the-datagrid-selection"></a>Bir WPF DataGrid üzerinde sağ tıklayarak satır üst bilgisi DataGrid seçimi değiştirir
