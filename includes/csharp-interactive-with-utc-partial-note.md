...
>  
> [Yerel saat dilimi](xref:System.TimeZoneInfo.Local) , [Try.NET](https://try.dot.net) satır içi kod Çalıştırıcısı ve oyun alanı olduğundan, Eşgüdümlü Evrensel Saat ve UTC. Bu davranışı ve çıktısını gösteren örnekler etkileyebilir <xref:System.DateTime>, <xref:System.DateTimeOffset>, ve <xref:System.TimeZoneInfo> türleri ve üyeleri.
